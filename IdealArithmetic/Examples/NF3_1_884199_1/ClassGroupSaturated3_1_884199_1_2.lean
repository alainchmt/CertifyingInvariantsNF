...
def I0 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![3, 0, 0], ![-38, -1, 1]] i)))
def I1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![3, 0, 0], ![-1, 1, 0]] i)))
def I2 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![11, 0, 0], ![-3, 1, 0]] i)))

def A0: IdealEqSpanCertificate' Table ![![3, 0, 0], ![-38, -1, 1]] 
 ![![3, 0, 0], ![0, 1, 0], ![1, 0, 1]] where
  M :=![![![3, 0, 0], ![0, 3, 0], ![0, 0, 3]], ![![-38, -1, 1], ![327, 19, -3], ![-436, 51, 20]]]
  hmulB := by decide  
  f := ![![![9, 21, 11], ![-51, -6, 0]], ![![5, -3, -2], ![9, 1, 0]], ![![3, 7, 4], ![-17, -2, 0]]]
  g := ![![![1, 0, 0], ![0, 3, 0], ![-1, 0, 3]], ![![-13, -1, 1], ![110, 19, -3], ![-152, 51, 20]]]
  hle1 := by decide   
  hle2 := by decide  
...
def A1: IdealEqSpanCertificate' Table ![![3, 0, 0], ![-1, 1, 0]] 
 ![![3, 0, 0], ![2, 1, 0], ![2, 0, 1]] where
  M :=![![![3, 0, 0], ![0, 3, 0], ![0, 0, 3]], ![![-1, 1, 0], ![0, 0, 3], ![327, 58, -1]]]
  hmulB := by decide  
  f := ![![![606, 165, -2], ![-147, 0, -6]], ![![304, 82, -1], ![-71, 0, -3]], ![![404, 110, -1], ![-98, 0, -4]]]
  g := ![![![1, 0, 0], ![-2, 3, 0], ![-2, 0, 3]], ![![-1, 1, 0], ![-2, 0, 3], ![71, 58, -1]]]
  hle1 := by decide   
  hle2 := by decide  
...
def A2: IdealEqSpanCertificate' Table ![![11, 0, 0], ![-3, 1, 0]] 
 ![![11, 0, 0], ![8, 1, 0], ![9, 0, 1]] where
  M :=![![![11, 0, 0], ![0, 11, 0], ![0, 0, 11]], ![![-3, 1, 0], ![0, -2, 3], ![327, 58, -3]]]
  hmulB := by decide  
  f := ![![![19, -6, 0], ![66, 0, 0]], ![![16, -5, 0], ![56, 0, 0]], ![![15, -4, -1], ![52, 4, 0]]]
  g := ![![![1, 0, 0], ![-8, 11, 0], ![-9, 0, 11]], ![![-1, 1, 0], ![-1, -2, 3], ![-10, 58, -3]]]
  hle1 := by decide   
  hle2 := by decide  
...
def Log00Mem : IdealMemCertificate B I0
 ![![3, 0, 0], ![0, 1, 0], ![1, 0, 1]] ![4608541970671, 310254517665, -121238679848] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![1576593550173, 310254517665, -121238679848]
 hmem := by decide
...
def Log00: DiscreteLogCertificate N0 ((orderOf_of_IsOrderOf R3) ▸ IsPrimitiveRoot.orderOf _) 2 zeta1 1 where
 ...
 B := B
 hone := B_one
 xcoord := ![4608541970673, 310254517665, -121238679848]
 hxeq :=  rfl
 m := 2
 C := ![4608541970671, 310254517665, -121238679848]
 hCeq := by rfl
...
def Log02Mem : IdealMemCertificate B I0
 ![![3, 0, 0], ![0, 1, 0], ![1, 0, 1]] ![37, 13, 4] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![11, 13, 4]
 hmem := by decide
...
def Log10Mem : IdealMemCertificate B I1
 ![![3, 0, 0], ![2, 1, 0], ![2, 0, 1]] ![4608541970672, 310254517665, -121238679848] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![1410170098346, 310254517665, -121238679848]
 hmem := by decide
...
def Log10: DiscreteLogCertificate N1 ((orderOf_of_IsOrderOf R3) ▸ IsPrimitiveRoot.orderOf _) 2 zeta1 0 where
 ...
 hxeq :=  rfl
 m := 1
 C := ![4608541970672, 310254517665, -121238679848]
 hCeq := by rfl
...
def Log12Mem : IdealMemCertificate B I1
 ![![3, 0, 0], ![2, 1, 0], ![2, 0, 1]] ![37, 13, 4] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![1, 13, 4]
 hmem := by decide
...
def Log20Mem : IdealMemCertificate B I2
 ![![11, 0, 0], ![8, 1, 0], ![9, 0, 1]] ![4608541970669, 310254517665, -121238679848] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![292513995271, 310254517665, -121238679848]
 hmem := by decide
...
def Log20: DiscreteLogCertificate N2 ((orderOf_of_IsOrderOf R11) ▸ IsPrimitiveRoot.orderOf _) 2 zeta1 0 where
 ...
 hxeq :=  rfl
 m := 4
 C := ![4608541970669, 310254517665, -121238679848]
 hCeq := by rfl
...
def Log21Mem : IdealMemCertificate B I2
 ![![11, 0, 0], ![8, 1, 0], ![9, 0, 1]] ![-11, 0, 0] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![-1, 0, 0]
 hmem := by decide
...
def Log22Mem : IdealMemCertificate B I2
 ![![11, 0, 0], ![8, 1, 0], ![9, 0, 1]] ![30, 13, 4] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![-10, 13, 4]
 hmem := by decide
