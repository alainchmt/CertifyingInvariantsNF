...
import IdealArithmetic.Examples.NF3_1_213716_1.Irreducible3_1_213716_1
...
noncomputable def T : ℤ[X] := X^3 - X^2 + 8*X + 86
lemma T_def : T = X^3 - X^2 + 8*X + 86 := rfl
