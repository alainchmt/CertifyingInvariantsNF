...
def Log00Mem : IdealMemCertificate B I0
 ![![19, 0, 0], ![16, 1, 0], ![5, 0, 1]] ![496546942937202, 25310875074642, -7940967232216] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![6909356731790, 25310875074642, -7940967232216]
 hmem := by decide
...
def Log00: DiscreteLogCertificate N0 ((orderOf_of_IsOrderOf R19) ▸ IsPrimitiveRoot.orderOf _) 3 zeta1 1 where
 ...
 B := B
 hone := B_one
 xcoord := ![496546942937207, 25310875074642, -7940967232216]
 hxeq :=  rfl
 m := 5
 C := ![496546942937202, 25310875074642, -7940967232216]
 hCeq := by rfl
...
def Log01Mem : IdealMemCertificate B I0
 ![![19, 0, 0], ![16, 1, 0], ![5, 0, 1]] ![-1417, -363, -49] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![244, -363, -49]
 hmem := by decide
...
def Log10Mem : IdealMemCertificate B I1
 ![![31, 0, 0], ![16, 1, 0], ![27, 0, 1]] ![496546942937202, 25310875074642, -7940967232216] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![9870292161702, 25310875074642, -7940967232216]
 hmem := by decide
...
def Log11Mem : IdealMemCertificate B I1
 ![![31, 0, 0], ![16, 1, 0], ![27, 0, 1]] ![-1427, -363, -49] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![184, -363, -49]
 hmem := by decide
