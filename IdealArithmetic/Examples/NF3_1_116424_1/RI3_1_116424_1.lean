...
import IdealArithmetic.Examples.NF3_1_116424_1.Irreducible3_1_116424_1
...
noncomputable def T : ℤ[X] := X^3 + 63*X - 266
lemma T_def : T = X^3 + 63*X - 266 := rfl
