...
import IdealArithmetic.Examples.NF3_1_703080_1.Irreducible3_1_703080_1
...
noncomputable def T : ℤ[X] := X^3 + 78*X - 184
lemma T_def : T = X^3 + 78*X - 184 := rfl
