...
import IdealArithmetic.Examples.NF3_1_189283_1.Irreducible3_1_189283_1
...
noncomputable def T : ℤ[X] := X^3 - X^2 + 60*X - 304
lemma T_def : T = X^3 - X^2 + 60*X - 304 := rfl
