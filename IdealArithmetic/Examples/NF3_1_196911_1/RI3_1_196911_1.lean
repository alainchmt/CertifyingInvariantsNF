...
import IdealArithmetic.Examples.NF3_1_196911_1.Irreducible3_1_196911_1
...
noncomputable def T : ℤ[X] := X^3 - 3*X - 427
lemma T_def : T = X^3 - 3*X - 427 := rfl
