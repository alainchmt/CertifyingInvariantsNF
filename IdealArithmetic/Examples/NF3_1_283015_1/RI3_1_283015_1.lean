...
import IdealArithmetic.Examples.NF3_1_283015_1.Irreducible3_1_283015_1
...
noncomputable def T : ℤ[X] := X^3 - X^2 + 54*X + 891
lemma T_def : T = X^3 - X^2 + 54*X + 891 := rfl
...
-- We build the subalgebra with integral basis [1, a, 1/9*a^2 - 1/9*a] 
