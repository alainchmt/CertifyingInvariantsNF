...
import IdealArithmetic.Examples.NF3_1_29535_1.Irreducible3_1_29535_1
...
noncomputable def T : ℤ[X] := X^3 - X^2 - 33
lemma T_def : T = X^3 - X^2 - 33 := rfl
