...
import IdealArithmetic.Examples.NF3_1_547575_2.Irreducible3_1_547575_2
...
noncomputable def T : ℤ[X] := X^3 - X^2 + 82*X - 48
lemma T_def : T = X^3 - X^2 + 82*X - 48 := rfl
