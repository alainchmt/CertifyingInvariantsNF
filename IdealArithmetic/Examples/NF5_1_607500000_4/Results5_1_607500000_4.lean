import IdealArithmetic.Examples.NF5_1_607500000_4.Invariants5_1_607500000_4

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 + 15*X^3 - 100*X^2 + 150*X - 120`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 + 15*X^3 - 100*X^2 + 150*X - 120)) := rfl

lemma T_irreducible' : Irreducible (X^5 + 15*X^3 - 100*X^2 + 150*X - 120 : ℤ[X]) := irreducible_T
