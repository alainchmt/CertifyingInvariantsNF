...
def SI607N0: IdealEqSpanCertificate timesTableO I607N0
 ![![361, 201, 12, -3]] 
...
lemma NI607N0 : Nat.card (O ⧸ I607N0) = 368449 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI607N0)

def MemCI607N0 : IdealMemCertificate B I607N0
  ![![607, 0, 0, 0], ![0, 607, 0, 0], ![22, 213, 1, 0], ![170, 178, 0, 1]] ![33283, 29567, 8126, 526] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI607N0
 g := ![-387, -2957, 8126, 526]
 hmem := by decide
...
def PI607N0 : CertifiedPrimeIdeal O 607 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI607N0
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI607N0]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI607N0 : Ideal.IsPrime I607N0 := CertifiedPrimeIdeal.isPrime PI607N0
def I607N1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![607, 0, 0, 0], ![90, 1, 0, 0]] i)))

def SI607N1: IdealEqSpanCertificate timesTableO I607N1
 ![![607, 0, 0, 0], ![90, 1, 0, 0]] 
...
lemma NI607N1 : Nat.card (O ⧸ I607N1) = 607 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI607N1)
...
def SI607N2: IdealEqSpanCertificate timesTableO I607N2
 ![![607, 0, 0, 0], ![303, 1, 0, 0]] 
...
lemma NI607N2 : Nat.card (O ⧸ I607N2) = 607 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI607N2)

lemma isPrimeI607N2 : Ideal.IsPrime I607N2 := prime_ideal_of_norm_prime hp607.out _ NI607N2
def MulI607N0 : IdealMulEqCertificate timesTableO (I607N0) I607N1
 ...
 hmul := by decide
 f :=  ![![![![3854399702986, -16126337264230652, -179181994542804, 71857], ![-25995784663477, 108763474613029656, -43617196, 0]]], ![![![-73980641831340, 309525963343634001, 3439186379768494, -1379210], ![498958328795816, -2087586207865718160, 837180470, 0]]]]
 g :=  ![![![![361, 201, 12, -3], ![0, 0, 0, 0]], ![![11655, 6221, 347, -87], ![604, 0, 0, 0]]]]
 hle1 := by decide
 hle2 := by decide

def MulI607N1 : IdealMulEqCertificate timesTableO (I607N0*I607N1) I607N2
  ![![607, 0, 0, 0], ![-11661, -6223, -347, 87]] ![![607, 0, 0, 0], ![303, 1, 0, 0]]
  ![![607, 0, 0, 0]] where
 T := Table
 heq := timesTableT_eq_Table
 hI1 := ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI607N0
 hI2 := rfl
 M :=  ![![![368449, 0, 0, 0], ![183921, 607, 0, 0]], ![![-7078227, -3777361, -210629, 52809], ![-3499962, -1868346, -104404, 26101]]]
 hmul := by decide
 f :=  ![![![![381491445867974242, -286608713843740031316, -1134210675592202705, -621462653468830], ![-764241930920792059, 574165853288627559153, 377227811460068938, 0]], ![![220638056, 0, 0, 0], ![0, 0, 0, 0]]]]
 g :=  ![![![![607, 0, 0, 0]], ![![303, 1, 0, 0]]], ![![![-11661, -6223, -347, 87]], ![![-5766, -3078, -172, 43]]]]
 hle1 := by decide
 hle2 := by decide

def PBC607 : IsPrimesAboveP 607 ![I607N0, I607N1, I607N2] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI607N0
  ...
  hPprod := by 
    ...
    dsimp
    rw [ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI607N1, Set.range_unique]
    dsimp ; congr 
    erw [B_int_repr]
    rfl
...
def SI613N0: IdealEqSpanCertificate timesTableO I613N0
 ![![613, 0, 0, 0], ![-91, -224, -4, 1]] 
...
lemma NI613N0 : Nat.card (O ⧸ I613N0) = 375769 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI613N0)

def MemCI613N0 : IdealMemCertificate B I613N0
  ![![613, 0, 0, 0], ![0, 613, 0, 0], ![573, 101, 1, 0], ![362, 180, 0, 1]] ![1552965, 1298357, 266884, -5911] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI613N0
...
def PI613N0 : CertifiedPrimeIdeal O 613 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI613N0
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI613N0]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI613N0 : Ideal.IsPrime I613N0 := CertifiedPrimeIdeal.isPrime PI613N0
def I613N1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![613, 0, 0, 0], ![-257, -347, -4, 1]] i)))

def SI613N1: IdealEqSpanCertificate timesTableO I613N1
 ![![613, 0, 0, 0], ![-257, -347, -4, 1]] 
...
lemma NI613N1 : Nat.card (O ⧸ I613N1) = 375769 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI613N1)

def MemCI613N1 : IdealMemCertificate B I613N1
  ![![613, 0, 0, 0], ![0, 613, 0, 0], ![454, 511, 1, 0], ![333, 471, 0, 1]] ![274609, 240118, 62477, 2169] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI613N1
...
def PI613N1 : CertifiedPrimeIdeal O 613 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI613N1
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI613N1]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI613N1 : Ideal.IsPrime I613N1 := CertifiedPrimeIdeal.isPrime PI613N1
def MulI613N0 : IdealMulEqCertificate timesTableO (I613N0) I613N1
 ...
 hmul := by decide
 f :=  ![![![![1697879960702194615126, -5994982569648996662, -1392610872850638721064, -14455126208893890775], ![-699378307640460282488, -3186790087891216324500, 0, 0]], ![![410018766322197, -10622, 0, 0], ![0, 0, 0, 0]]]]
 g :=  ![![![![613, 0, 0, 0]], ![![-257, -347, -4, 1]]], ![![![-91, -224, -4, 1]], ![![-263, -120, 63, 2]]]]
 hle1 := by decide
 hle2 := by decide

def PBC613 : IsPrimesAboveP 613 ![I613N0, I613N1] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI613N0
  ...
  hPprod := by 
    simp only [Fin.prod_univ_succ, Fin.prod_univ_zero, mul_one, ← Ideal.mul_assoc]
    dsimp
    rw [ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI613N0, Set.range_unique]
    dsimp ; congr 
    erw [B_int_repr]
    rfl
...
def SI617N0: IdealEqSpanCertificate timesTableO I617N0
 ![![617, 0, 0, 0], ![35, 1, 0, 0]] 
...
lemma NI617N0 : Nat.card (O ⧸ I617N0) = 617 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI617N0)
...
def SI617N1: IdealEqSpanCertificate timesTableO I617N1
 ![![617, 0, 0, 0], ![236, 1, 0, 0]] 
...
lemma NI617N1 : Nat.card (O ⧸ I617N1) = 617 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI617N1)
...
def SI617N2: IdealEqSpanCertificate timesTableO I617N2
 ![![617, 0, 0, 0], ![-140, 1, 0, 0]] 
...
lemma NI617N2 : Nat.card (O ⧸ I617N2) = 617 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI617N2)
...
def SI617N3: IdealEqSpanCertificate timesTableO I617N3
 ![![617, 0, 0, 0], ![-132, 1, 0, 0]] 
...
lemma NI617N3 : Nat.card (O ⧸ I617N3) = 617 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI617N3)

lemma isPrimeI617N3 : Ideal.IsPrime I617N3 := prime_ideal_of_norm_prime hp617.out _ NI617N3
def MulI617N0 : IdealMulEqCertificate timesTableO (I617N0) I617N1
 ...
 hmul := by decide
 f :=  ![![![![11001813712063589, -1451499354027962427, -6933962348119749, -3319253431152], ![-28762875549136975, 3794931638173127999, 2047979367025011, 0]], ![![-2298021353325, 0, 0, 0], ![34216, -2608060, 0, 0]]]]
 g :=  ![![![![48743, 28999, 1234, -617]], ![![18261, 10839, 439, -235]]], ![![![2382, 1392, 37, -34]], ![![890, 518, 12, -13]]]]
 hle1 := by decide
 hle2 := by decide

def MulI617N1 : IdealMulEqCertificate timesTableO (I617N0*I617N1) I617N2
  ![![-94, 21, 10, -1]] ![![617, 0, 0, 0], ![-140, 1, 0, 0]]
  ![![617, 0, 0, 0], ![-3927, -2048, -127, 32]] where
 T := Table
 heq := timesTableT_eq_Table
 hI1 := ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI617N0
 hI2 := rfl
 M :=  ![![![-57998, 12957, 6170, -617], ![12777, -3366, -1459, 149]]]
 hmul := by decide
 f :=  ![![![![-12975246123724813, -37098916397283584894, 264992921985375506, -17323], ![-57183763273844355, -163500632863480326600, 10688290, 0]]], ![![![82839199378632842, 236854430571953937933, -1691821587733490210, 110597], ![365084185832974739, 1043853919622010090567, -68238350, 0]]]]
 g :=  ![![![![3833, 2069, 137, -33], ![617, 0, 0, 0]], ![![2382, 1226, 74, -19], ![371, 0, 0, 0]]]]
 hle1 := by decide
 hle2 := by decide

def MulI617N2 : IdealMulEqCertificate timesTableO (I617N0*I617N1*I617N2) I617N3
  ![![617, 0, 0, 0], ![-3927, -2048, -127, 32]] ![![617, 0, 0, 0], ![-132, 1, 0, 0]]
  ![![617, 0, 0, 0]] where
 T := Table
 heq := timesTableT_eq_Table
 hI1 := ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI617N1
 hI2 := rfl
 M :=  ![![![380689, 0, 0, 0], ![-81444, 617, 0, 0]], ![![-2422959, -1263616, -78359, 19744], ![530620, 277033, 17276, -4319]]]
 hmul := by decide
 f :=  ![![![![54724130174528, -9413734870124735, 74436851193655, -23672022025], ![255789855973335, -44000143181988640, 14601340534545, 0]], ![![134282965, 0, 0, 0], ![0, 0, 0, 0]]]]
 g :=  ![![![![617, 0, 0, 0]], ![![-132, 1, 0, 0]]], ![![![-3927, -2048, -127, 32]], ![![860, 449, 28, -7]]]]
 hle1 := by decide
 hle2 := by decide

def PBC617 : IsPrimesAboveP 617 ![I617N0, I617N1, I617N2, I617N3] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI617N0
  ...
  hPprod := by 
    simp only [Fin.prod_univ_succ, Fin.prod_univ_zero, mul_one, ← Ideal.mul_assoc]
    dsimp
    rw [ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI617N2, Set.range_unique]
    dsimp ; congr 
    erw [B_int_repr]
    rfl
...
def SI619N0: IdealEqSpanCertificate timesTableO I619N0
 ![![629, 335, 20, -5]] 
...
lemma NI619N0 : Nat.card (O ⧸ I619N0) = 383161 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI619N0)

def MemCI619N0 : IdealMemCertificate B I619N0
  ![![619, 0, 0, 0], ![0, 619, 0, 0], ![377, 129, 1, 0], ![268, 449, 0, 1]] ![30320, 25048, 5827, 797] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI619N0
...
def PI619N0 : CertifiedPrimeIdeal O 619 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI619N0
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI619N0]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI619N0 : Ideal.IsPrime I619N0 := CertifiedPrimeIdeal.isPrime PI619N0
def I619N1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![619, 0, 0, 0], ![217, 1, 0, 0]] i)))

def SI619N1: IdealEqSpanCertificate timesTableO I619N1
 ![![619, 0, 0, 0], ![217, 1, 0, 0]] 
...
lemma NI619N1 : Nat.card (O ⧸ I619N1) = 619 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI619N1)
...
def SI619N2: IdealEqSpanCertificate timesTableO I619N2
 ![![619, 0, 0, 0], ![272, 1, 0, 0]] 
...
lemma NI619N2 : Nat.card (O ⧸ I619N2) = 619 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI619N2)

lemma isPrimeI619N2 : Ideal.IsPrime I619N2 := prime_ideal_of_norm_prime hp619.out _ NI619N2
def MulI619N0 : IdealMulEqCertificate timesTableO (I619N0) I619N1
 ...
 hmul := by decide
 f :=  ![![![![294690788249921, -584288993753850322, -2692582254530242, 54001], ![-840615658648389, 1666708422807797226, -33426624, 0]]], ![![![-13297837256232170, 26365873177390990011, 121502001580651965, -2436780], ![37932540376072413, -75209739305739165387, 1508366816, 0]]]]
 g :=  ![![![![629, 335, 20, -5], ![0, 0, 0, 0]], ![![27898, 14824, 855, -214], ![614, 0, 0, 0]]]]
 hle1 := by decide
 hle2 := by decide

def MulI619N1 : IdealMulEqCertificate timesTableO (I619N0*I619N1) I619N2
  ![![619, 0, 0, 0], ![-27906, -14828, -855, 214]] ![![619, 0, 0, 0], ![272, 1, 0, 0]]
  ![![619, 0, 0, 0]] where
 T := Table
 heq := timesTableT_eq_Table
 hI1 := ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI619N0
 hI2 := rfl
 M :=  ![![![383161, 0, 0, 0], ![168368, 619, 0, 0]], ![![-17273814, -9178532, -529245, 132466], ![-7508470, -3990074, -230268, 57567]]]
 hmul := by decide
 f :=  ![![![![68278949779, -2400661041787, -10239193830, -5208022], ![-155380219575, 5463842755074, 3214178418, 0]], ![![44800, 0, 0, 0], ![0, 0, 0, 0]]]]
 g :=  ![![![![619, 0, 0, 0]], ![![272, 1, 0, 0]]], ![![![-27906, -14828, -855, 214]], ![![-12130, -6446, -372, 93]]]]
 hle1 := by decide
 hle2 := by decide

def PBC619 : IsPrimesAboveP 619 ![I619N0, I619N1, I619N2] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI619N0
  ...
  hPprod := by 
    simp only [Fin.prod_univ_succ, Fin.prod_univ_zero, mul_one, ← Ideal.mul_assoc]
    dsimp
    rw [ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI619N1, Set.range_unique]
    dsimp ; congr 
    erw [B_int_repr]
    rfl
...
def SI631N0: IdealEqSpanCertificate timesTableO I631N0
 ![![631, 0, 0, 0], ![13, -67, -4, 1]] 
...
lemma NI631N0 : Nat.card (O ⧸ I631N0) = 398161 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI631N0)

def MemCI631N0 : IdealMemCertificate B I631N0
  ![![631, 0, 0, 0], ![0, 631, 0, 0], ![422, 144, 1, 0], ![439, 509, 0, 1]] ![284773, 243794, 62559, 4811] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI631N0
...
def PI631N0 : CertifiedPrimeIdeal O 631 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI631N0
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI631N0]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI631N0 : Ideal.IsPrime I631N0 := CertifiedPrimeIdeal.isPrime PI631N0
def I631N1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![631, 0, 0, 0], ![191, 1, 0, 0]] i)))

def SI631N1: IdealEqSpanCertificate timesTableO I631N1
 ![![631, 0, 0, 0], ![191, 1, 0, 0]] 
...
lemma NI631N1 : Nat.card (O ⧸ I631N1) = 631 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI631N1)
...
def SI631N2: IdealEqSpanCertificate timesTableO I631N2
 ![![631, 0, 0, 0], ![295, 1, 0, 0]] 
...
lemma NI631N2 : Nat.card (O ⧸ I631N2) = 631 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI631N2)

lemma isPrimeI631N2 : Ideal.IsPrime I631N2 := prime_ideal_of_norm_prime hp631.out _ NI631N2
def MulI631N0 : IdealMulEqCertificate timesTableO (I631N0) I631N1
 ...
 hmul := by decide
 f :=  ![![![![1362698528980987974, -435940229096370125245, -2474701503420824559, -1006567446772111], ![-4501899286581697663, 1440224012657634502998, 635144678136197961, 0]], ![![-619222901920, 0, 0, 0], ![-315500, 0, 0, 0]]], ![![![-53769357154291884180, 17201329111094660748671, 97646769375468947451, 39717137278958914], ![177635937417409770818, -56828357609429933102216, -25061538056323410554, 0]], ![![24433296626768, 0, 0, 0], ![12449000, 0, 0, 0]]]]
 g :=  ![![![![631, 0, 0, 0], ![0, 0, 0, 0]], ![![191, 1, 0, 0], ![0, 0, 0, 0]]], ![![![24911, 13016, 747, -187], ![631, 0, 0, 0]], ![![44, 1, 0, 0], ![1, 0, 0, 0]]]]
 hle1 := by decide
 hle2 := by decide

def MulI631N1 : IdealMulEqCertificate timesTableO (I631N0*I631N1) I631N2
  ![![631, 0, 0, 0], ![-24898, -13083, -751, 188]] ![![631, 0, 0, 0], ![295, 1, 0, 0]]
  ![![631, 0, 0, 0]] where
 T := Table
 heq := timesTableT_eq_Table
 hI1 := ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI631N0
 hI2 := rfl
 M :=  ![![![398161, 0, 0, 0], ![186145, 631, 0, 0]], ![![-15710638, -8255373, -473881, 118628], ![-7272906, -3821967, -219588, 54897]]]
 hmul := by decide
 f :=  ![![![![78502498118961, -43932891828495545, -175598563664602, -90415613807], ![-167915511481980, 93972280201749002, 57052249096477, 0]], ![![17105, 0, 0, 0], ![0, 0, 0, 0]]]]
 g :=  ![![![![631, 0, 0, 0]], ![![295, 1, 0, 0]]], ![![![-24898, -13083, -751, 188]], ![![-11526, -6057, -348, 87]]]]
 hle1 := by decide
 hle2 := by decide

def PBC631 : IsPrimesAboveP 631 ![I631N0, I631N1, I631N2] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI631N0
  ...
  hPprod := by 
    simp only [Fin.prod_univ_succ, Fin.prod_univ_zero, mul_one, ← Ideal.mul_assoc]
    dsimp
    rw [ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI631N1, Set.range_unique]
    dsimp ; congr 
    erw [B_int_repr]
    rfl
...
def SI641N0: IdealEqSpanCertificate timesTableO I641N0
 ![![641, 0, 0, 0], ![-87, -67, -4, 1]] 
...
lemma NI641N0 : Nat.card (O ⧸ I641N0) = 410881 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI641N0)

def MemCI641N0 : IdealMemCertificate B I641N0
  ![![641, 0, 0, 0], ![0, 641, 0, 0], ![122, 44, 1, 0], ![401, 109, 0, 1]] ![125499, 112292, 31084, 3449] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI641N0
...
def PI641N0 : CertifiedPrimeIdeal O 641 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI641N0
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI641N0]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI641N0 : Ideal.IsPrime I641N0 := CertifiedPrimeIdeal.isPrime PI641N0
def I641N1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![641, 0, 0, 0], ![-176, -67, -4, 1]] i)))

def SI641N1: IdealEqSpanCertificate timesTableO I641N1
 ![![641, 0, 0, 0], ![-176, -67, -4, 1]] 
...
lemma NI641N1 : Nat.card (O ⧸ I641N1) = 410881 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI641N1)

def MemCI641N1 : IdealMemCertificate B I641N1
  ![![641, 0, 0, 0], ![0, 641, 0, 0], ![496, 596, 1, 0], ![526, 394, 0, 1]] ![122694, 109100, 28780, 2744] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI641N1
...
def PI641N1 : CertifiedPrimeIdeal O 641 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  f := ofList [557, 396, 1]
  hfeq := by decide
  hirr := irreducible_ofList_ofCertificateIrreducibleZModOfList' P641P1
  hneq := by decide
  hlen := by decide
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI641N1
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI641N1]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI641N1 : Ideal.IsPrime I641N1 := CertifiedPrimeIdeal.isPrime PI641N1
def MulI641N0 : IdealMulEqCertificate timesTableO (I641N0) I641N1
 ...
 hmul := by decide
 f :=  ![![![![15372740251, 6297181947, 536825778, -123296931], ![-4882657855, -27971992614, 0, 0]], ![![12784, 0, 0, 0], ![0, 0, 0, 0]]]]
 g :=  ![![![![641, 0, 0, 0]], ![![-176, -67, -4, 1]]], ![![![-87, -67, -4, 1]], ![![-3, 0, 0, 0]]]]
 hle1 := by decide
 hle2 := by decide

def PBC641 : IsPrimesAboveP 641 ![I641N0, I641N1] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI641N0
  ...
  hPprod := by 
    simp only [Fin.prod_univ_succ, Fin.prod_univ_zero, mul_one, ← Ideal.mul_assoc]
    dsimp
    rw [ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI641N0, Set.range_unique]
    dsimp ; congr 
    erw [B_int_repr]
    rfl
...
def SI643N0: IdealEqSpanCertificate timesTableO I643N0
 ![![841, 402, 24, -6]] 
...
lemma NI643N0 : Nat.card (O ⧸ I643N0) = 413449 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI643N0)

def MemCI643N0 : IdealMemCertificate B I643N0
  ![![643, 0, 0, 0], ![0, 643, 0, 0], ![284, 98, 1, 0], ![460, 325, 0, 1]] ![79795, 64391, 15706, -1859] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI643N0
...
def PI643N0 : CertifiedPrimeIdeal O 643 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI643N0
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI643N0]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI643N0 : Ideal.IsPrime I643N0 := CertifiedPrimeIdeal.isPrime PI643N0
def I643N1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![-737, -402, -24, 6]] i)))

def SI643N1: IdealEqSpanCertificate timesTableO I643N1
 ![![-737, -402, -24, 6]] 
...
lemma NI643N1 : Nat.card (O ⧸ I643N1) = 413449 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI643N1)

def MemCI643N1 : IdealMemCertificate B I643N1
  ![![643, 0, 0, 0], ![0, 643, 0, 0], ![336, 544, 1, 0], ![471, 180, 0, 1]] ![39971, 37937, 10436, 853] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI643N1
...
def PI643N1 : CertifiedPrimeIdeal O 643 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  f := ofList [229, 292, 1]
  hfeq := by decide
  hirr := irreducible_ofList_ofCertificateIrreducibleZModOfList' P643P1
  hneq := by decide
  hlen := by decide
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI643N1
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI643N1]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI643N1 : Ideal.IsPrime I643N1 := CertifiedPrimeIdeal.isPrime PI643N1
def MulI643N0 : IdealMulEqCertificate timesTableO (I643N0) I643N1
...
def PBC643 : IsPrimesAboveP 643 ![I643N0, I643N1] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI643N0
  ...
  hPprod := by 
    simp only [Fin.prod_univ_succ, Fin.prod_univ_zero, mul_one, ← Ideal.mul_assoc]
    dsimp
    rw [ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI643N0, Set.range_unique]
    dsimp ; congr 
    erw [B_int_repr]
    rfl
...
def SI647N0: IdealEqSpanCertificate timesTableO I647N0
 ![![647, 0, 0, 0]] 
...
lemma NI647N0 : Nat.card (O ⧸ I647N0) = 175233494881 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI647N0)

def MemCI647N0 : IdealMemCertificate B I647N0
  ![![647, 0, 0, 0], ![0, 647, 0, 0], ![0, 0, 647, 0], ![0, 0, 0, 647]] ![34072973293, 32647474425, 10086081706, 999560652] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI647N0
...
def PI647N0 : CertifiedPrimeIdeal O 647 where 
  r := 4
  n := 4
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI647N0
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI647N0]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI647N0 : Ideal.IsPrime I647N0 := CertifiedPrimeIdeal.isPrime PI647N0
def PBC647 : IsPrimesAboveP 647 ![I647N0] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI647N0
...
def SI653N0: IdealEqSpanCertificate timesTableO I653N0
 ![![653, 0, 0, 0], ![36, -34, -4, 1]] 
...
lemma NI653N0 : Nat.card (O ⧸ I653N0) = 426409 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI653N0)

def MemCI653N0 : IdealMemCertificate B I653N0
  ![![653, 0, 0, 0], ![0, 653, 0, 0], ![533, 584, 1, 0], ![209, 343, 0, 1]] ![495638, 412628, 99881, 1165] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI653N0
...
def PI653N0 : CertifiedPrimeIdeal O 653 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI653N0
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI653N0]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI653N0 : Ideal.IsPrime I653N0 := CertifiedPrimeIdeal.isPrime PI653N0
def I653N1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![653, 0, 0, 0], ![162, -164, -4, 1]] i)))

def SI653N1: IdealEqSpanCertificate timesTableO I653N1
 ![![653, 0, 0, 0], ![162, -164, -4, 1]] 
...
lemma NI653N1 : Nat.card (O ⧸ I653N1) = 426409 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI653N1)

def MemCI653N1 : IdealMemCertificate B I653N1
  ![![653, 0, 0, 0], ![0, 653, 0, 0], ![161, 68, 1, 0], ![153, 108, 0, 1]] ![30339, 25705, 6484, 140] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI653N1
 g := ![-1585, -659, 6484, 140]
 hmem := by decide
...
def PI653N1 : CertifiedPrimeIdeal O 653 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  f := ofList [465, 192, 1]
  hfeq := by decide
  hirr := irreducible_ofList_ofCertificateIrreducibleZModOfList' P653P1
  hneq := by decide
  hlen := by decide
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI653N1
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI653N1]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI653N1 : Ideal.IsPrime I653N1 := CertifiedPrimeIdeal.isPrime PI653N1
def MulI653N0 : IdealMulEqCertificate timesTableO (I653N0) I653N1
 ...
 hmul := by decide
 f :=  ![![![![6478210123102347666737, 8114519634730427421560, -1400417996689204485900, -49275837889439838769], ![-422295228184291572529, -10866473337554934422654, 0, 0]], ![![-2642676854310228, -185776984, 0, 0], ![0, 0, 0, 0]]]]
 g :=  ![![![![653, 0, 0, 0]], ![![162, -164, -4, 1]]], ![![![36, -34, -4, 1]], ![![-55, -77, -9, 1]]]]
 hle1 := by decide
 hle2 := by decide

def PBC653 : IsPrimesAboveP 653 ![I653N0, I653N1] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI653N0
  ...
  hPprod := by 
    simp only [Fin.prod_univ_succ, Fin.prod_univ_zero, mul_one, ← Ideal.mul_assoc]
    dsimp
    rw [ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI653N0, Set.range_unique]
    dsimp ; congr 
    erw [B_int_repr]
    rfl
...
def SI659N0: IdealEqSpanCertificate timesTableO I659N0
 ![![659, 0, 0, 0], ![-119, -381, -4, 1]] 
...
lemma NI659N0 : Nat.card (O ⧸ I659N0) = 434281 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI659N0)

def MemCI659N0 : IdealMemCertificate B I659N0
  ![![659, 0, 0, 0], ![0, 659, 0, 0], ![381, 363, 1, 0], ![87, 412, 0, 1]] ![6248, 6233, 2517, 40] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI659N0
 g := ![-1451, -1402, 2517, 40]
 hmem := by decide
...
def PI659N0 : CertifiedPrimeIdeal O 659 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  f := ofList [428, 309, 1]
  hfeq := by decide
  hirr := irreducible_ofList_ofCertificateIrreducibleZModOfList' P659P0
  hneq := by decide
  hlen := by decide
  c := ![6248, 6233, 2517, 40]
  a := ![-1, 3, 4, 0]
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI659N0
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI659N0]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI659N0 : Ideal.IsPrime I659N0 := CertifiedPrimeIdeal.isPrime PI659N0
def I659N1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![659, 0, 0, 0], ![-310, -28, -4, 1]] i)))

def SI659N1: IdealEqSpanCertificate timesTableO I659N1
 ![![659, 0, 0, 0], ![-310, -28, -4, 1]] 
...
lemma NI659N1 : Nat.card (O ⧸ I659N1) = 434281 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI659N1)

def MemCI659N1 : IdealMemCertificate B I659N1
  ![![659, 0, 0, 0], ![0, 659, 0, 0], ![530, 295, 1, 0], ![492, 493, 0, 1]] ![1525712, 1341167, 353676, 24479] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI659N1
...
def PI659N1 : CertifiedPrimeIdeal O 659 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  f := ofList [268, 46, 1]
  hfeq := by decide
  hirr := irreducible_ofList_ofCertificateIrreducibleZModOfList' P659P1
  hneq := by decide
  hlen := by decide
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI659N1
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI659N1]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI659N1 : Ideal.IsPrime I659N1 := CertifiedPrimeIdeal.isPrime PI659N1
def MulI659N0 : IdealMulEqCertificate timesTableO (I659N0) I659N1
 ...
 hmul := by decide
 f :=  ![![![![58888651006506055719107, 2951311438661270301146, 9607093129465960441060, -521704564808667933130], ![-27886295310139704629258, -123896528487062316257130, 0, 0]], ![![18057864220358998, -234477180, 0, 0], ![0, 0, 0, 0]]]]
 g :=  ![![![![659, 0, 0, 0]], ![![-310, -28, -4, 1]]], ![![![-119, -381, -4, 1]], ![![-130, 19, -23, 1]]]]
 hle1 := by decide
 hle2 := by decide

def PBC659 : IsPrimesAboveP 659 ![I659N0, I659N1] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI659N0
  ...
  hPprod := by 
    simp only [Fin.prod_univ_succ, Fin.prod_univ_zero, mul_one, ← Ideal.mul_assoc]
    dsimp
    rw [ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI659N0, Set.range_unique]
    dsimp ; congr 
    erw [B_int_repr]
    rfl
