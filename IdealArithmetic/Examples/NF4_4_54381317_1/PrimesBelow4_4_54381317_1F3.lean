...
noncomputable section instance hp127 : Fact (Nat.Prime 127) := {out := by norm_num}
...
def PB692I3 : PrimesBelowBoundCertificateInterval O 113 173 692 where
  ...
  hN := fun i => by
    ...
    · dsimp ; intro j
      ...
      exact NI173N2
      exact NI173N3
  β := ![I149N0, I149N1, I149N2, I149N3, I151N1, I151N2, I167N1, I167N2, I173N0, I173N1, I173N2, I173N3]
