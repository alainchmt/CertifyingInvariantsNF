...
noncomputable section instance hp353 : Fact (Nat.Prime 353) := {out := by norm_num}
...
def PB692I7 : PrimesBelowBoundCertificateInterval O 349 409 692 where
  ...
  hN := fun i => by
    ...
    · dsimp ; intro j
      ...
      exact NI409N1
      exact NI409N2
  β := ![I359N1, I359N2, I367N1, I367N2, I373N1, I373N2, I383N0, I383N2, I401N0, I401N1, I401N2, I401N3, I409N1, I409N2]
