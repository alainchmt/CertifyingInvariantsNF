...
def SI353N0: IdealEqSpanCertificate timesTableO I353N0
 ![![353, 0, 0, 0], ![-52, -35, -4, 1]] 
...
lemma NI353N0 : Nat.card (O ⧸ I353N0) = 124609 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI353N0)

def MemCI353N0 : IdealMemCertificate B I353N0
  ![![353, 0, 0, 0], ![0, 353, 0, 0], ![285, 16, 1, 0], ![29, 29, 0, 1]] ![32990, 29625, 8184, 584] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI353N0
 g := ![-6562, -335, 8184, 584]
 hmem := by decide
...
def PI353N0 : CertifiedPrimeIdeal O 353 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI353N0
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI353N0]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI353N0 : Ideal.IsPrime I353N0 := CertifiedPrimeIdeal.isPrime PI353N0
def I353N1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![353, 0, 0, 0], ![-150, 39, -4, 1]] i)))

def SI353N1: IdealEqSpanCertificate timesTableO I353N1
 ![![353, 0, 0, 0], ![-150, 39, -4, 1]] 
...
lemma NI353N1 : Nat.card (O ⧸ I353N1) = 124609 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI353N1)

def MemCI353N1 : IdealMemCertificate B I353N1
  ![![353, 0, 0, 0], ![0, 353, 0, 0], ![260, 336, 1, 0], ![184, 324, 0, 1]] ![1552625, 1298276, 268612, -5938] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI353N1
...
def PI353N1 : CertifiedPrimeIdeal O 353 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI353N1
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI353N1]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI353N1 : Ideal.IsPrime I353N1 := CertifiedPrimeIdeal.isPrime PI353N1
def MulI353N0 : IdealMulEqCertificate timesTableO (I353N0) I353N1
 ...
 hmul := by decide
 f :=  ![![![![30973441665370251565, 18239753355597658840, 10984023119628028336, -248198050939979596], ![-11271530196789464626, -32961724423377967008, 0, 0]], ![![268908468329790, -10400, 0, 0], ![0, 0, 0, 0]]]]
 g :=  ![![![![353, 0, 0, 0]], ![![-150, 39, -4, 1]]], ![![![-52, -35, -4, 1]], ![![123, 89, 14, -1]]]]
 hle1 := by decide
 hle2 := by decide

def PBC353 : IsPrimesAboveP 353 ![I353N0, I353N1] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI353N0
  ...
  hPprod := by 
    ...
    dsimp
    rw [ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI353N0, Set.range_unique]
    dsimp ; congr 
    erw [B_int_repr]
    rfl
...
def SI359N0: IdealEqSpanCertificate timesTableO I359N0
 ![![-407, -201, -12, 3]] 
...
lemma NI359N0 : Nat.card (O ⧸ I359N0) = 128881 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI359N0)

def MemCI359N0 : IdealMemCertificate B I359N0
  ![![359, 0, 0, 0], ![0, 359, 0, 0], ![335, 115, 1, 0], ![247, 34, 0, 1]] ![274705, 239846, 62205, 2985] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI359N0
...
def PI359N0 : CertifiedPrimeIdeal O 359 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI359N0
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI359N0]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI359N0 : Ideal.IsPrime I359N0 := CertifiedPrimeIdeal.isPrime PI359N0
def I359N1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![-103, -59, -5, 1]] i)))

def SI359N1: IdealEqSpanCertificate timesTableO I359N1
 ![![-103, -59, -5, 1]] 
...
lemma NI359N1 : Nat.card (O ⧸ I359N1) = 359 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI359N1)
...
def SI359N2: IdealEqSpanCertificate timesTableO I359N2
 ![![311, 142, 7, -2]] 
...
lemma NI359N2 : Nat.card (O ⧸ I359N2) = 359 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI359N2)

lemma isPrimeI359N2 : Ideal.IsPrime I359N2 := prime_ideal_of_norm_prime hp359.out _ NI359N2
def MulI359N0 : IdealMulEqCertificate timesTableO (I359N0) I359N1
...
def MulI359N1 : IdealMulEqCertificate timesTableO (I359N0*I359N1) I359N2
  ![![2855, 1660, 151, -29]] ![![311, 142, 7, -2]]
  ![![359, 0, 0, 0]] where
 T := Table
 heq := timesTableT_eq_Table
 hI1 := ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI359N0
 hI2 := rfl
...
def PBC359 : IsPrimesAboveP 359 ![I359N0, I359N1, I359N2] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI359N0
  ...
  hPprod := by 
    simp only [Fin.prod_univ_succ, Fin.prod_univ_zero, mul_one, ← Ideal.mul_assoc]
    dsimp
    rw [ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI359N1, Set.range_unique]
    dsimp ; congr 
    erw [B_int_repr]
    rfl
...
def SI367N0: IdealEqSpanCertificate timesTableO I367N0
 ![![367, 0, 0, 0], ![-88, -67, -4, 1]] 
...
lemma NI367N0 : Nat.card (O ⧸ I367N0) = 134689 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI367N0)

def MemCI367N0 : IdealMemCertificate B I367N0
  ![![367, 0, 0, 0], ![0, 367, 0, 0], ![119, 43, 1, 0], ![21, 105, 0, 1]] ![30059, 25482, 6261, 363] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI367N0
 g := ![-1969, -768, 6261, 363]
 hmem := by decide
...
def PI367N0 : CertifiedPrimeIdeal O 367 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI367N0
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI367N0]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI367N0 : Ideal.IsPrime I367N0 := CertifiedPrimeIdeal.isPrime PI367N0
def I367N1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![367, 0, 0, 0], ![77, 1, 0, 0]] i)))

def SI367N1: IdealEqSpanCertificate timesTableO I367N1
 ![![367, 0, 0, 0], ![77, 1, 0, 0]] 
...
lemma NI367N1 : Nat.card (O ⧸ I367N1) = 367 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI367N1)
...
def SI367N2: IdealEqSpanCertificate timesTableO I367N2
 ![![367, 0, 0, 0], ![-121, 1, 0, 0]] 
...
lemma NI367N2 : Nat.card (O ⧸ I367N2) = 367 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI367N2)

lemma isPrimeI367N2 : Ideal.IsPrime I367N2 := prime_ideal_of_norm_prime hp367.out _ NI367N2
def MulI367N0 : IdealMulEqCertificate timesTableO (I367N0) I367N1
 ...
 hmul := by decide
 f :=  ![![![![238669684439157, -19246665329543819, -260520219444352, -136811010131], ![-1137497022911074, 91748923398825269, 50158465433631, 0]], ![![51175276158, 0, 0, 0], ![41104, 0, 0, 0]]], ![![![-6305563250971902, 508489655445016382, 6882846163400265, 3614495405371], ![30052243302757962, -2423972030879888421, -1325167782013463, 0]], ![![-1352031538728, 0, 0, 0], ![-1085952, 0, 0, 0]]]]
 g :=  ![![![![367, 0, 0, 0], ![0, 0, 0, 0]], ![![77, 1, 0, 0], ![0, 0, 0, 0]]], ![![![9608, 4848, 291, -73], ![367, 0, 0, 0]], ![![9, 0, 0, 0], ![1, 0, 0, 0]]]]
 hle1 := by decide
 hle2 := by decide

def MulI367N1 : IdealMulEqCertificate timesTableO (I367N0*I367N1) I367N2
  ![![367, 0, 0, 0], ![-9696, -4915, -295, 74]] ![![367, 0, 0, 0], ![-121, 1, 0, 0]]
  ![![367, 0, 0, 0]] where
 T := Table
 heq := timesTableT_eq_Table
 hI1 := ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI367N0
 hI2 := rfl
 M :=  ![![![134689, 0, 0, 0], ![-44407, 367, 0, 0]], ![![-3558432, -1803805, -108265, 27158], ![1201558, 609587, 36700, -9175]]]
 hmul := by decide
 f :=  ![![![![18799487217, -1936678885740, 17576238023, -12995701], ![57017992622, -5873588859888, 4767631023, 0]], ![![24206, 0, 0, 0], ![0, 0, 0, 0]]]]
 g :=  ![![![![367, 0, 0, 0]], ![![-121, 1, 0, 0]]], ![![![-9696, -4915, -295, 74]], ![![3274, 1661, 100, -25]]]]
 hle1 := by decide
 hle2 := by decide

def PBC367 : IsPrimesAboveP 367 ![I367N0, I367N1, I367N2] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI367N0
  ...
  hPprod := by 
    simp only [Fin.prod_univ_succ, Fin.prod_univ_zero, mul_one, ← Ideal.mul_assoc]
    dsimp
    rw [ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI367N1, Set.range_unique]
    dsimp ; congr 
    erw [B_int_repr]
    rfl
...
def SI373N0: IdealEqSpanCertificate timesTableO I373N0
 ![![373, 0, 0, 0], ![-67, -67, -4, 1]] 
...
lemma NI373N0 : Nat.card (O ⧸ I373N0) = 139129 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI373N0)

def MemCI373N0 : IdealMemCertificate B I373N0
  ![![373, 0, 0, 0], ![0, 373, 0, 0], ![182, 64, 1, 0], ![288, 189, 0, 1]] ![283058, 243704, 62649, 4541] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI373N0
...
def PI373N0 : CertifiedPrimeIdeal O 373 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI373N0
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI373N0]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI373N0 : Ideal.IsPrime I373N0 := CertifiedPrimeIdeal.isPrime PI373N0
def I373N1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![373, 0, 0, 0], ![147, 1, 0, 0]] i)))

def SI373N1: IdealEqSpanCertificate timesTableO I373N1
 ![![373, 0, 0, 0], ![147, 1, 0, 0]] 
...
lemma NI373N1 : Nat.card (O ⧸ I373N1) = 373 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI373N1)
...
def SI373N2: IdealEqSpanCertificate timesTableO I373N2
 ![![373, 0, 0, 0], ![161, 1, 0, 0]] 
...
lemma NI373N2 : Nat.card (O ⧸ I373N2) = 373 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI373N2)

lemma isPrimeI373N2 : Ideal.IsPrime I373N2 := prime_ideal_of_norm_prime hp373.out _ NI373N2
def MulI373N0 : IdealMulEqCertificate timesTableO (I373N0) I373N1
 ...
 hmul := by decide
 f :=  ![![![![217790380195023979, -30536257725635483101, -235567514188402298, -189304814135511], ![-552624551442782272, 77486916727647162849, 70610654617993885, 0]], ![![41054539910, 0, 0, 0], ![30586, 0, 0, 0]]], ![![![-10971851501323937676, 1538356675220509621308, 11867428588428614803, 9536804643624027], ![27840139261368952866, -3903638640374721434490, -3557226063824098882, 0]], ![![-2068247068325, 0, 0, 0], ![-1540862, 0, 0, 0]]]]
 g :=  ![![![![373, 0, 0, 0], ![0, 0, 0, 0]], ![![147, 1, 0, 0], ![0, 0, 0, 0]]], ![![![18724, 9890, 571, -143], ![373, 0, 0, 0]], ![![25, 1, 0, 0], ![1, 0, 0, 0]]]]
 hle1 := by decide
 hle2 := by decide

def MulI373N1 : IdealMulEqCertificate timesTableO (I373N0*I373N1) I373N2
  ![![373, 0, 0, 0], ![-18791, -9957, -575, 144]] ![![373, 0, 0, 0], ![161, 1, 0, 0]]
  ![![373, 0, 0, 0]] where
 T := Table
 heq := timesTableT_eq_Table
 hI1 := ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI373N0
 hI2 := rfl
 M :=  ![![![139129, 0, 0, 0], ![60053, 373, 0, 0]], ![![-7009043, -3713961, -214475, 53712], ![-2970199, -1574060, -91012, 22753]]]
 hmul := by decide
 f :=  ![![![![40418557163397, -14082556742821, 14768398805080841, 91729738071378], ![-93640500525916, 33207669696937, -34215192310105530, 0]], ![![65844, 0, 0, 0], ![0, 0, 0, 0]]]]
 g :=  ![![![![373, 0, 0, 0]], ![![161, 1, 0, 0]]], ![![![-18791, -9957, -575, 144]], ![![-7963, -4220, -244, 61]]]]
 hle1 := by decide
 hle2 := by decide

def PBC373 : IsPrimesAboveP 373 ![I373N0, I373N1, I373N2] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI373N0
  ...
  hPprod := by 
    simp only [Fin.prod_univ_succ, Fin.prod_univ_zero, mul_one, ← Ideal.mul_assoc]
    dsimp
    rw [ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI373N1, Set.range_unique]
    dsimp ; congr 
    erw [B_int_repr]
    rfl
...
def SI379N0: IdealEqSpanCertificate timesTableO I379N0
 ![![379, 0, 0, 0]] 
...
lemma NI379N0 : Nat.card (O ⧸ I379N0) = 20632736881 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI379N0)

def MemCI379N0 : IdealMemCertificate B I379N0
  ![![379, 0, 0, 0], ![0, 379, 0, 0], ![0, 0, 379, 0], ![0, 0, 0, 379]] ![792069490964, 757302021093, 233170637703, 22975269935] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI379N0
...
def PI379N0 : CertifiedPrimeIdeal O 379 where 
  r := 4
  n := 4
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI379N0
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI379N0]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI379N0 : Ideal.IsPrime I379N0 := CertifiedPrimeIdeal.isPrime PI379N0
def PBC379 : IsPrimesAboveP 379 ![I379N0] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI379N0
...
def SI383N0: IdealEqSpanCertificate timesTableO I383N0
 ![![0, 1, 0, 0]] 
...
lemma NI383N0 : Nat.card (O ⧸ I383N0) = 383 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI383N0)
...
def SI383N1: IdealEqSpanCertificate timesTableO I383N1
 ![![406, 201, 12, -3]] 
...
lemma NI383N1 : Nat.card (O ⧸ I383N1) = 146689 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI383N1)

def MemCI383N1 : IdealMemCertificate B I383N1
  ![![383, 0, 0, 0], ![0, 383, 0, 0], ![360, 251, 1, 0], ![28, 171, 0, 1]] ![124065, 109100, 28780, 2096] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI383N1
...
def PI383N1 : CertifiedPrimeIdeal O 383 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI383N1
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI383N1]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI383N1 : Ideal.IsPrime I383N1 := CertifiedPrimeIdeal.isPrime PI383N1
def I383N2 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![-131, -68, -4, 1]] i)))

def SI383N2: IdealEqSpanCertificate timesTableO I383N2
 ![![-131, -68, -4, 1]] 
...
lemma NI383N2 : Nat.card (O ⧸ I383N2) = 383 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI383N2)

lemma isPrimeI383N2 : Ideal.IsPrime I383N2 := prime_ideal_of_norm_prime hp383.out _ NI383N2
def MulI383N0 : IdealMulEqCertificate timesTableO (I383N0) I383N1
...
def MulI383N1 : IdealMulEqCertificate timesTableO (I383N0*I383N1) I383N2
  ![![-1149, -590, -39, 9]] ![![-131, -68, -4, 1]]
  ![![383, 0, 0, 0]] where
 T := Table
 heq := timesTableT_eq_Table
 hI1 := ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI383N0
 hI2 := rfl
 M :=  ![![![383, 0, 0, 0]]]
 hmul := by decide
 f :=  ![![![![1, 0, 0, 0]]]]
...
def PBC383 : IsPrimesAboveP 383 ![I383N0, I383N1, I383N2] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI383N0
  ...
  hPprod := by 
    simp only [Fin.prod_univ_succ, Fin.prod_univ_zero, mul_one, ← Ideal.mul_assoc]
    dsimp
    rw [ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI383N1, Set.range_unique]
    dsimp ; congr 
    erw [B_int_repr]
    rfl
...
def SI389N0: IdealEqSpanCertificate timesTableO I389N0
 ![![389, 0, 0, 0]] 
...
lemma NI389N0 : Nat.card (O ⧸ I389N0) = 22898045041 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI389N0)

def MemCI389N0 : IdealMemCertificate B I389N0
  ![![389, 0, 0, 0], ![0, 389, 0, 0], ![0, 0, 389, 0], ![0, 0, 0, 389]] ![41617572283, 28019474722, 3191927441, -536438002] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI389N0
...
def PI389N0 : CertifiedPrimeIdeal O 389 where 
  r := 4
  n := 4
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI389N0
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI389N0]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI389N0 : Ideal.IsPrime I389N0 := CertifiedPrimeIdeal.isPrime PI389N0
def PBC389 : IsPrimesAboveP 389 ![I389N0] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI389N0
...
def SI397N0: IdealEqSpanCertificate timesTableO I397N0
 ![![397, 0, 0, 0], ![-49, -67, -4, 1]] 
...
lemma NI397N0 : Nat.card (O ⧸ I397N0) = 157609 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI397N0)

def MemCI397N0 : IdealMemCertificate B I397N0
  ![![397, 0, 0, 0], ![0, 397, 0, 0], ![236, 82, 1, 0], ![101, 261, 0, 1]] ![39773, 37881, 10660, 909] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI397N0
...
def PI397N0 : CertifiedPrimeIdeal O 397 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI397N0
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI397N0]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI397N0 : Ideal.IsPrime I397N0 := CertifiedPrimeIdeal.isPrime PI397N0
def I397N1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![397, 0, 0, 0], ![-214, -67, -4, 1]] i)))

def SI397N1: IdealEqSpanCertificate timesTableO I397N1
 ![![397, 0, 0, 0], ![-214, -67, -4, 1]] 
...
lemma NI397N1 : Nat.card (O ⧸ I397N1) = 157609 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI397N1)

def MemCI397N1 : IdealMemCertificate B I397N1
  ![![397, 0, 0, 0], ![0, 397, 0, 0], ![138, 314, 1, 0], ![338, 395, 0, 1]] ![30822, 27132, 6321, 623] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI397N1
...
def PI397N1 : CertifiedPrimeIdeal O 397 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI397N1
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI397N1]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI397N1 : Ideal.IsPrime I397N1 := CertifiedPrimeIdeal.isPrime PI397N1
def MulI397N0 : IdealMulEqCertificate timesTableO (I397N0) I397N1
 ...
 hmul := by decide
 f :=  ![![![![19030085483023, 5832793104920, 738417433115, -168224160535], ![-11250270340345, -26011754017075, 0, 0]], ![![21515, 0, 0, 0], ![0, 0, 0, 0]]]]
 g :=  ![![![![397, 0, 0, 0]], ![![-214, -67, -4, 1]]], ![![![-49, -67, -4, 1]], ![![-17, 0, 0, 0]]]]
 hle1 := by decide
 hle2 := by decide

def PBC397 : IsPrimesAboveP 397 ![I397N0, I397N1] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI397N0
  ...
  hPprod := by 
    simp only [Fin.prod_univ_succ, Fin.prod_univ_zero, mul_one, ← Ideal.mul_assoc]
    dsimp
    rw [ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI397N0, Set.range_unique]
    dsimp ; congr 
    erw [B_int_repr]
    rfl
...
def SI401N0: IdealEqSpanCertificate timesTableO I401N0
 ![![401, 0, 0, 0], ![39, 1, 0, 0]] 
...
lemma NI401N0 : Nat.card (O ⧸ I401N0) = 401 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI401N0)
...
def SI401N1: IdealEqSpanCertificate timesTableO I401N1
 ![![401, 0, 0, 0], ![172, 1, 0, 0]] 
...
lemma NI401N1 : Nat.card (O ⧸ I401N1) = 401 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI401N1)
...
def SI401N2: IdealEqSpanCertificate timesTableO I401N2
 ![![401, 0, 0, 0], ![-137, 1, 0, 0]] 
...
lemma NI401N2 : Nat.card (O ⧸ I401N2) = 401 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI401N2)
...
def SI401N3: IdealEqSpanCertificate timesTableO I401N3
 ![![401, 0, 0, 0], ![-75, 1, 0, 0]] 
...
lemma NI401N3 : Nat.card (O ⧸ I401N3) = 401 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI401N3)

lemma isPrimeI401N3 : Ideal.IsPrime I401N3 := prime_ideal_of_norm_prime hp401.out _ NI401N3
def MulI401N0 : IdealMulEqCertificate timesTableO (I401N0) I401N1
 ...
 hmul := by decide
 f :=  ![![![![-2048446043534376294, 7853878155073808103, 52244995239648913, 37869606288506], ![4773735823151051530, -18338300606169296121, -15185712121714448, 0]], ![![8828253212975121, 0, 0, 0], ![-119498, 9440342, 0, 0]]], ![![![1133724248511414927, -4346774052148366596, -28915293206530261, -20959151482840], ![-2642051556972397600, 10149437979744702223, 8404619744631871, 0]], ![![-4886047534002953, 0, 0, 0], ![66752, -5225430, 0, 0]]]]
...
def MulI401N1 : IdealMulEqCertificate timesTableO (I401N0*I401N1) I401N2
  ![![401, 0, 0, 0], ![-224, -161, -4, 1]] ![![401, 0, 0, 0], ![-137, 1, 0, 0]]
  ![![401, 0, 0, 0], ![-4564, -2377, -143, 36]] where
 T := Table
 heq := timesTableT_eq_Table
 hI1 := ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI401N0
 hI2 := rfl
 M :=  ![![![160801, 0, 0, 0], ![-54937, 401, 0, 0]], ![![-89824, -64561, -1604, 401], ![31071, 22165, 467, -140]]]
 hmul := by decide
 f :=  ![![![![465735527961039085, -24406008183243941283, 196767616563216344, -136105043726444], ![1363211262626989475, -71426613670809582655, 54578105871450812, 0]], ![![16662848892, 0, 0, 0], ![-12431, 0, 0, 0]]], ![![![-5300791443859018229, 277778162904752728719, -2239520147567701947, 1549086139959549], ![-15515454938000545141, 812945459127017108343, -621183352474708937, 0]], ![![-189649020816, 0, 0, 0], ![141484, 0, 0, 0]]]]
 g :=  ![![![![401, 0, 0, 0], ![0, 0, 0, 0]], ![![4427, 2378, 143, -36], ![401, 0, 0, 0]]], ![![![4340, 2216, 139, -35], ![401, 0, 0, 0]], ![![3583, 1881, 111, -28], ![308, 0, 0, 0]]]]
 hle1 := by decide
 hle2 := by decide

def MulI401N2 : IdealMulEqCertificate timesTableO (I401N0*I401N1*I401N2) I401N3
  ![![401, 0, 0, 0], ![-4564, -2377, -143, 36]] ![![401, 0, 0, 0], ![-75, 1, 0, 0]]
  ![![401, 0, 0, 0]] where
 T := Table
 heq := timesTableT_eq_Table
 hI1 := ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI401N1
 hI2 := rfl
 M :=  ![![![160801, 0, 0, 0], ![-30075, 401, 0, 0]], ![![-1830164, -953177, -57343, 14436], ![356088, 185663, 11228, -2807]]]
 hmul := by decide
 f :=  ![![![![5342937567394, -337469292140923, 4651084724101, -2032588399], ![28566905109747, -1803954923809860, 815067306767, 0]], ![![17812, 0, 0, 0], ![0, 0, 0, 0]]]]
 g :=  ![![![![401, 0, 0, 0]], ![![-75, 1, 0, 0]]], ![![![-4564, -2377, -143, 36]], ![![888, 463, 28, -7]]]]
 hle1 := by decide
 hle2 := by decide

def PBC401 : IsPrimesAboveP 401 ![I401N0, I401N1, I401N2, I401N3] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI401N0
  ...
  hPprod := by 
    simp only [Fin.prod_univ_succ, Fin.prod_univ_zero, mul_one, ← Ideal.mul_assoc]
    dsimp
    rw [ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI401N2, Set.range_unique]
    dsimp ; congr 
    erw [B_int_repr]
    rfl
...
def SI409N0: IdealEqSpanCertificate timesTableO I409N0
 ![![409, 0, 0, 0], ![-64, -67, -4, 1]] 
...
lemma NI409N0 : Nat.card (O ⧸ I409N0) = 167281 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI409N0)

def MemCI409N0 : IdealMemCertificate B I409N0
  ![![409, 0, 0, 0], ![0, 409, 0, 0], ![191, 67, 1, 0], ![291, 201, 0, 1]] ![494619, 412628, 98040, 2217] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI409N0
...
def PI409N0 : CertifiedPrimeIdeal O 409 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI409N0
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI409N0]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI409N0 : Ideal.IsPrime I409N0 := CertifiedPrimeIdeal.isPrime PI409N0
def I409N1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![409, 0, 0, 0], ![-65, 1, 0, 0]] i)))

def SI409N1: IdealEqSpanCertificate timesTableO I409N1
 ![![409, 0, 0, 0], ![-65, 1, 0, 0]] 
...
lemma NI409N1 : Nat.card (O ⧸ I409N1) = 409 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI409N1)
...
def SI409N2: IdealEqSpanCertificate timesTableO I409N2
 ![![409, 0, 0, 0], ![-3, 1, 0, 0]] 
...
lemma NI409N2 : Nat.card (O ⧸ I409N2) = 409 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI409N2)

lemma isPrimeI409N2 : Ideal.IsPrime I409N2 := prime_ideal_of_norm_prime hp409.out _ NI409N2
def MulI409N0 : IdealMulEqCertificate timesTableO (I409N0) I409N1
 ...
 hmul := by decide
 f :=  ![![![![226698438886453007300, -15644840922539790540651, 246571973966471995276, -91319677869970946], ![1426456270342606211073, -98420207464077656755540, 37349686806788800730, 0]], ![![61442029305440, 0, 0, 0], ![-64622, 0, 0, 0]]], ![![![5011754532191255894185, -345869617735755468312648, 5451110356594769357380, -2018857349398456163], ![31535500257427680205851, -2175832896071922885807896, 825711297569211591383, 0]], ![![1358334756741760, 0, 0, 0], ![-1428636, 0, 0, 0]]]]
 g :=  ![![![![-8633, -4623, -273, 68], ![409, 0, 0, 0]], ![![-65, 1, 0, 0], ![0, 0, 0, 0]]], ![![![-64, -67, -4, 1], ![0, 0, 0, 0]], ![![-11, 0, 0, 0], ![1, 0, 0, 0]]]]
 hle1 := by decide
 hle2 := by decide

def MulI409N1 : IdealMulEqCertificate timesTableO (I409N0*I409N1) I409N2
  ![![409, 0, 0, 0], ![9042, 4623, 273, -68]] ![![409, 0, 0, 0], ![-3, 1, 0, 0]]
  ![![409, 0, 0, 0]] where
 T := Table
 heq := timesTableT_eq_Table
 hI1 := ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI409N0
 hI2 := rfl
 M :=  ![![![167281, 0, 0, 0], ![-1227, 409, 0, 0]], ![![3698178, 1890807, 111657, -27812], ![-53170, -27403, -1636, 409]]]
 hmul := by decide
 f :=  ![![![![370315349824, -25116534356799, 8331480326291, -149416983], ![50486275867017, -3407392117666580, 61110414391, 0]], ![![-16642, 0, 0, 0], ![0, 0, 0, 0]]]]
 g :=  ![![![![409, 0, 0, 0]], ![![-3, 1, 0, 0]]], ![![![9042, 4623, 273, -68]], ![![-130, -67, -4, 1]]]]
 hle1 := by decide
 hle2 := by decide

def PBC409 : IsPrimesAboveP 409 ![I409N0, I409N1, I409N2] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI409N0
  ...
  hPprod := by 
    simp only [Fin.prod_univ_succ, Fin.prod_univ_zero, mul_one, ← Ideal.mul_assoc]
    dsimp
    rw [ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI409N1, Set.range_unique]
    dsimp ; congr 
    erw [B_int_repr]
    rfl
