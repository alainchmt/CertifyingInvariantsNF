...
def SI233N0: IdealEqSpanCertificate timesTableO I233N0
 ![![233, 0, 0, 0], ![-104, -67, -4, 1]] 
...
lemma NI233N0 : Nat.card (O ⧸ I233N0) = 54289 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI233N0)

def MemCI233N0 : IdealMemCertificate B I233N0
  ![![233, 0, 0, 0], ![0, 233, 0, 0], ![71, 27, 1, 0], ![180, 41, 0, 1]] ![33062, 29559, 8118, 518] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI233N0
 g := ![-2732, -905, 8118, 518]
 hmem := by decide
...
def PI233N0 : CertifiedPrimeIdeal O 233 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI233N0
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI233N0]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI233N0 : Ideal.IsPrime I233N0 := CertifiedPrimeIdeal.isPrime PI233N0
def I233N1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![233, 0, 0, 0], ![-159, -67, -4, 1]] i)))

def SI233N1: IdealEqSpanCertificate timesTableO I233N1
 ![![233, 0, 0, 0], ![-159, -67, -4, 1]] 
...
lemma NI233N1 : Nat.card (O ⧸ I233N1) = 54289 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI233N1)

def MemCI233N1 : IdealMemCertificate B I233N1
  ![![233, 0, 0, 0], ![0, 233, 0, 0], ![139, 205, 1, 0], ![164, 54, 0, 1]] ![1552852, 1297985, 274820, -6035] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI233N1
...
def PI233N1 : CertifiedPrimeIdeal O 233 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI233N1
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI233N1]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI233N1 : Ideal.IsPrime I233N1 := CertifiedPrimeIdeal.isPrime PI233N1
def MulI233N0 : IdealMulEqCertificate timesTableO (I233N0) I233N1
 ...
 hmul := by decide
 f :=  ![![![![1859738141, 871502392, 72242914, -16169296], ![-1521004822, -1762815090, 0, 0]], ![![5520, 0, 0, 0], ![0, 0, 0, 0]]]]
 g :=  ![![![![233, 0, 0, 0]], ![![-159, -67, -4, 1]]], ![![![-104, -67, -4, 1]], ![![-3, 0, 0, 0]]]]
 hle1 := by decide
 hle2 := by decide

def PBC233 : IsPrimesAboveP 233 ![I233N0, I233N1] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI233N0
  ...
  hPprod := by 
    ...
    dsimp
    rw [ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI233N0, Set.range_unique]
    dsimp ; congr 
    erw [B_int_repr]
    rfl
...
def SI239N0: IdealEqSpanCertificate timesTableO I239N0
 ![![-19, -8, 1, 0]] 
...
lemma NI239N0 : Nat.card (O ⧸ I239N0) = 57121 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI239N0)

def MemCI239N0 : IdealMemCertificate B I239N0
  ![![239, 0, 0, 0], ![0, 239, 0, 0], ![220, 231, 1, 0], ![87, 156, 0, 1]] ![274894, 239690, 62049, 3453] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI239N0
...
def PI239N0 : CertifiedPrimeIdeal O 239 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI239N0
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI239N0]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI239N0 : Ideal.IsPrime I239N0 := CertifiedPrimeIdeal.isPrime PI239N0
def I239N1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![-189, -75, -3, 1]] i)))

def SI239N1: IdealEqSpanCertificate timesTableO I239N1
 ![![-189, -75, -3, 1]] 
...
lemma NI239N1 : Nat.card (O ⧸ I239N1) = 57121 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI239N1)

def MemCI239N1 : IdealMemCertificate B I239N1
  ![![239, 0, 0, 0], ![0, 239, 0, 0], ![234, 7, 1, 0], ![35, 185, 0, 1]] ![30035, 25491, 6270, 354] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI239N1
 g := ![-6065, -351, 6270, 354]
 hmem := by decide
...
def PI239N1 : CertifiedPrimeIdeal O 239 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI239N1
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI239N1]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI239N1 : Ideal.IsPrime I239N1 := CertifiedPrimeIdeal.isPrime PI239N1
def MulI239N0 : IdealMulEqCertificate timesTableO (I239N0) I239N1
  ![![-19, -8, 1, 0]] ![![-189, -75, -3, 1]]
  ![![239, 0, 0, 0]] where
 T := Table
 heq := timesTableT_eq_Table
...
def PBC239 : IsPrimesAboveP 239 ![I239N0, I239N1] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI239N0
  ...
  hPprod := by 
    simp only [Fin.prod_univ_succ, Fin.prod_univ_zero, mul_one, ← Ideal.mul_assoc]
    dsimp
    rw [ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI239N0, Set.range_unique]
    dsimp ; congr 
    erw [B_int_repr]
    rfl
...
def SI241N0: IdealEqSpanCertificate timesTableO I241N0
 ![![-422, -201, -12, 3]] 
...
lemma NI241N0 : Nat.card (O ⧸ I241N0) = 58081 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI241N0)

def MemCI241N0 : IdealMemCertificate B I241N0
  ![![241, 0, 0, 0], ![0, 241, 0, 0], ![202, 151, 1, 0], ![105, 55, 0, 1]] ![283018, 243700, 62653, 4529] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI241N0
...
def PI241N0 : CertifiedPrimeIdeal O 241 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI241N0
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI241N0]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI241N0 : Ideal.IsPrime I241N0 := CertifiedPrimeIdeal.isPrime PI241N0
def I241N1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![6, 1, 0, 0]] i)))

def SI241N1: IdealEqSpanCertificate timesTableO I241N1
 ![![6, 1, 0, 0]] 
...
lemma NI241N1 : Nat.card (O ⧸ I241N1) = 241 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI241N1)
...
def SI241N2: IdealEqSpanCertificate timesTableO I241N2
 ![![-125, -68, -4, 1]] 
...
lemma NI241N2 : Nat.card (O ⧸ I241N2) = 241 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI241N2)

lemma isPrimeI241N2 : Ideal.IsPrime I241N2 := prime_ideal_of_norm_prime hp241.out _ NI241N2
def MulI241N0 : IdealMulEqCertificate timesTableO (I241N0) I241N1
...
def MulI241N1 : IdealMulEqCertificate timesTableO (I241N0*I241N1) I241N2
  ![![-1383, -632, -33, 9]] ![![-125, -68, -4, 1]]
  ![![241, 0, 0, 0]] where
 T := Table
 heq := timesTableT_eq_Table
 hI1 := ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI241N0
 hI2 := rfl
 M :=  ![![![-241, 0, 0, 0]]]
 hmul := by decide
 f :=  ![![![![-1, 0, 0, 0]]]]
...
def PBC241 : IsPrimesAboveP 241 ![I241N0, I241N1, I241N2] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI241N0
  ...
  hPprod := by 
    simp only [Fin.prod_univ_succ, Fin.prod_univ_zero, mul_one, ← Ideal.mul_assoc]
    dsimp
    rw [ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI241N1, Set.range_unique]
    dsimp ; congr 
    erw [B_int_repr]
    rfl
...
def SI251N0: IdealEqSpanCertificate timesTableO I251N0
 ![![251, 0, 0, 0]] 
...
lemma NI251N0 : Nat.card (O ⧸ I251N0) = 3969126001 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI251N0)

def MemCI251N0 : IdealMemCertificate B I251N0
  ![![251, 0, 0, 0], ![0, 251, 0, 0], ![0, 0, 251, 0], ![0, 0, 0, 251]] ![820576927788, 784820991609, 241761868194, 23839624835] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI251N0
...
def PI251N0 : CertifiedPrimeIdeal O 251 where 
  r := 4
  n := 4
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI251N0
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI251N0]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI251N0 : Ideal.IsPrime I251N0 := CertifiedPrimeIdeal.isPrime PI251N0
def PBC251 : IsPrimesAboveP 251 ![I251N0] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI251N0
...
def SI257N0: IdealEqSpanCertificate timesTableO I257N0
 ![![-681, -382, -27, 6]] 
...
lemma NI257N0 : Nat.card (O ⧸ I257N0) = 66049 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI257N0)

def MemCI257N0 : IdealMemCertificate B I257N0
  ![![257, 0, 0, 0], ![0, 257, 0, 0], ![49, 66, 1, 0], ![107, 62, 0, 1]] ![123093, 109100, 28780, 2394] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI257N0
...
def PI257N0 : CertifiedPrimeIdeal O 257 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI257N0
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI257N0]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI257N0 : Ideal.IsPrime I257N0 := CertifiedPrimeIdeal.isPrime PI257N0
def I257N1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![-781, -355, -17, 5]] i)))

def SI257N1: IdealEqSpanCertificate timesTableO I257N1
 ![![-781, -355, -17, 5]] 
...
lemma NI257N1 : Nat.card (O ⧸ I257N1) = 66049 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI257N1)

def MemCI257N1 : IdealMemCertificate B I257N1
  ![![257, 0, 0, 0], ![0, 257, 0, 0], ![181, 190, 1, 0], ![48, 61, 0, 1]] ![83032, 63693, 11169, -1510] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI257N1
...
def PI257N1 : CertifiedPrimeIdeal O 257 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  f := ofList [12, 134, 1]
  hfeq := by decide
  hirr := irreducible_ofList_ofCertificateIrreducibleZModOfList' P257P1
  hneq := by decide
  hlen := by decide
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI257N1
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI257N1]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI257N1 : Ideal.IsPrime I257N1 := CertifiedPrimeIdeal.isPrime PI257N1
def MulI257N0 : IdealMulEqCertificate timesTableO (I257N0) I257N1
...
def PBC257 : IsPrimesAboveP 257 ![I257N0, I257N1] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI257N0
  ...
  hPprod := by 
    simp only [Fin.prod_univ_succ, Fin.prod_univ_zero, mul_one, ← Ideal.mul_assoc]
    dsimp
    rw [ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI257N0, Set.range_unique]
    dsimp ; congr 
    erw [B_int_repr]
    rfl
...
def SI263N0: IdealEqSpanCertificate timesTableO I263N0
 ![![263, 0, 0, 0], ![-119, -159, -4, 1]] 
...
lemma NI263N0 : Nat.card (O ⧸ I263N0) = 69169 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI263N0)

def MemCI263N0 : IdealMemCertificate B I263N0
  ![![263, 0, 0, 0], ![0, 263, 0, 0], ![150, 237, 1, 0], ![218, 0, 0, 1]] ![39887, 37896, 10600, 894] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI263N0
...
def PI263N0 : CertifiedPrimeIdeal O 263 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI263N0
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI263N0]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI263N0 : Ideal.IsPrime I263N0 := CertifiedPrimeIdeal.isPrime PI263N0
def I263N1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![263, 0, 0, 0], ![-82, -42, -4, 1]] i)))

def SI263N1: IdealEqSpanCertificate timesTableO I263N1
 ![![263, 0, 0, 0], ![-82, -42, -4, 1]] 
...
lemma NI263N1 : Nat.card (O ⧸ I263N1) = 69169 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI263N1)

def MemCI263N1 : IdealMemCertificate B I263N1
  ![![263, 0, 0, 0], ![0, 263, 0, 0], ![157, 25, 1, 0], ![20, 58, 0, 1]] ![30717, 27082, 6371, 573] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI263N1
 g := ![-3730, -629, 6371, 573]
 hmem := by decide
...
def PI263N1 : CertifiedPrimeIdeal O 263 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI263N1
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI263N1]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI263N1 : Ideal.IsPrime I263N1 := CertifiedPrimeIdeal.isPrime PI263N1
def MulI263N0 : IdealMulEqCertificate timesTableO (I263N0) I263N1
 ...
 hmul := by decide
 f :=  ![![![![64101541308349703060062, 43023254414087135829930, 6783920889366364116473, -465430798270458109478], ![-26961612878448940191251, -49789922850878202224925, 0, 0]], ![![144270944769285459, -15674577, 0, 0], ![0, 0, 0, 0]]]]
 g :=  ![![![![263, 0, 0, 0]], ![![-82, -42, -4, 1]]], ![![![-119, -159, -4, 1]], ![![-126, -83, -13, 1]]]]
 hle1 := by decide
 hle2 := by decide

def PBC263 : IsPrimesAboveP 263 ![I263N0, I263N1] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI263N0
  ...
  hPprod := by 
    simp only [Fin.prod_univ_succ, Fin.prod_univ_zero, mul_one, ← Ideal.mul_assoc]
    dsimp
    rw [ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI263N0, Set.range_unique]
    dsimp ; congr 
    erw [B_int_repr]
    rfl
...
def SI269N0: IdealEqSpanCertificate timesTableO I269N0
 ![![269, 0, 0, 0]] 
...
lemma NI269N0 : Nat.card (O ⧸ I269N0) = 5236114321 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI269N0)

def MemCI269N0 : IdealMemCertificate B I269N0
  ![![269, 0, 0, 0], ![0, 269, 0, 0], ![0, 0, 269, 0], ![0, 0, 0, 269]] ![5403807691939, 5126948236894, 1560909084807, 151175487271] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI269N0
...
def PI269N0 : CertifiedPrimeIdeal O 269 where 
  r := 4
  n := 4
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI269N0
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI269N0]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI269N0 : Ideal.IsPrime I269N0 := CertifiedPrimeIdeal.isPrime PI269N0
def PBC269 : IsPrimesAboveP 269 ![I269N0] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI269N0
...
def SI271N0: IdealEqSpanCertificate timesTableO I271N0
 ![![271, 0, 0, 0], ![-102, -67, -4, 1]] 
...
lemma NI271N0 : Nat.card (O ⧸ I271N0) = 73441 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI271N0)

def MemCI271N0 : IdealMemCertificate B I271N0
  ![![271, 0, 0, 0], ![0, 271, 0, 0], ![77, 29, 1, 0], ![206, 49, 0, 1]] ![30095, 25593, 6372, 252] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI271N0
 g := ![-1891, -633, 6372, 252]
 hmem := by decide
...
def PI271N0 : CertifiedPrimeIdeal O 271 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI271N0
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI271N0]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI271N0 : Ideal.IsPrime I271N0 := CertifiedPrimeIdeal.isPrime PI271N0
def I271N1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![271, 0, 0, 0], ![-161, -67, -4, 1]] i)))

def SI271N1: IdealEqSpanCertificate timesTableO I271N1
 ![![271, 0, 0, 0], ![-161, -67, -4, 1]] 
...
lemma NI271N1 : Nat.card (O ⧸ I271N1) = 73441 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI271N1)

def MemCI271N1 : IdealMemCertificate B I271N1
  ![![271, 0, 0, 0], ![0, 271, 0, 0], ![171, 241, 1, 0], ![252, 84, 0, 1]] ![6194, 5663, 1757, 40] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI271N1
 g := ![-1123, -1554, 1757, 40]
 hmem := by decide
...
def PI271N1 : CertifiedPrimeIdeal O 271 where 
  r := 4
  n := 2
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI271N1
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI271N1]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI271N1 : Ideal.IsPrime I271N1 := CertifiedPrimeIdeal.isPrime PI271N1
def MulI271N0 : IdealMulEqCertificate timesTableO (I271N0) I271N1
 ...
 hmul := by decide
 f :=  ![![![![3869427724945968, 1776976567598515, 146150197741855, -32949104277295], ![-2740416397197632, -3889874551454925, 0, 0]], ![![1979802, 0, 0, 0], ![0, 0, 0, 0]]]]
 g :=  ![![![![271, 0, 0, 0]], ![![-161, -67, -4, 1]]], ![![![-102, -67, -4, 1]], ![![-3, 0, 0, 0]]]]
 hle1 := by decide
 hle2 := by decide

def PBC271 : IsPrimesAboveP 271 ![I271N0, I271N1] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI271N0
  ...
  hPprod := by 
    simp only [Fin.prod_univ_succ, Fin.prod_univ_zero, mul_one, ← Ideal.mul_assoc]
    dsimp
    rw [ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI271N0, Set.range_unique]
    dsimp ; congr 
    erw [B_int_repr]
    rfl
...
def SI277N0: IdealEqSpanCertificate timesTableO I277N0
 ![![277, 0, 0, 0], ![32, 1, 0, 0]] 
...
lemma NI277N0 : Nat.card (O ⧸ I277N0) = 277 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI277N0)
...
def SI277N1: IdealEqSpanCertificate timesTableO I277N1
 ![![277, 0, 0, 0], ![-114, 1, 0, 0]] 
...
lemma NI277N1 : Nat.card (O ⧸ I277N1) = 277 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI277N1)
...
def SI277N2: IdealEqSpanCertificate timesTableO I277N2
 ![![277, 0, 0, 0], ![-113, 1, 0, 0]] 
...
lemma NI277N2 : Nat.card (O ⧸ I277N2) = 277 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI277N2)
...
def SI277N3: IdealEqSpanCertificate timesTableO I277N3
 ![![277, 0, 0, 0], ![-83, 1, 0, 0]] 
...
lemma NI277N3 : Nat.card (O ⧸ I277N3) = 277 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI277N3)

lemma isPrimeI277N3 : Ideal.IsPrime I277N3 := prime_ideal_of_norm_prime hp277.out _ NI277N3
def MulI277N0 : IdealMulEqCertificate timesTableO (I277N0) I277N1
 ...
 hmul := by decide
 f :=  ![![![![-1077307756069858776689, 8512667574670927758161, -85838883386804197263, 98677685216416202], ![-2617668700913691430043, 20661326754380772041970, -27333718804947280859, 0]], ![![516474689334996, 0, 0, 0], ![45705, -1965315, 0, 0]]], ![![![246163634132310871999, -1945135152452474755495, 19614090184814495861, -22547742243360377], ![598134411212328163108, -4721090376632781420456, 6245724601410822807, 0]], ![![-118013896909083, 0, 0, 0], ![-10725, 449295, 0, 0]]]]
...
def MulI277N1 : IdealMulEqCertificate timesTableO (I277N0*I277N1) I277N2
  ![![277, 0, 0, 0], ![-65, -72, -4, 1]] ![![277, 0, 0, 0], ![-113, 1, 0, 0]]
  ![![277, 0, 0, 0], ![-3871, -1893, -115, 29]] where
 T := Table
 heq := timesTableT_eq_Table
 hI1 := ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI277N0
 hI2 := rfl
 M :=  ![![![76729, 0, 0, 0], ![-31301, 277, 0, 0]], ![![-18005, -19944, -1108, 277], ![7728, 8403, 460, -116]]]
 hmul := by decide
 f :=  ![![![![111497847989218, -8057545518466533, 81503216528350, -90390137698], ![273306190903867, -19749276523986706, 25018001667868, 0]], ![![20066452670, 0, 0, 0], ![-52076, 0, 0, 0]]], ![![![-1558152459021686, 112602033041118860, -1138985545839264, 1263177880692], ![-3819380562967379, 275990831525003574, -349619849364003, 0]], ![![-280423282920, 0, 0, 0], ![727748, 0, 0, 0]]]]
 g :=  ![![![![277, 0, 0, 0], ![0, 0, 0, 0]], ![![3758, 1894, 115, -29], ![277, 0, 0, 0]]], ![![![3806, 1821, 111, -28], ![277, 0, 0, 0]], ![![3843, 1896, 115, -29], ![273, 0, 0, 0]]]]
 hle1 := by decide
 hle2 := by decide

def MulI277N2 : IdealMulEqCertificate timesTableO (I277N0*I277N1*I277N2) I277N3
  ![![277, 0, 0, 0], ![-3871, -1893, -115, 29]] ![![277, 0, 0, 0], ![-83, 1, 0, 0]]
  ![![277, 0, 0, 0]] where
 T := Table
 heq := timesTableT_eq_Table
 hI1 := ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI277N1
 hI2 := rfl
 M :=  ![![![76729, 0, 0, 0], ![-22991, 277, 0, 0]], ![![-1072267, -524361, -31855, 8033], ![332400, 162876, 9972, -2493]]]
 hmul := by decide
 f :=  ![![![![2318257107725, -10488075544164, 136815886886, -130001830], ![7736833362900, -34909158032340, 36010134434, 0]], ![![12844, 0, 0, 0], ![0, 0, 0, 0]]]]
 g :=  ![![![![277, 0, 0, 0]], ![![-83, 1, 0, 0]]], ![![![-3871, -1893, -115, 29]], ![![1200, 588, 36, -9]]]]
 hle1 := by decide
 hle2 := by decide

def PBC277 : IsPrimesAboveP 277 ![I277N0, I277N1, I277N2, I277N3] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI277N0
  ...
  hPprod := by 
    simp only [Fin.prod_univ_succ, Fin.prod_univ_zero, mul_one, ← Ideal.mul_assoc]
    dsimp
    rw [ideal_eq_mul_of_IdealMulEqCertificate timesTableO _ _ _ _ _ MulI277N2, Set.range_unique]
    dsimp ; congr 
    erw [B_int_repr]
    rfl
...
def SI281N0: IdealEqSpanCertificate timesTableO I281N0
 ![![281, 0, 0, 0]] 
...
lemma NI281N0 : Nat.card (O ⧸ I281N0) = 6234839521 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate SI281N0)

def MemCI281N0 : IdealMemCertificate B I281N0
  ![![281, 0, 0, 0], ![0, 281, 0, 0], ![0, 0, 281, 0], ![0, 0, 0, 281]] ![100239295118613, 95789812493111, 29471526103734, 2900754779345] where
 hieq := ideal_eq_of_IdealEqSpanCertificate SI281N0
...
def PI281N0 : CertifiedPrimeIdeal O 281 where 
  r := 4
  n := 4
  hpos := by decide
  TT := timesTableO
  ...
  hBz := B_one_repr
  hpol := by decide
  hcmem := mem_of_certificate _ _ _ _ MemCI281N0
  hpmem := by 
    erw [← Submodule.mem_carrier (R := O), ideal_eq_of_IdealEqSpanCertificate SI281N0]
    apply Submodule.subset_span
    use 0 ; dsimp ; congr ; norm_num

        
lemma isPrimeI281N0 : Ideal.IsPrime I281N0 := CertifiedPrimeIdeal.isPrime PI281N0
def PBC281 : IsPrimesAboveP 281 ![I281N0] where 
  Ip := by 
    intro i 
    fin_cases i 
    exact isPrimeI281N0
