...
import IdealArithmetic.Examples.NF3_1_249879_1.Irreducible3_1_249879_1
...
noncomputable def T : ℤ[X] := X^3 - X^2 + 30*X - 192
lemma T_def : T = X^3 - X^2 + 30*X - 192 := rfl
