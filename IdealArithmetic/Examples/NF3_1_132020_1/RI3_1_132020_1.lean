...
import IdealArithmetic.Examples.NF3_1_132020_1.Irreducible3_1_132020_1
...
noncomputable def T : ℤ[X] := X^3 - X^2 + 70
lemma T_def : T = X^3 - X^2 + 70 := rfl
