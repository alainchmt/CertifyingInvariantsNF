...
import IdealArithmetic.Examples.NF3_1_304535_3.Irreducible3_1_304535_3
...
noncomputable def T : ℤ[X] := X^3 + 35*X - 525
lemma T_def : T = X^3 + 35*X - 525 := rfl
