...
import IdealArithmetic.Examples.NF3_1_117720_1.Irreducible3_1_117720_1
...
noncomputable def T : ℤ[X] := X^3 + 27*X - 38
lemma T_def : T = X^3 + 27*X - 38 := rfl
