...
import IdealArithmetic.Examples.NF3_1_702351_1.Irreducible3_1_702351_1
...
noncomputable def T : ℤ[X] := X^3 - 3*X - 1129
lemma T_def : T = X^3 - 3*X - 1129 := rfl
