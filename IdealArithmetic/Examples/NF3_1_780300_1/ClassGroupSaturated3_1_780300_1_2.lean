...
def I2 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![23, 0, 0], ![1, 1, 0]] i)))
...
def A2: IdealEqSpanCertificate' Table ![![23, 0, 0], ![1, 1, 0]] 
...
def Log02Mem : IdealMemCertificate B I0
 ![![3, 0, 0], ![2, 1, 0], ![1, 0, 1]] ![782, -144, -64] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![378, -144, -64]
 hmem := by decide
...
def Log20Mem : IdealMemCertificate B I2
 ![![23, 0, 0], ![1, 1, 0], ![9, 0, 1]] ![-16, -2, 1] where
...
def Log21Mem : IdealMemCertificate B I2
 ![![23, 0, 0], ![1, 1, 0], ![9, 0, 1]] ![-23, 0, 0] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![-1, 0, 0]
 hmem := by decide
...
def Log22Mem : IdealMemCertificate B I2
 ![![23, 0, 0], ![1, 1, 0], ![9, 0, 1]] ![775, -144, -64] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![65, -144, -64]
 hmem := by decide
