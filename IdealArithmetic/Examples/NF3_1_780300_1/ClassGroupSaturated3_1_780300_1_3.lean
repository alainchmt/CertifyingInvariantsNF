...
instance hq157 : Fact $ Nat.Prime 157 := {out := by norm_num}
...
def R157 : IsOrderOf (5 : ZMod 157) 156 where
 m := 3
 P := ![2, 3, 13]
 e := ![2, 1, 1]
 hP := fun i => by fin_cases i <;> norm_num
...
def I1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![37, 0, 0], ![1, 1, 0]] i)))
def I2 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![157, 0, 0], ![-69, 1, 0]] i)))
...
def A1: IdealEqSpanCertificate' Table ![![37, 0, 0], ![1, 1, 0]] 
...
def A2: IdealEqSpanCertificate' Table ![![157, 0, 0], ![-69, 1, 0]] 
...
lemma N2 : Nat.card (O ⧸ I2) = 157 := 
ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2)

def Log00Mem : IdealMemCertificate B I0
 ![![13, 0, 0], ![2, 1, 0], ![7, 0, 1]] ![-10, -2, 1] where
...
def Log01Mem : IdealMemCertificate B I0
 ![![13, 0, 0], ![2, 1, 0], ![7, 0, 1]] ![772, -144, -64] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![116, -144, -64]
 hmem := by decide
...
def Log02Mem : IdealMemCertificate B I0
 ![![13, 0, 0], ![2, 1, 0], ![7, 0, 1]] ![13, 0, 0] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![1, 0, 0]
 hmem := by decide
...
def Log10Mem : IdealMemCertificate B I1
 ![![37, 0, 0], ![1, 1, 0], ![22, 0, 1]] ![-17, -2, 1] where
...
def Log11Mem : IdealMemCertificate B I1
 ![![37, 0, 0], ![1, 1, 0], ![22, 0, 1]] ![779, -144, -64] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![63, -144, -64]
 hmem := by decide
...
def Log12Mem : IdealMemCertificate B I1
 ![![37, 0, 0], ![1, 1, 0], ![22, 0, 1]] ![0, 0, 0] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![0, 0, 0]
 hmem := by decide
...
def Log20Mem : IdealMemCertificate B I2
 ![![157, 0, 0], ![88, 1, 0], ![84, 0, 1]] ![-92, -2, 1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![0, -2, 1]
 hmem := by decide

def Log20: DiscreteLogCertificate N2 ((orderOf_of_IsOrderOf R157) ▸ IsPrimitiveRoot.orderOf _) 3 zeta1 0 where
 r := 3
 hN := by infer_instance
 hpdvd := by decide
 B := B
...
def Log21Mem : IdealMemCertificate B I2
 ![![157, 0, 0], ![88, 1, 0], ![84, 0, 1]] ![635, -144, -64] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![119, -144, -64]
 hmem := by decide

def Log21: DiscreteLogCertificate N2 ((orderOf_of_IsOrderOf R157) ▸ IsPrimitiveRoot.orderOf _) 3 alpha0 0 where
 r := 3
 hN := by infer_instance
 hpdvd := by decide
 B := B
...
def Log22Mem : IdealMemCertificate B I2
 ![![157, 0, 0], ![88, 1, 0], ![84, 0, 1]] ![0, 0, 0] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![0, 0, 0]
 hmem := by decide

def Log22: DiscreteLogCertificate N2 ((orderOf_of_IsOrderOf R157) ▸ IsPrimitiveRoot.orderOf _) 3 alpha1 2 where
 r := 3
 hN := by infer_instance
 hpdvd := by decide
 B := B
