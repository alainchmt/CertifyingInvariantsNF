...
import IdealArithmetic.Examples.NF3_1_89544_1.Irreducible3_1_89544_1
...
noncomputable def T : ℤ[X] := X^3 - X^2 - 14*X + 66
lemma T_def : T = X^3 - X^2 - 14*X + 66 := rfl
