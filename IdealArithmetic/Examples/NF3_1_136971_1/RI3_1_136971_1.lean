...
import IdealArithmetic.Examples.NF3_1_136971_1.Irreducible3_1_136971_1
...
noncomputable def T : ℤ[X] := X^3 + 6*X - 71
lemma T_def : T = X^3 + 6*X - 71 := rfl
