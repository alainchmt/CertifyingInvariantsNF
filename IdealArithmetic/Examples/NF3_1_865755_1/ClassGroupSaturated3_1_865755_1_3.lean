...
def Log00Mem : IdealMemCertificate B I0
 ![![7, 0, 0], ![5, 1, 0], ![0, 0, 1]] ![-4036548, -516692, 241930] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![-207584, -516692, 241930]
 hmem := by decide
...
def Log00: DiscreteLogCertificate N0 ((orderOf_of_IsOrderOf R7) ▸ IsPrimitiveRoot.orderOf _) 3 zeta1 1 where
 ...
 B := B
 hone := B_one
 xcoord := ![-4036545, -516692, 241930]
 hxeq :=  rfl
 m := 3
 C := ![-4036548, -516692, 241930]
 hCeq := by rfl
...
def Log01Mem : IdealMemCertificate B I0
 ![![7, 0, 0], ![5, 1, 0], ![0, 0, 1]] ![17, 2, -1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![1, 2, -1]
 hmem := by decide
...
def Log10Mem : IdealMemCertificate B I1
 ![![19, 0, 0], ![5, 1, 0], ![2, 0, 1]] ![-4036555, -516692, 241930] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![-101945, -516692, 241930]
 hmem := by decide
...
def Log11Mem : IdealMemCertificate B I1
 ![![19, 0, 0], ![5, 1, 0], ![2, 0, 1]] ![8, 2, -1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![0, 2, -1]
 hmem := by decide
