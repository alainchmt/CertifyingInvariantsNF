...
import IdealArithmetic.Examples.NF3_1_203987_1.Irreducible3_1_203987_1
...
noncomputable def T : ℤ[X] := X^3 - X^2 - 51*X - 440
lemma T_def : T = X^3 - X^2 - 51*X - 440 := rfl
