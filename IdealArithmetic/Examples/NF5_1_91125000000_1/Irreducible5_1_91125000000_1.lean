...
def P7PI1 : CertificateIrreducibleZModOfList' 7 4 2 2 [3, 6, 2, 4, 1] where
 m := 1
 P := ![2]
 exp := ![2]
 hneq := by decide
...
def P23PI0 : CertificateIrreducibleZModOfList' 23 2 2 4 [11, 20, 1] where
 m := 1
 P := ![2]
 exp := ![1]
 hneq := by decide
...
def P23PI1 : CertificateIrreducibleZModOfList' 23 3 2 4 [22, 21, 3, 1] where
 m := 1
 P := ![3]
 exp := ![1]
 hneq := by decide
...
noncomputable def C : IrreducibleCertificateIntPolynomial T l where
 ...
 hirr := by
  ...
  · exact irreducible_ofList_of_linear (R := ZMod 7) _ (by decide) rfl
  · dsimp ; exact irreducible_ofList_ofCertificateIrreducibleZModOfList' P7PI1
  · dsimp ; exact irreducible_ofList_ofCertificateIrreducibleZModOfList' P23PI0
  · dsimp ; exact irreducible_ofList_ofCertificateIrreducibleZModOfList' P23PI1
 hm := by decide
 hprod := by decide
 hinter := by decide
