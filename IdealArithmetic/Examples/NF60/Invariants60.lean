import IdealArithmetic.Examples.NF60.NonPrincipalExample60

/- Number field `K(α)` with with α root of polynomial `X^5 + 15*X^3 - 50*X^2 - 480`.
Class number `2`, generated by class of ideal `J = (2, 1/8*a^4 + 1/2*a^3 - 1/8*a^2 + 5/4*a - 27)`. We have `J ^ 2` is principal. -/
