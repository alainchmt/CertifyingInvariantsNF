...
import IdealArithmetic.Examples.NF3_3_658476_1.Irreducible3_3_658476_1
...
noncomputable def T : ℤ[X] := X^3 - 87*X - 2
lemma T_def : T = X^3 - 87*X - 2 := rfl
