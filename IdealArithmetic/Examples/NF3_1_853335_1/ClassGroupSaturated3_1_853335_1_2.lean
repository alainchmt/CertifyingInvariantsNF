...
def I0 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![3, 0, 0], ![-4, 0, 1]] i)))
def I1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![5, 0, 0], ![1, 1, 0]] i)))
def I2 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![11, 0, 0], ![2, 1, 0]] i)))

def A0: IdealEqSpanCertificate' Table ![![3, 0, 0], ![-4, 0, 1]] 
...
def A2: IdealEqSpanCertificate' Table ![![11, 0, 0], ![2, 1, 0]] 
...
def Log00Mem : IdealMemCertificate B I0
 ![![3, 0, 0], ![0, 1, 0], ![2, 0, 1]] ![683074292, 403526284, -316232396] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![438513028, 403526284, -316232396]
 hmem := by decide
...
def Log02Mem : IdealMemCertificate B I0
 ![![3, 0, 0], ![0, 1, 0], ![2, 0, 1]] ![14790, -938, -57] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![4968, -938, -57]
 hmem := by decide
...
def Log10Mem : IdealMemCertificate B I1
 ![![5, 0, 0], ![1, 1, 0], ![4, 0, 1]] ![683074290, 403526284, -316232396] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![308895518, 403526284, -316232396]
 hmem := by decide
...
def Log10: DiscreteLogCertificate N1 ((orderOf_of_IsOrderOf R5) ▸ IsPrimitiveRoot.orderOf _) 2 zeta1 1 where
 ...
 hxeq :=  rfl
 m := 3
 C := ![683074290, 403526284, -316232396]
 hCeq := by rfl
...
def Log12Mem : IdealMemCertificate B I1
 ![![5, 0, 0], ![1, 1, 0], ![4, 0, 1]] ![14789, -938, -57] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![3191, -938, -57]
 hmem := by decide
...
def Log20Mem : IdealMemCertificate B I2
 ![![11, 0, 0], ![2, 1, 0], ![8, 0, 1]] ![683074284, 403526284, -316232396] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![218716444, 403526284, -316232396]
 hmem := by decide
...
def Log20: DiscreteLogCertificate N2 ((orderOf_of_IsOrderOf R11) ▸ IsPrimitiveRoot.orderOf _) 2 zeta1 0 where
 ...
 hxeq :=  rfl
 m := 9
 C := ![683074284, 403526284, -316232396]
 hCeq := by rfl
...
def Log21Mem : IdealMemCertificate B I2
 ![![11, 0, 0], ![2, 1, 0], ![8, 0, 1]] ![-11, 0, 0] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![-1, 0, 0]
 hmem := by decide
...
def Log22Mem : IdealMemCertificate B I2
 ![![11, 0, 0], ![2, 1, 0], ![8, 0, 1]] ![14784, -938, -57] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![1556, -938, -57]
 hmem := by decide
