...
import IdealArithmetic.Examples.NF3_1_866700_5.Irreducible3_1_866700_5
...
noncomputable def T : ℤ[X] := X^3 - 30*X - 2330
lemma T_def : T = X^3 - 30*X - 2330 := rfl
...
-- We build the subalgebra with integral basis [1, a, 1/13*a^2 - 6/13*a + 6/13] 
...
noncomputable def BQ : SubalgebraBuilderLists 3 ℤ  ℚ K T l where
 ...
 hofL := T_ofList.symm
 hm := rfl
 B := ![![13, 0, 0], ![0, 13, 0], ![6, -6, 1]]
 a := ![ ![![1, 0, 0],![0, 1, 0],![0, 0, 1]], 
![![0, 1, 0],![-6, 6, 13],![182, 0, -6]], 
![![0, 0, 1],![182, 0, -6],![-168, 14, 6]]]
 s := ![![[], [], []],![[], [], [-13]],![[], [-13], [12, -1]]]
 h := Adj
 honed := by decide
 hd := by norm_num
