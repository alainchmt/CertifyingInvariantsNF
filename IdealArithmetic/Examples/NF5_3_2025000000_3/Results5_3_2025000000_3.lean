import IdealArithmetic.Examples.NF5_3_2025000000_3.Invariants5_3_2025000000_3

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 - 60*X^3 - 20*X^2 + 135*X + 816`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 - 60*X^3 - 20*X^2 + 135*X + 816)) := rfl

lemma T_irreducible' : Irreducible (X^5 - 60*X^3 - 20*X^2 + 135*X + 816 : ℤ[X]) := irreducible_T
