...
import IdealArithmetic.Examples.NF3_1_138355_1.Irreducible3_1_138355_1
...
noncomputable def T : ℤ[X] := X^3 - X^2 - 5*X - 70
lemma T_def : T = X^3 - X^2 - 5*X - 70 := rfl
