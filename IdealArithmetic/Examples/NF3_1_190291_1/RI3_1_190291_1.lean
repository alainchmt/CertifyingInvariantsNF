...
import IdealArithmetic.Examples.NF3_1_190291_1.Irreducible3_1_190291_1
...
noncomputable def T : ℤ[X] := X^3 + 37*X - 666
lemma T_def : T = X^3 + 37*X - 666 := rfl
