...
import IdealArithmetic.Examples.NF3_1_35075_1.Irreducible3_1_35075_1
...
noncomputable def T : ℤ[X] := X^3 - X^2 + 22*X - 68
lemma T_def : T = X^3 - X^2 + 22*X - 68 := rfl
