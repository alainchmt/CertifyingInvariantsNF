...
def A1: IdealEqSpanCertificate' Table ![![13, 0, 0], ![6, 1, 0]] 
 ![![13, 0, 0], ![6, 1, 0], ![8, 0, 1]] where
  M :=![![![13, 0, 0], ![0, 13, 0], ![0, 0, 13]], ![![6, 1, 0], ![0, 6, 2], ![154, 35, 6]]]
  hmulB := by decide  
  f := ![![![19, 3, 0], ![-39, 0, 0]], ![![6, 1, 0], ![-12, 0, 0]], ![![8, -2, -1], ![-16, 7, 0]]]
  g := ![![![1, 0, 0], ![-6, 13, 0], ![-8, 0, 13]], ![![0, 1, 0], ![-4, 6, 2], ![-8, 35, 6]]]
  hle1 := by decide   
  hle2 := by decide  
...
def Log00Mem : IdealMemCertificate B I0
 ![![7, 0, 0], ![0, 1, 0], ![0, 0, 1]] ![749, -2092, 402] where
...
def Log01Mem : IdealMemCertificate B I0
 ![![7, 0, 0], ![0, 1, 0], ![0, 0, 1]] ![-56, 10, -1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![-8, 10, -1]
 hmem := by decide
...
def Log10Mem : IdealMemCertificate B I1
 ![![13, 0, 0], ![6, 1, 0], ![8, 0, 1]] ![752, -2092, 402] where
...
def Log11Mem : IdealMemCertificate B I1
 ![![13, 0, 0], ![6, 1, 0], ![8, 0, 1]] ![-52, 10, -1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![-8, 10, -1]
 hmem := by decide
...
def Log12Mem : IdealMemCertificate B I1
 ![![13, 0, 0], ![6, 1, 0], ![8, 0, 1]] ![-6, -1, 0] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![0, -1, 0]
 hmem := by decide
...
def Log20Mem : IdealMemCertificate B I2
 ![![19, 0, 0], ![10, 1, 0], ![7, 0, 1]] ![742, -2092, 402] where
...
def Log21Mem : IdealMemCertificate B I2
 ![![19, 0, 0], ![10, 1, 0], ![7, 0, 1]] ![-59, 10, -1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![-8, 10, -1]
 hmem := by decide
...
def Log22Mem : IdealMemCertificate B I2
 ![![19, 0, 0], ![10, 1, 0], ![7, 0, 1]] ![-10, -1, 0] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![0, -1, 0]
 hmem := by decide
