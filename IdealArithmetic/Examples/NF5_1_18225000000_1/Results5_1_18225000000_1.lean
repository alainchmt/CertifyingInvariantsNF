import IdealArithmetic.Examples.NF5_1_18225000000_1.Invariants5_1_18225000000_1

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 + 90*X^3 - 120*X^2 + 2160*X - 5184`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 + 90*X^3 - 120*X^2 + 2160*X - 5184)) := rfl

lemma T_irreducible' : Irreducible (X^5 + 90*X^3 - 120*X^2 + 2160*X - 5184 : ℤ[X]) := irreducible_T
