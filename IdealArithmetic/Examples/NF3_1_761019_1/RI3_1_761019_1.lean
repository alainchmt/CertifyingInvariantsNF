...
import IdealArithmetic.Examples.NF3_1_761019_1.Irreducible3_1_761019_1
...
noncomputable def T : ℤ[X] := X^3 - X^2 + 124*X + 372
lemma T_def : T = X^3 - X^2 + 124*X + 372 := rfl
