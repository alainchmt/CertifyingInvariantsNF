import IdealArithmetic.Examples.NF5_3_15187500000_5.Invariants5_3_15187500000_5

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 - 25*X^3 - 350*X^2 + 1200*X + 320`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 - 25*X^3 - 350*X^2 + 1200*X + 320)) := rfl

lemma T_irreducible' : Irreducible (X^5 - 25*X^3 - 350*X^2 + 1200*X + 320 : ℤ[X]) := irreducible_T
