import IdealArithmetic.Examples.NF5_1_10125000000_17.Invariants5_1_10125000000_17

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 + 75*X - 60`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 + 75*X - 60)) := rfl

lemma T_irreducible' : Irreducible (X^5 + 75*X - 60 : ℤ[X]) := irreducible_T
