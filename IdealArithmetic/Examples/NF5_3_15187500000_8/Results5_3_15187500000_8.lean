import IdealArithmetic.Examples.NF5_3_15187500000_8.Invariants5_3_15187500000_8

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 - 25*X^3 - 50*X^2 - 150*X + 920`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 - 25*X^3 - 50*X^2 - 150*X + 920)) := rfl

lemma T_irreducible' : Irreducible (X^5 - 25*X^3 - 50*X^2 - 150*X + 920 : ℤ[X]) := irreducible_T
