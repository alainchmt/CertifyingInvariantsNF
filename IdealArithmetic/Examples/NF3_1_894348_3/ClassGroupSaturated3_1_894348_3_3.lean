...
def I1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![7, 0, 0], ![0, 0, 1]] i)))
...
def A1: IdealEqSpanCertificate' Table ![![7, 0, 0], ![0, 0, 1]] 
...
def Log00Mem : IdealMemCertificate B I0
 ![![19, 0, 0], ![8, 1, 0], ![18, 0, 1]] ![6540, 986, -1027] where
...
def Log01Mem : IdealMemCertificate B I0
 ![![19, 0, 0], ![8, 1, 0], ![18, 0, 1]] ![2, -2, 1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![0, -2, 1]
 hmem := by decide
...
def Log02Mem : IdealMemCertificate B I0
 ![![19, 0, 0], ![8, 1, 0], ![18, 0, 1]] ![7, 1, 1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![-1, 1, 1]
 hmem := by decide
...
def Log10Mem : IdealMemCertificate B I1
 ![![7, 0, 0], ![0, 1, 0], ![0, 0, 1]] ![6552, 986, -1027] where
...
def Log20Mem : IdealMemCertificate B I2
 ![![13, 0, 0], ![0, 1, 0], ![0, 0, 1]] ![6552, 986, -1027] where
...
def Log21Mem : IdealMemCertificate B I2
 ![![13, 0, 0], ![0, 1, 0], ![0, 0, 1]] ![0, -2, 1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![0, -2, 1]
 hmem := by decide
...
def Log22Mem : IdealMemCertificate B I2
 ![![13, 0, 0], ![0, 1, 0], ![0, 0, 1]] ![0, 1, 1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![0, 1, 1]
 hmem := by decide
