...
import IdealArithmetic.Examples.NF3_1_760455_3.Irreducible3_1_760455_3
...
noncomputable def T : ℤ[X] := X^3 + 207*X - 257
lemma T_def : T = X^3 + 207*X - 257 := rfl
