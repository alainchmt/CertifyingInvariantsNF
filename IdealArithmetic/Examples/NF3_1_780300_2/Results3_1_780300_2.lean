import IdealArithmetic.Examples.NF3_1_780300_2.Invariants3_1_780300_2

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^3 - 340`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^3 - 340)) := rfl

lemma T_irreducible' : Irreducible (X^3 - 340 : ℤ[X]) := irreducible_T
