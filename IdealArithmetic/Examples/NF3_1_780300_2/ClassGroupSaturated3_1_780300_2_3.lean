...
def I1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![43, 0, 0], ![13, 1, 0]] i)))
def I2 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![67, 0, 0], ![10, 1, 0]] i)))
...
def A1: IdealEqSpanCertificate' Table ![![43, 0, 0], ![13, 1, 0]] 
...
def A2: IdealEqSpanCertificate' Table ![![67, 0, 0], ![10, 1, 0]] 
...
def Log00Mem : IdealMemCertificate B I0
 ![![31, 0, 0], ![1, 1, 0], ![15, 0, 1]] ![-6, 49, -14] where
...
def Log01Mem : IdealMemCertificate B I0
 ![![31, 0, 0], ![1, 1, 0], ![15, 0, 1]] ![10, -5, 1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![0, -5, 1]
 hmem := by decide
...
def Log02Mem : IdealMemCertificate B I0
 ![![31, 0, 0], ![1, 1, 0], ![15, 0, 1]] ![5, 4, -2] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![1, 4, -2]
 hmem := by decide
...
def Log10Mem : IdealMemCertificate B I1
 ![![43, 0, 0], ![13, 1, 0], ![23, 0, 1]] ![-29, 49, -14] where
...
def Log11Mem : IdealMemCertificate B I1
 ![![43, 0, 0], ![13, 1, 0], ![23, 0, 1]] ![1, -5, 1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![1, -5, 1]
 hmem := by decide
...
def Log12Mem : IdealMemCertificate B I1
 ![![43, 0, 0], ![13, 1, 0], ![23, 0, 1]] ![6, 4, -2] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![0, 4, -2]
 hmem := by decide
...
def Log20Mem : IdealMemCertificate B I2
 ![![67, 0, 0], ![10, 1, 0], ![17, 0, 1]] ![-16, 49, -14] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![-4, 49, -14]
 hmem := by decide

def Log20: DiscreteLogCertificate N2 ((orderOf_of_IsOrderOf R67) ▸ IsPrimitiveRoot.orderOf _) 3 zeta1 0 where
 r := 3
 hN := by infer_instance
 hpdvd := by decide
 B := B
...
def Log21Mem : IdealMemCertificate B I2
 ![![67, 0, 0], ![10, 1, 0], ![17, 0, 1]] ![-33, -5, 1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![0, -5, 1]
 hmem := by decide
...
def Log22Mem : IdealMemCertificate B I2
 ![![67, 0, 0], ![10, 1, 0], ![17, 0, 1]] ![6, 4, -2] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![0, 4, -2]
 hmem := by decide
