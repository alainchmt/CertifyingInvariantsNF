...
import IdealArithmetic.Examples.NF3_1_933107_3.Irreducible3_1_933107_3
...
noncomputable def T : ℤ[X] := X^3 + 245*X - 182
lemma T_def : T = X^3 + 245*X - 182 := rfl
