import IdealArithmetic.Examples.NF3_1_399735_1.ClassGroupSaturated3_1_399735_1_3
import IdealArithmetic.Examples.NF3_1_399735_1.RelationIdeals3_1_399735_1F0
import IdealArithmetic.Examples.NF3_1_399735_1.RelationIdeals3_1_399735_1F1
import IdealArithmetic.Examples.NF3_1_399735_1.RelationIdeals3_1_399735_1F2
import IdealArithmetic.Examples.NF3_1_399735_1.RelationIdeals3_1_399735_1F3
import IdealArithmetic.Examples.NF3_1_399735_1.PrimesBelowCert3_1_399735_1
...
/- Number field `K(α)` with α root of polynomial `X^3 - 153*X - 768`.
Class group structure `[3]`, generated by class of ideals `[(2, 1/2*a^2 - 5/2*a - 51)]`. -/
...
def SturmRC : SturmBuilderOfList [[-768, -153, 0, 1], [-153, 0, 3], [6912, 918], [-1598940]] [-768, -153, 0, 1] [-153, 0, 3] where
  hlen := by decide
  h0 := by decide
  h1 := by decide
  hlast := by decide
...
def RC : RankUnitsCertificate O where
  ...
  P := [[-768, -153, 0, 1], [-153, 0, 3], [6912, 918], [-1598940]]
  SB := SturmRC
  k := 1
  r := 2
  hr := by decide
...
theorem K_minowski : minkowskiBoundFB K ≤ (178.89902325630817 : ℝ) := by
  refine K_minkowski_decimal _ ?_
  erw [K_nrComplexPlaces, K_discr, K_finrank]
  have hraux: √399735 ≤ 632.246006 := by
      refine Real.sqrt_le_iff.mpr ?_
      norm_num
  have : 0.2222222222222222 * √399735 ≤ 140.509112 := by
...
def BM : (i : Fin 4) → Fin (e i) → (Fin 1 → ℕ) := by 
  rintro ⟨i, hi⟩ 
  interval_cases i 
  exact ![![2], ![0], ![1], ![2], ![2], ![2], ![0], ![0], ![1], ![0], ![2], ![1], ![2], ![1], ![0]]
  exact ![![1], ![2], ![2], ![2], ![0], ![0], ![0], ![0], ![0], ![0]]
  exact ![![1], ![1], ![2], ![1], ![2]]
  exact ![![2], ![1], ![2]]
...
lemma relations_proof0 (i : Fin 15) : IsInClass O J (𝔭 0 i) (BM 0 i) := by
  show IsInClass O J (𝔭 0 i) (![![2], ![0], ![1], ![2], ![2], ![2], ![0], ![0], ![1], ![0], ![2], ![1], ![2], ![1], ![0]] i)
  unfold IsInClass
...
lemma relations_proof1 (i : Fin 10) : IsInClass O J (𝔭 1 i) (BM 1 i) := by
  show IsInClass O J (𝔭 1 i) (![![1], ![2], ![2], ![2], ![0], ![0], ![0], ![0], ![0], ![0]] i)
  unfold IsInClass
  simp only [Fin.isValue, Fin.prod_univ_castSucc, Finset.univ_eq_empty, Finset.prod_empty, Fin.succ_zero_eq_one, one_mul]
  fin_cases i
...
lemma relations_proof2 (i : Fin 5) : IsInClass O J (𝔭 2 i) (BM 2 i) := by
  show IsInClass O J (𝔭 2 i) (![![1], ![1], ![2], ![1], ![2]] i)
  unfold IsInClass
  simp only [Fin.isValue, Fin.prod_univ_castSucc, Finset.univ_eq_empty, Finset.prod_empty, Fin.succ_zero_eq_one, one_mul]
  fin_cases i
...
lemma relations_proof3 (i : Fin 3) : IsInClass O J (𝔭 3 i) (BM 3 i) := by
  show IsInClass O J (𝔭 3 i) (![![2], ![1], ![2]] i)
  unfold IsInClass
  simp only [Fin.isValue, Fin.prod_univ_castSucc, Finset.univ_eq_empty, Finset.prod_empty, Fin.succ_zero_eq_one, one_mul]
  fin_cases i
