...
def A0: IdealEqSpanCertificate' Table ![![7, 0, 0], ![2, 1, 0]] 
 ![![7, 0, 0], ![2, 1, 0], ![6, 0, 1]] where
  M :=![![![7, 0, 0], ![0, 7, 0], ![0, 0, 7]], ![![2, 1, 0], ![2, 5, 8], ![47, -19, -1]]]
  hmulB := by decide  
  f := ![![![-33, -97, -160], ![-21, 140, 0]], ![![-10, -25, -40], ![1, 35, 0]], ![![-28, -83, -137], ![-19, 120, 0]]]
  g := ![![![1, 0, 0], ![-2, 7, 0], ![-6, 0, 7]], ![![0, 1, 0], ![-8, 5, 8], ![13, -19, -1]]]
  hle1 := by decide   
  hle2 := by decide  
...
def A1: IdealEqSpanCertificate' Table ![![13, 0, 0], ![3, 1, 0]] 
 ![![13, 0, 0], ![3, 1, 0], ![11, 0, 1]] where
  M :=![![![13, 0, 0], ![0, 13, 0], ![0, 0, 13]], ![![3, 1, 0], ![2, 6, 8], ![47, -19, 0]]]
  hmulB := by decide  
  f := ![![![-194, -641, -864], ![-91, 1404, 0]], ![![-45, -143, -192], ![-12, 312, 0]], ![![-166, -543, -731], ![-69, 1188, 0]]]
  g := ![![![1, 0, 0], ![-3, 13, 0], ![-11, 0, 13]], ![![0, 1, 0], ![-8, 6, 8], ![8, -19, 0]]]
  hle1 := by decide   
  hle2 := by decide  
...
def Log00Mem : IdealMemCertificate B I0
 ![![7, 0, 0], ![2, 1, 0], ![6, 0, 1]] ![15255152, -6063348, -1114677] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![4867130, -6063348, -1114677]
 hmem := by decide
...
def Log00: DiscreteLogCertificate N0 ((orderOf_of_IsOrderOf R7) ▸ IsPrimitiveRoot.orderOf _) 3 zeta1 2 where
 ...
 B := B
 hone := B_one
 xcoord := ![15255154, -6063348, -1114677]
 hxeq :=  rfl
 m := 2
 C := ![15255152, -6063348, -1114677]
 hCeq := by rfl
...
def Log01Mem : IdealMemCertificate B I0
 ![![7, 0, 0], ![2, 1, 0], ![6, 0, 1]] ![167, -77, -76] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![111, -77, -76]
 hmem := by decide
...
def Log10Mem : IdealMemCertificate B I1
 ![![13, 0, 0], ![3, 1, 0], ![11, 0, 1]] ![15255144, -6063348, -1114677] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![3515895, -6063348, -1114677]
 hmem := by decide
...
def Log11Mem : IdealMemCertificate B I1
 ![![13, 0, 0], ![3, 1, 0], ![11, 0, 1]] ![168, -77, -76] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![95, -77, -76]
 hmem := by decide
