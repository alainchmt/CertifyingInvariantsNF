import IdealArithmetic.Examples.NF3_1_236763_2.ClassGroupSaturated3_1_236763_2_3
import IdealArithmetic.Examples.NF3_1_236763_2.RelationIdeals3_1_236763_2F0
import IdealArithmetic.Examples.NF3_1_236763_2.RelationIdeals3_1_236763_2F1
import IdealArithmetic.Examples.NF3_1_236763_2.RelationIdeals3_1_236763_2F2
import IdealArithmetic.Examples.NF3_1_236763_2.PrimesBelowCert3_1_236763_2
...
/- Number field `K(α)` with α root of polynomial `X^3 + 141*X - 382`.
...
def SturmRC : SturmBuilderOfList [[-382, 141, 0, 1], [141, 0, 3], [3438, -846], [-15152832]] [-382, 141, 0, 1] [141, 0, 3] where
  hlen := by decide
  h0 := by decide
  h1 := by decide
  hlast := by decide
...
def RC : RankUnitsCertificate O where
  ...
  P := [[-382, 141, 0, 1], [141, 0, 3], [3438, -846], [-15152832]]
  SB := SturmRC
  k := 1
  r := 2
  hr := by decide
...
lemma T_discr : T.discr = -15152832 :=  by
  convert discriminant_eq_DiscriminantOfPRemainder_of_SturmBuilderOfList SturmRC
  rw [T_ofList]

theorem K_discr : NumberField.discr K = -236763 := by
...
theorem K_minowski : minkowskiBoundFB K ≤ (137.68482146834043 : ℝ) := by
  refine K_minkowski_decimal _ ?_
  erw [K_nrComplexPlaces, K_discr, K_finrank]
  have hraux: √236763 ≤ 486.582994 := by
      refine Real.sqrt_le_iff.mpr ?_
      norm_num
  have : 0.2222222222222222 * √236763 ≤ 108.139554 := by
...
def BM : (i : Fin 3) → Fin (e i) → (Fin 1 → ℕ) := by 
  rintro ⟨i, hi⟩ 
  interval_cases i 
  exact ![![1], ![2], ![1], ![2], ![1], ![0], ![0], ![0], ![0], ![2], ![1], ![2], ![1], ![2]]
  exact ![![2], ![2], ![1], ![1], ![2], ![2], ![0], ![0]]
  exact ![![2], ![2], ![1], ![0], ![2], ![2], ![1], ![2], ![0], ![1], ![1], ![0]]
...
lemma relations_proof0 (i : Fin 14) : IsInClass O J (𝔭 0 i) (BM 0 i) := by
  show IsInClass O J (𝔭 0 i) (![![1], ![2], ![1], ![2], ![1], ![0], ![0], ![0], ![0], ![2], ![1], ![2], ![1], ![2]] i)
  unfold IsInClass
...
lemma relations_proof1 (i : Fin 8) : IsInClass O J (𝔭 1 i) (BM 1 i) := by
  show IsInClass O J (𝔭 1 i) (![![2], ![2], ![1], ![1], ![2], ![2], ![0], ![0]] i)
  unfold IsInClass
  simp only [Fin.isValue, Fin.prod_univ_castSucc, Finset.univ_eq_empty, Finset.prod_empty, Fin.succ_zero_eq_one, one_mul]
  fin_cases i
...
lemma relations_proof2 (i : Fin 12) : IsInClass O J (𝔭 2 i) (BM 2 i) := by
  show IsInClass O J (𝔭 2 i) (![![2], ![2], ![1], ![0], ![2], ![2], ![1], ![2], ![0], ![1], ![1], ![0]] i)
  unfold IsInClass
  simp only [Fin.isValue, Fin.prod_univ_castSucc, Finset.univ_eq_empty, Finset.prod_empty, Fin.succ_zero_eq_one, one_mul]
  fin_cases i
