import IdealArithmetic.Examples.NF5_3_67500000_1.Invariants5_3_67500000_1

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 - 30*X^2 + 15*X + 18`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 - 30*X^2 + 15*X + 18)) := rfl

lemma T_irreducible' : Irreducible (X^5 - 30*X^2 + 15*X + 18 : ℤ[X]) := irreducible_T
