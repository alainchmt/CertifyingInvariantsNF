...
import IdealArithmetic.Examples.NF3_1_314847_3.Irreducible3_1_314847_3
...
noncomputable def T : ℤ[X] := X^3 - 39*X - 442
lemma T_def : T = X^3 - 39*X - 442 := rfl
