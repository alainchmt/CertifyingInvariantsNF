...
def I3 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![31, 0, 0], ![-15, 1, 0]] i)))
...
def A3: IdealEqSpanCertificate' Table ![![31, 0, 0], ![-15, 1, 0]] 
...
def Log00Mem : IdealMemCertificate B I0
 ![![7, 0, 0], ![2, 1, 0], ![5, 0, 1]] ![-30, 0, 1] where
...
def Log01Mem : IdealMemCertificate B I0
 ![![7, 0, 0], ![2, 1, 0], ![5, 0, 1]] ![-69, 0, 3] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![-12, 0, 3]
 hmem := by decide
...
def Log03: DiscreteLogCertificate N0 ((orderOf_of_IsOrderOf R7) ▸ IsPrimitiveRoot.orderOf _) 3 alpha1 0 where
 r := 3
 hN := by infer_instance
 hpdvd := by decide
 B := B
...
def Log10Mem : IdealMemCertificate B I1
 ![![13, 0, 0], ![4, 1, 0], ![10, 0, 1]] ![-29, 0, 1] where
...
def Log11Mem : IdealMemCertificate B I1
 ![![13, 0, 0], ![4, 1, 0], ![10, 0, 1]] ![-74, 0, 3] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![-8, 0, 3]
 hmem := by decide
...
def Log12Mem : IdealMemCertificate B I1
 ![![13, 0, 0], ![4, 1, 0], ![10, 0, 1]] ![-8, 2, 1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![-2, 2, 1]
 hmem := by decide
...
def Log13: DiscreteLogCertificate N1 ((orderOf_of_IsOrderOf R13) ▸ IsPrimitiveRoot.orderOf _) 3 alpha1 2 where
 r := 3
 hN := by infer_instance
 hpdvd := by decide
 B := B
...
def Log20Mem : IdealMemCertificate B I2
 ![![19, 0, 0], ![15, 1, 0], ![16, 0, 1]] ![-41, 0, 1] where
...
def Log21Mem : IdealMemCertificate B I2
 ![![19, 0, 0], ![15, 1, 0], ![16, 0, 1]] ![-66, 0, 3] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![-6, 0, 3]
 hmem := by decide
...
def Log22Mem : IdealMemCertificate B I2
 ![![19, 0, 0], ![15, 1, 0], ![16, 0, 1]] ![-11, 2, 1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![-3, 2, 1]
 hmem := by decide

def Log22: DiscreteLogCertificate N2 ((orderOf_of_IsOrderOf R19) ▸ IsPrimitiveRoot.orderOf _) 3 alpha0 0 where
 r := 3
 hN := by infer_instance
 hpdvd := by decide
 B := B
...
def Log23: DiscreteLogCertificate N2 ((orderOf_of_IsOrderOf R19) ▸ IsPrimitiveRoot.orderOf _) 3 alpha1 0 where
 r := 3
 hN := by infer_instance
 hpdvd := by decide
 B := B
...
def Log30Mem : IdealMemCertificate B I3
 ![![31, 0, 0], ![16, 1, 0], ![11, 0, 1]] ![-51, 0, 1] where
...
def Log31Mem : IdealMemCertificate B I3
 ![![31, 0, 0], ![16, 1, 0], ![11, 0, 1]] ![-91, 0, 3] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A3
 g := ![-4, 0, 3]
 hmem := by decide

def Log31: DiscreteLogCertificate N3 ((orderOf_of_IsOrderOf R31) ▸ IsPrimitiveRoot.orderOf _) 3 zeta2 0 where
 r := 3
 hN := by infer_instance
 hpdvd := by decide
 B := B
...
def Log32Mem : IdealMemCertificate B I3
 ![![31, 0, 0], ![16, 1, 0], ![11, 0, 1]] ![-19, 2, 1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A3
 g := ![-2, 2, 1]
 hmem := by decide

def Log32: DiscreteLogCertificate N3 ((orderOf_of_IsOrderOf R31) ▸ IsPrimitiveRoot.orderOf _) 3 alpha0 0 where
 r := 3
 hN := by infer_instance
 hpdvd := by decide
 B := B
...
def Log33: DiscreteLogCertificate N3 ((orderOf_of_IsOrderOf R31) ▸ IsPrimitiveRoot.orderOf _) 3 alpha1 0 where
 r := 3
 hN := by infer_instance
 hpdvd := by decide
 B := B
