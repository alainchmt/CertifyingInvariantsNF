...
import IdealArithmetic.Examples.NF3_3_240149_1.Irreducible3_3_240149_1
...
noncomputable def T : ℤ[X] := X^3 - X^2 - 121*X + 246
lemma T_def : T = X^3 - X^2 - 121*X + 246 := rfl
...
-- We build the subalgebra with integral basis [1, a, 1/5*a^2 - 1/5] 
