...
import IdealArithmetic.Examples.NF3_1_795800_1.Irreducible3_1_795800_1
...
noncomputable def T : ℤ[X] := X^3 - X^2 - 18*X + 522
lemma T_def : T = X^3 - X^2 - 18*X + 522 := rfl
