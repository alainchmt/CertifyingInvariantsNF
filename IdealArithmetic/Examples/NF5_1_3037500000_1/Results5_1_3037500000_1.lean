import IdealArithmetic.Examples.NF5_1_3037500000_1.Invariants5_1_3037500000_1

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 - 15*X^3 - 10*X^2 - 390*X - 2088`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 - 15*X^3 - 10*X^2 - 390*X - 2088)) := rfl

lemma T_irreducible' : Irreducible (X^5 - 15*X^3 - 10*X^2 - 390*X - 2088 : ℤ[X]) := irreducible_T
