...
def P13PI1 : CertificateIrreducibleZModOfList' 13 4 2 3 [3, 1, 6, 1, 1] where
 m := 1
 P := ![2]
 exp := ![2]
 hneq := by decide
...
def P19PI0 : CertificateIrreducibleZModOfList' 19 2 2 4 [14, 13, 1] where
 m := 1
 P := ![2]
 exp := ![1]
 hneq := by decide
...
def P19PI1 : CertificateIrreducibleZModOfList' 19 3 2 4 [4, 0, 6, 1] where
 m := 1
 P := ![3]
 exp := ![1]
 hneq := by decide
...
noncomputable def C : IrreducibleCertificateIntPolynomial T l where
 ...
 hirr := by
  ...
  · dsimp ; exact irreducible_ofList_ofCertificateIrreducibleZModOfList' P19PI0
  · dsimp ; exact irreducible_ofList_ofCertificateIrreducibleZModOfList' P19PI1
 hm := by decide
 hprod := by decide
 hinter := by decide
