import IdealArithmetic.Examples.NF5_3_3037500000_1.Invariants5_3_3037500000_1

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 - 60*X^3 - 330*X^2 - 765*X - 666`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 - 60*X^3 - 330*X^2 - 765*X - 666)) := rfl

lemma T_irreducible' : Irreducible (X^5 - 60*X^3 - 330*X^2 - 765*X - 666 : ℤ[X]) := irreducible_T
