import IdealArithmetic.Examples.NF25.NonPrincipalExample25
...
theorem K_minowski (C : ClassGroup (NumberField.RingOfIntegers K)) :
  ∃ (I : (nonZeroDivisors (Ideal (NumberField.RingOfIntegers K)))),
    ClassGroup.mk0 I = C ∧
    ↑(Ideal.absNorm (↑I : Ideal (NumberField.RingOfIntegers K)) ) ≤ (433.99 : ℝ) := by
  ...
  · refine le_trans hI2 ?_
    ...
    have hraux: √48600000 ≤ 6971.38 := by
      refine Real.sqrt_le_iff.mpr ?_
      norm_num
    have : 24 / 625 * √48600000 ≤ 267.701 := by
