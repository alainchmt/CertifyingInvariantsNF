...
import IdealArithmetic.Examples.NF3_1_186731_1.Irreducible3_1_186731_1
...
noncomputable def T : ℤ[X] := X^3 - X^2 + 13*X + 744
lemma T_def : T = X^3 - X^2 + 13*X + 744 := rfl
