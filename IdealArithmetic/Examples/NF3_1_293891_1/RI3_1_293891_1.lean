...
import IdealArithmetic.Examples.NF3_1_293891_1.Irreducible3_1_293891_1
...
noncomputable def T : ℤ[X] := X^3 + 26*X - 91
lemma T_def : T = X^3 + 26*X - 91 := rfl
