...
import IdealArithmetic.Examples.NF3_1_112887_1.Irreducible3_1_112887_1
...
noncomputable def T : ℤ[X] := X^3 + 21*X - 53
lemma T_def : T = X^3 + 21*X - 53 := rfl
