import IdealArithmetic.Examples.NF5_3_1012500000_1.Invariants5_3_1012500000_1

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 + 15*X^3 - 30*X^2 - 90*X - 36`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 + 15*X^3 - 30*X^2 - 90*X - 36)) := rfl

lemma T_irreducible' : Irreducible (X^5 + 15*X^3 - 30*X^2 - 90*X - 36 : ℤ[X]) := irreducible_T
