...
import IdealArithmetic.Examples.NF3_1_672300_4.Irreducible3_1_672300_4
...
noncomputable def T : ℤ[X] := X^3 + 60*X - 1090
lemma T_def : T = X^3 + 60*X - 1090 := rfl
