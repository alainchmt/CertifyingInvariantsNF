import IdealArithmetic.Examples.NF5_1_121500000_1.Invariants5_1_121500000_1

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 - 20*X^2 + 75*X - 72`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 - 20*X^2 + 75*X - 72)) := rfl

lemma T_irreducible' : Irreducible (X^5 - 20*X^2 + 75*X - 72 : ℤ[X]) := irreducible_T
