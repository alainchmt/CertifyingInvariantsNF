...
import IdealArithmetic.Examples.NF3_1_565068_1.Irreducible3_1_565068_1
...
noncomputable def T : ℤ[X] := X^3 - X^2 + 145*X + 225
lemma T_def : T = X^3 - X^2 + 145*X + 225 := rfl
