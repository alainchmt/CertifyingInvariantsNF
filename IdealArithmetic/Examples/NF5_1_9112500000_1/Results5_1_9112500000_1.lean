import IdealArithmetic.Examples.NF5_1_9112500000_1.Invariants5_1_9112500000_1

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 - 75*X^3 - 150*X^2 - 3600`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 - 75*X^3 - 150*X^2 - 3600)) := rfl

lemma T_irreducible' : Irreducible (X^5 - 75*X^3 - 150*X^2 - 3600 : ℤ[X]) := irreducible_T
