import IdealArithmetic.Examples.NF5_1_15187500000_9.Invariants5_1_15187500000_9

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 - 100*X^2 + 300*X - 360`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 - 100*X^2 + 300*X - 360)) := rfl

lemma T_irreducible' : Irreducible (X^5 - 100*X^2 + 300*X - 360 : ℤ[X]) := irreducible_T
