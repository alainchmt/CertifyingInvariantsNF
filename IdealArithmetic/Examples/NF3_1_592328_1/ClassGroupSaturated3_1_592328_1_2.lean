...
def I0 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![3, 0, 0], ![15, 0, -1]] i)))
def I1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![5, 0, 0], ![0, 1, 0]] i)))
def I2 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![11, 0, 0], ![0, 1, 0]] i)))

def A0: IdealEqSpanCertificate' Table ![![3, 0, 0], ![15, 0, -1]] 
 ![![3, 0, 0], ![1, 1, 0], ![0, 0, 1]] where
  M :=![![![3, 0, 0], ![0, 3, 0], ![0, 0, 3]], ![![15, 0, -1], ![193, -8, 1], ![-108, 36, -8]]]
  hmulB := by decide  
  f := ![![![12, -16, 27], ![75, -6, 0]], ![![4, -5, 9], ![25, -2, 0]], ![![5, 0, 0], ![-1, 0, 0]]]
...
def A1: IdealEqSpanCertificate' Table ![![5, 0, 0], ![0, 1, 0]] 
...
def A2: IdealEqSpanCertificate' Table ![![11, 0, 0], ![0, 1, 0]] 
 ![![11, 0, 0], ![0, 1, 0], ![6, 0, 1]] where
  M :=![![![11, 0, 0], ![0, 11, 0], ![0, 0, 11]], ![![0, 1, 0], ![3, 2, 6], ![-193, 23, -1]]]
  hmulB := by decide  
  f := ![![![-11, -8, -24], ![0, 44, 0]], ![![0, 0, 0], ![1, 0, 0]], ![![-6, -5, -13], ![7, 24, 0]]]
  g := ![![![1, 0, 0], ![0, 11, 0], ![-6, 0, 11]], ![![0, 1, 0], ![-3, 2, 6], ![-17, 23, -1]]]
  hle1 := by decide   
  hle2 := by decide  
...
def Log00Mem : IdealMemCertificate B I0
 ![![3, 0, 0], ![1, 1, 0], ![0, 0, 1]] ![6903131033682962535047941368008, 155870529360192107646040254143, -119072896981337702897609170776] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![2249086834774256809133967037955, 155870529360192107646040254143, -119072896981337702897609170776]
 hmem := by decide
...
def Log00: DiscreteLogCertificate N0 ((orderOf_of_IsOrderOf R3) ▸ IsPrimitiveRoot.orderOf _) 2 zeta1 1 where
 ...
 B := B
 hone := B_one
 xcoord := ![6903131033682962535047941368010, 155870529360192107646040254143, -119072896981337702897609170776]
 hxeq :=  rfl
 m := 2
 C := ![6903131033682962535047941368008, 155870529360192107646040254143, -119072896981337702897609170776]
 hCeq := by rfl
...
def Log02Mem : IdealMemCertificate B I0
 ![![3, 0, 0], ![1, 1, 0], ![0, 0, 1]] ![600, -99, -52] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![233, -99, -52]
 hmem := by decide
...
def Log10Mem : IdealMemCertificate B I1
 ![![5, 0, 0], ![0, 1, 0], ![3, 0, 1]] ![6903131033682962535047941368007, 155870529360192107646040254143, -119072896981337702897609170776] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![1452069944925395128748153776067, 155870529360192107646040254143, -119072896981337702897609170776]
 hmem := by decide
...
def Log10: DiscreteLogCertificate N1 ((orderOf_of_IsOrderOf R5) ▸ IsPrimitiveRoot.orderOf _) 2 zeta1 1 where
 ...
 hxeq :=  rfl
 m := 3
 C := ![6903131033682962535047941368007, 155870529360192107646040254143, -119072896981337702897609170776]
 hCeq := by rfl
...
def Log12Mem : IdealMemCertificate B I1
 ![![5, 0, 0], ![0, 1, 0], ![3, 0, 1]] ![599, -99, -52] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![151, -99, -52]
 hmem := by decide
...
def Log20Mem : IdealMemCertificate B I2
 ![![11, 0, 0], ![0, 1, 0], ![6, 0, 1]] ![6903131033682962535047941368004, 155870529360192107646040254143, -119072896981337702897609170776] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![692506219597362613857599672060, 155870529360192107646040254143, -119072896981337702897609170776]
 hmem := by decide
...
def Log20: DiscreteLogCertificate N2 ((orderOf_of_IsOrderOf R11) ▸ IsPrimitiveRoot.orderOf _) 2 zeta1 1 where
 ...
 hxeq :=  rfl
 m := 6
 C := ![6903131033682962535047941368004, 155870529360192107646040254143, -119072896981337702897609170776]
 hCeq := by rfl
...
def Log22Mem : IdealMemCertificate B I2
 ![![11, 0, 0], ![0, 1, 0], ![6, 0, 1]] ![601, -99, -52] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![83, -99, -52]
 hmem := by decide
