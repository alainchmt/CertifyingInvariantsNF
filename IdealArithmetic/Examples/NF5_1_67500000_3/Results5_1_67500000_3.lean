import IdealArithmetic.Examples.NF5_1_67500000_3.Invariants5_1_67500000_3

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 - 10*X^2 + 15*X + 54`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 - 10*X^2 + 15*X + 54)) := rfl

lemma T_irreducible' : Irreducible (X^5 - 10*X^2 + 15*X + 54 : ℤ[X]) := irreducible_T
