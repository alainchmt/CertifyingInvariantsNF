...
import IdealArithmetic.Examples.NF3_1_254280_1.Irreducible3_1_254280_1
...
noncomputable def T : ℤ[X] := X^3 - X^2 + 34*X + 270
lemma T_def : T = X^3 - X^2 + 34*X + 270 := rfl
