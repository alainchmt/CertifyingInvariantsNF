...
import IdealArithmetic.Examples.NF3_3_336604_1.PrimesBelowCert3_3_336604_1
...
/- Number field `K(α)` with α root of polynomial `X^3 - X^2 - 76*X + 152`.
...
def SturmRC : SturmBuilderOfList [[152, -76, -1, 1], [-76, -2, 3], [-1292, 458], [1346416]] [152, -76, -1, 1] [-76, -2, 3] where
  hlen := by decide
  h0 := by decide
  h1 := by decide
  hlast := by decide
...
def RC : RankUnitsCertificate O where
  ...
  P := [[152, -76, -1, 1], [-76, -2, 3], [-1292, 458], [1346416]]
  SB := SturmRC
  k := 3
  r := 3
  hr := by decide
...
theorem K_minowski : minkowskiBoundFB K ≤ (128.9379634256526 : ℝ) := by
  refine K_minkowski_decimal _ ?_
  erw [K_nrComplexPlaces, K_discr, K_finrank]
  have hraux: √336604 ≤ 580.175845 := by
      refine Real.sqrt_le_iff.mpr ?_
      norm_num
  have : 0.2222222222222222 * √336604 ≤ 128.937966 := by
