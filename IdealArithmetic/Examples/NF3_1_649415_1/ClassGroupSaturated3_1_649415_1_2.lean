...
def I0 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![3, 0, 0], ![3, 1, 0]] i)))
def I1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![5, 0, 0], ![-5, 1, 1]] i)))
def I2 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![3, 0, 0], ![1, 1, 0]] i)))

def A0: IdealEqSpanCertificate' Table ![![3, 0, 0], ![3, 1, 0]] 
 ![![3, 0, 0], ![0, 1, 0], ![1, 0, 1]] where
  M :=![![![3, 0, 0], ![0, 3, 0], ![0, 0, 3]], ![![3, 1, 0], ![2, 2, 5], ![157, 8, 4]]]
  hmulB := by decide  
  f := ![![![-3, -4, -10], ![0, 6, 0]], ![![-1, 0, 0], ![1, 0, 0]], ![![-3, -2, -3], ![2, 2, 0]]]
  g := ![![![1, 0, 0], ![0, 3, 0], ![-1, 0, 3]], ![![1, 1, 0], ![-1, 2, 5], ![51, 8, 4]]]
  hle1 := by decide   
  hle2 := by decide  
...
def A1: IdealEqSpanCertificate' Table ![![5, 0, 0], ![-5, 1, 1]] 
 ![![5, 0, 0], ![4, 1, 0], ![1, 0, 1]] where
  M :=![![![5, 0, 0], ![0, 5, 0], ![0, 0, 5]], ![![-5, 1, 1], ![159, 2, 6], ![223, 41, 4]]]
  hmulB := by decide  
  f := ![![![85, 17, 21], ![-75, -5, 0]], ![![72, 13, 16], ![-56, -4, 0]], ![![19, 3, 4], ![-13, -1, 0]]]
  g := ![![![1, 0, 0], ![-4, 5, 0], ![-1, 0, 5]], ![![-2, 1, 1], ![29, 2, 6], ![11, 41, 4]]]
  hle1 := by decide   
  hle2 := by decide  
...
def Log00Mem : IdealMemCertificate B I0
 ![![3, 0, 0], ![0, 1, 0], ![1, 0, 1]] ![4491034, -390570, -11588] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![1500874, -390570, -11588]
 hmem := by decide
...
def Log00: DiscreteLogCertificate N0 ((orderOf_of_IsOrderOf R3) ▸ IsPrimitiveRoot.orderOf _) 2 zeta1 0 where
 ...
 B := B
 hone := B_one
 xcoord := ![4491035, -390570, -11588]
 hxeq :=  rfl
 m := 1
 C := ![4491034, -390570, -11588]
 hCeq := by rfl
...
def Log02Mem : IdealMemCertificate B I0
 ![![3, 0, 0], ![0, 1, 0], ![1, 0, 1]] ![-5307, -125, 267] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![-1858, -125, 267]
 hmem := by decide
...
def Log10Mem : IdealMemCertificate B I1
 ![![5, 0, 0], ![4, 1, 0], ![1, 0, 1]] ![4491032, -390570, -11588] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![1212980, -390570, -11588]
 hmem := by decide
...
def Log12Mem : IdealMemCertificate B I1
 ![![5, 0, 0], ![4, 1, 0], ![1, 0, 1]] ![-5308, -125, 267] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![-1015, -125, 267]
 hmem := by decide
...
def Log20Mem : IdealMemCertificate B I2
 ![![3, 0, 0], ![1, 1, 0], ![1, 0, 1]] ![4491034, -390570, -11588] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![1631064, -390570, -11588]
 hmem := by decide
...
def Log22Mem : IdealMemCertificate B I2
 ![![3, 0, 0], ![1, 1, 0], ![1, 0, 1]] ![-5306, -125, 267] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![-1816, -125, 267]
 hmem := by decide
