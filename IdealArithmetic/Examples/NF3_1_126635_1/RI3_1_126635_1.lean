...
import IdealArithmetic.Examples.NF3_1_126635_1.Irreducible3_1_126635_1
...
noncomputable def T : ℤ[X] := X^3 - X^2 - 21*X + 216
lemma T_def : T = X^3 - X^2 - 21*X + 216 := rfl
