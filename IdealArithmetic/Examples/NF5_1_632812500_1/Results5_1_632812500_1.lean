import IdealArithmetic.Examples.NF5_1_632812500_1.Invariants5_1_632812500_1

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 - 25*X^3 - 1200`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 - 25*X^3 - 1200)) := rfl

lemma T_irreducible' : Irreducible (X^5 - 25*X^3 - 1200 : ℤ[X]) := irreducible_T
