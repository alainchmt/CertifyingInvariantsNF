import IdealArithmetic.Examples.NF3_1_119660_3.ClassGroupSaturated3_1_119660_3_3
import IdealArithmetic.Examples.NF3_1_119660_3.RelationIdeals3_1_119660_3F0
import IdealArithmetic.Examples.NF3_1_119660_3.RelationIdeals3_1_119660_3F1
import IdealArithmetic.Examples.NF3_1_119660_3.RelationIdeals3_1_119660_3F2
import IdealArithmetic.Examples.NF3_1_119660_3.PrimesBelowCert3_1_119660_3
...
/- Number field `K(α)` with α root of polynomial `X^3 + 8*X - 66`.
...
def SturmRC : SturmBuilderOfList [[-66, 8, 0, 1], [8, 0, 3], [594, -48], [-119660]] [-66, 8, 0, 1] [8, 0, 3] where
  hlen := by decide
  h0 := by decide
  h1 := by decide
  hlast := by decide
...
def RC : RankUnitsCertificate O where
  ...
  P := [[-66, 8, 0, 1], [8, 0, 3], [594, -48], [-119660]]
  SB := SturmRC
  k := 1
  r := 2
  hr := by decide
...
theorem K_minowski : minkowskiBoundFB K ≤ (97.88507415553671 : ℝ) := by
  refine K_minkowski_decimal _ ?_
  erw [K_nrComplexPlaces, K_discr, K_finrank]
  have hraux: √119660 ≤ 345.91907599999996 := by
      refine Real.sqrt_le_iff.mpr ?_
      norm_num
  have : 0.2222222222222222 * √119660 ≤ 76.880906 := by
...
def BM : (i : Fin 3) → Fin (e i) → (Fin 1 → ℕ) := by 
  rintro ⟨i, hi⟩ 
  interval_cases i 
  exact ![![1], ![1], ![2], ![0], ![2], ![2], ![0], ![0], ![1], ![0], ![2], ![1], ![1], ![0], ![2], ![2]]
  exact ![![0], ![0], ![1], ![0], ![0], ![1]]
  exact ![![2]]
...
lemma relations_proof0 (i : Fin 16) : IsInClass O J (𝔭 0 i) (BM 0 i) := by
  show IsInClass O J (𝔭 0 i) (![![1], ![1], ![2], ![0], ![2], ![2], ![0], ![0], ![1], ![0], ![2], ![1], ![1], ![0], ![2], ![2]] i)
  unfold IsInClass
...
lemma relations_proof1 (i : Fin 6) : IsInClass O J (𝔭 1 i) (BM 1 i) := by
  show IsInClass O J (𝔭 1 i) (![![0], ![0], ![1], ![0], ![0], ![1]] i)
  unfold IsInClass
  simp only [Fin.isValue, Fin.prod_univ_castSucc, Finset.univ_eq_empty, Finset.prod_empty, Fin.succ_zero_eq_one, one_mul]
  fin_cases i
  · refine ideal_mem_principal_class''' (by decide) J rfl (by unfold_prod)
