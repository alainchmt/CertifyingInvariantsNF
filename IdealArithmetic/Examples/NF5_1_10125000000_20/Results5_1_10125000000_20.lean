import IdealArithmetic.Examples.NF5_1_10125000000_20.Invariants5_1_10125000000_20

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 - 75*X^3 - 50*X^2 + 2250*X + 5820`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 - 75*X^3 - 50*X^2 + 2250*X + 5820)) := rfl

lemma T_irreducible' : Irreducible (X^5 - 75*X^3 - 50*X^2 + 2250*X + 5820 : ℤ[X]) := irreducible_T
