...
import IdealArithmetic.Examples.NF3_1_110700_4.Irreducible3_1_110700_4
...
noncomputable def T : ℤ[X] := X^3 + 30*X - 10
lemma T_def : T = X^3 + 30*X - 10 := rfl
