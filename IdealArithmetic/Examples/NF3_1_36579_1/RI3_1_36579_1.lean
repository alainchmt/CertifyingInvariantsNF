...
import IdealArithmetic.Examples.NF3_1_36579_1.Irreducible3_1_36579_1
...
noncomputable def T : ℤ[X] := X^3 - X^2 - 7*X + 40
lemma T_def : T = X^3 - X^2 - 7*X + 40 := rfl
