...
def Log00Mem : IdealMemCertificate B I0
 ![![7, 0, 0], ![5, 1, 0], ![6, 0, 1]] ![13908659653852, -3471063367147, 683347577295] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![3880555860831, -3471063367147, 683347577295]
 hmem := by decide
...
def Log00: DiscreteLogCertificate N0 ((orderOf_of_IsOrderOf R7) ▸ IsPrimitiveRoot.orderOf _) 3 zeta1 2 where
 ...
 B := B
 hone := B_one
 xcoord := ![13908659653857, -3471063367147, 683347577295]
 hxeq :=  rfl
 m := 5
 C := ![13908659653852, -3471063367147, 683347577295]
 hCeq := by rfl
...
def Log01Mem : IdealMemCertificate B I0
 ![![7, 0, 0], ![5, 1, 0], ![6, 0, 1]] ![93821, -443985, 259650] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![107978, -443985, 259650]
 hmem := by decide
...
def Log01: DiscreteLogCertificate N0 ((orderOf_of_IsOrderOf R7) ▸ IsPrimitiveRoot.orderOf _) 3 alpha0 2 where
 ...
 B := B
 hone := B_one
 xcoord := ![93823, -443985, 259650]
 hxeq :=  rfl
 m := 2
 C := ![93821, -443985, 259650]
 hCeq := by rfl
...
def Log10Mem : IdealMemCertificate B I1
 ![![13, 0, 0], ![0, 1, 0], ![7, 0, 1]] ![13908659653853, -3471063367147, 683347577295] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![701940508676, -3471063367147, 683347577295]
 hmem := by decide
...
def Log10: DiscreteLogCertificate N1 ((orderOf_of_IsOrderOf R13) ▸ IsPrimitiveRoot.orderOf _) 3 zeta1 2 where
 ...
 hxeq :=  rfl
 m := 4
 C := ![13908659653853, -3471063367147, 683347577295]
 hCeq := by rfl
...
def Log11Mem : IdealMemCertificate B I1
 ![![13, 0, 0], ![0, 1, 0], ![7, 0, 1]] ![93815, -443985, 259650] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![-132595, -443985, 259650]
 hmem := by decide
