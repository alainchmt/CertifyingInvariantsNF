import IdealArithmetic.Examples.NF3_1_138580_1.ClassGroupSaturated3_1_138580_1_3
import IdealArithmetic.Examples.NF3_1_138580_1.RelationIdeals3_1_138580_1F0
import IdealArithmetic.Examples.NF3_1_138580_1.RelationIdeals3_1_138580_1F1
import IdealArithmetic.Examples.NF3_1_138580_1.RelationIdeals3_1_138580_1F2
import IdealArithmetic.Examples.NF3_1_138580_1.PrimesBelowCert3_1_138580_1
...
/- Number field `K(α)` with α root of polynomial `X^3 + 13*X - 286`.
Class group structure `[3]`, generated by class of ideals `[(2, 1/4*a^2 + 1/4*a + 5/2)]`. -/
...
def SturmRC : SturmBuilderOfList [[-286, 13, 0, 1], [13, 0, 3], [2574, -78], [-2217280]] [-286, 13, 0, 1] [13, 0, 3] where
  hlen := by decide
  h0 := by decide
  h1 := by decide
  hlast := by decide
...
def RC : RankUnitsCertificate O where
  ...
  P := [[-286, 13, 0, 1], [13, 0, 3], [2574, -78], [-2217280]]
  SB := SturmRC
  k := 1
  r := 2
  hr := by decide
...
theorem K_minowski : minkowskiBoundFB K ≤ (105.33898117274295 : ℝ) := by
  refine K_minkowski_decimal _ ?_
  erw [K_nrComplexPlaces, K_discr, K_finrank]
  have hraux: √138580 ≤ 372.263358 := by
      refine Real.sqrt_le_iff.mpr ?_
      norm_num
  have : 0.2222222222222222 * √138580 ≤ 82.735191 := by
...
def BM : (i : Fin 3) → Fin (e i) → (Fin 1 → ℕ) := by 
  rintro ⟨i, hi⟩ 
  interval_cases i 
  exact ![![1], ![1], ![2], ![1], ![0], ![0], ![1], ![2], ![1], ![1], ![1], ![1], ![2], ![2], ![2], ![1], ![0]]
  exact ![![1], ![1], ![1], ![0], ![2], ![1], ![0]]
  exact ![![1], ![1]]
...
lemma relations_proof0 (i : Fin 17) : IsInClass O J (𝔭 0 i) (BM 0 i) := by
  show IsInClass O J (𝔭 0 i) (![![1], ![1], ![2], ![1], ![0], ![0], ![1], ![2], ![1], ![1], ![1], ![1], ![2], ![2], ![2], ![1], ![0]] i)
  unfold IsInClass
...
lemma relations_proof1 (i : Fin 7) : IsInClass O J (𝔭 1 i) (BM 1 i) := by
  show IsInClass O J (𝔭 1 i) (![![1], ![1], ![1], ![0], ![2], ![1], ![0]] i)
  unfold IsInClass
  simp only [Fin.isValue, Fin.prod_univ_castSucc, Finset.univ_eq_empty, Finset.prod_empty, Fin.succ_zero_eq_one, one_mul]
  fin_cases i
