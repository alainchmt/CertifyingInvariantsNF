import IdealArithmetic.Examples.NF3_1_45227_1.ClassGroupSaturated3_1_45227_1_3
import IdealArithmetic.Examples.NF3_1_45227_1.RelationIdeals3_1_45227_1F0
import IdealArithmetic.Examples.NF3_1_45227_1.RelationIdeals3_1_45227_1F1
import IdealArithmetic.Examples.NF3_1_45227_1.PrimesBelowCert3_1_45227_1
...
/- Number field `K(α)` with α root of polynomial `X^3 - X^2 + 47*X - 20`.
...
def SturmRC : SturmBuilderOfList [[-20, 47, -1, 1], [47, -2, 3], [133, -280], [-407043]] [-20, 47, -1, 1] [47, -2, 3] where
  hlen := by decide
  h0 := by decide
  h1 := by decide
  hlast := by decide
...
def RC : RankUnitsCertificate O where
  ...
  P := [[-20, 47, -1, 1], [47, -2, 3], [133, -280], [-407043]]
  SB := SturmRC
  k := 1
  r := 2
  hr := by decide
...
theorem K_minowski : minkowskiBoundFB K ≤ (60.18228382991017 : ℝ) := by
  refine K_minkowski_decimal _ ?_
  erw [K_nrComplexPlaces, K_discr, K_finrank]
  have hraux: √45227 ≤ 212.666415 := by
      refine Real.sqrt_le_iff.mpr ?_
      norm_num
  have : 0.2222222222222222 * √45227 ≤ 47.269203 := by
...
def BM : (i : Fin 2) → Fin (e i) → (Fin 1 → ℕ) := by 
  rintro ⟨i, hi⟩ 
  interval_cases i 
  exact ![![1], ![2], ![2], ![2], ![2], ![2], ![1], ![1], ![0], ![0], ![2], ![1], ![1]]
  exact ![![1], ![2], ![2], ![2], ![2]]

lemma primesGenerationBelow : {I : Ideal O | 0 < I.absNorm ∧ I.IsPrime ∧ I.absNorm < 61} ⊆ Set.range (Fin.addCasesIter e 𝔭) := by
  rw [← cert_eq_𝔭]
  refine le_primes_below_bound_of_PrimesBelowBoundCertificate_le_of_eq (Subalgebra.equivOfEq _ _ O_integral_closure).toRingEquiv PB61

def 𝔭' : Fin 18 → nonZeroDivisors (Ideal O) := by
  intro i
  have : PB61.β i ∈ List.ofFn PB61.β := by
    simp only [List.mem_ofFn, exists_apply_eq_apply]
  refine Ideal.toNonZeroDivisorOfNeZero ((PB61.β) i)
    (fun hc => ((zero_ne_mem_of_PrimesBelowCertificate_Fn _ PB61) (hc ▸ this) ))
...
lemma 𝔭'_apply : ∀ (i : Fin 18), ↑(𝔭' i) = (Fin.addCasesIter e 𝔭) i := by
  intro i
  rw [← cert_eq_𝔭]
  rfl
...
lemma relations_proof0 (i : Fin 13) : IsInClass O J (𝔭 0 i) (BM 0 i) := by
  show IsInClass O J (𝔭 0 i) (![![1], ![2], ![2], ![2], ![2], ![2], ![1], ![1], ![0], ![0], ![2], ![1], ![1]] i)
  unfold IsInClass
...
lemma relations_proof1 (i : Fin 5) : IsInClass O J (𝔭 1 i) (BM 1 i) := by
  show IsInClass O J (𝔭 1 i) (![![1], ![2], ![2], ![2], ![2]] i)
  unfold IsInClass
  simp only [Fin.isValue, Fin.prod_univ_castSucc, Finset.univ_eq_empty, Finset.prod_empty, Fin.succ_zero_eq_one, one_mul]
  fin_cases i
