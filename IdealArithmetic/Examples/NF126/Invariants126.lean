import IdealArithmetic.Examples.NF126.NonPrincipalExample126

/- Number field `K(α)` with with α root of polynomial `X^5 + 75*X - 60`.
Class number `5`, generated by class of ideal `J = (2, 1/4*a^4 + 3/4*a^3 + 5/4*a^2 + 3/4*a + 16)`. We have `J ^ 5` is principal. -/
