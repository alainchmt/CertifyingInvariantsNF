...
def A1: IdealEqSpanCertificate' Table ![![19, 0, 0], ![-5, 1, 0]] 
 ![![19, 0, 0], ![14, 1, 0], ![13, 0, 1]] where
  M :=![![![19, 0, 0], ![0, 19, 0], ![0, 0, 19]], ![![-5, 1, 0], ![0, -5, 1], ![37, 48, -5]]]
  hmulB := by decide  
  f := ![![![31, -6, 0], ![114, 0, 0]], ![![26, -5, 0], ![96, 0, 0]], ![![27, -5, 0], ![100, 1, 0]]]
  g := ![![![1, 0, 0], ![-14, 19, 0], ![-13, 0, 19]], ![![-1, 1, 0], ![3, -5, 1], ![-30, 48, -5]]]
  hle1 := by decide   
  hle2 := by decide  
...
def Log01Mem : IdealMemCertificate B I0
 ![![7, 0, 0], ![4, 1, 0], ![5, 0, 1]] ![-2804, -3222, 495] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![1087, -3222, 495]
 hmem := by decide
...
def Log02Mem : IdealMemCertificate B I0
 ![![7, 0, 0], ![4, 1, 0], ![5, 0, 1]] ![49, -7, 0] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![11, -7, 0]
 hmem := by decide
...
def Log10Mem : IdealMemCertificate B I1
 ![![19, 0, 0], ![14, 1, 0], ![13, 0, 1]] ![-7, -1, 2] where
...
def Log11Mem : IdealMemCertificate B I1
 ![![19, 0, 0], ![14, 1, 0], ![13, 0, 1]] ![-2801, -3222, 495] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![1888, -3222, 495]
 hmem := by decide

def Log11: DiscreteLogCertificate N1 ((orderOf_of_IsOrderOf R19) ▸ IsPrimitiveRoot.orderOf _) 3 zeta2 0 where
 r := 3
 hN := by infer_instance
 hpdvd := by decide
 B := B
...
def Log12Mem : IdealMemCertificate B I1
 ![![19, 0, 0], ![14, 1, 0], ![13, 0, 1]] ![35, -7, 0] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![7, -7, 0]
 hmem := by decide
...
def Log20Mem : IdealMemCertificate B I2
 ![![13, 0, 0], ![4, 1, 0], ![10, 0, 1]] ![-10, -1, 2] where
...
def Log21Mem : IdealMemCertificate B I2
 ![![13, 0, 0], ![4, 1, 0], ![10, 0, 1]] ![-2803, -3222, 495] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![395, -3222, 495]
 hmem := by decide
...
def Log22Mem : IdealMemCertificate B I2
 ![![13, 0, 0], ![4, 1, 0], ![10, 0, 1]] ![50, -7, 0] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![6, -7, 0]
 hmem := by decide
