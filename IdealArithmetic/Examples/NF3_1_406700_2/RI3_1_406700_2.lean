...
import IdealArithmetic.Examples.NF3_1_406700_2.Irreducible3_1_406700_2
...
noncomputable def T : ℤ[X] := X^3 - X^2 + 117*X + 337
lemma T_def : T = X^3 - X^2 + 117*X + 337 := rfl
...
-- We build the subalgebra with integral basis [1, a, 1/5*a^2 + 1/5*a - 1/5] 
...
![[0, 0, 1], [3, 1, 2], [0, 2, 2]]]
 ...
 g := ![![1, 0, 0],![12, 4, 8],![2, 4, 0]]
 a := ![![![1, 0],![0, 1]],![![675, -1116],![654, -1024]],![![295, -380],![230, -290]]]
 c := ![![![0],![0]],![![-635],![-614]],![![-273],![-206]]]
 d := ![![![0, 0]],![![-5, 20]],![![-15, 20]]]
 e := ![![![1]],![![13]],![![5]]]
