...
import IdealArithmetic.Examples.NF3_1_557179_1.Irreducible3_1_557179_1
...
noncomputable def T : ℤ[X] := X^3 - X^2 - 9*X + 1296
lemma T_def : T = X^3 - X^2 - 9*X + 1296 := rfl
