...
import IdealArithmetic.Examples.NF3_1_251451_1.Irreducible3_1_251451_1
...
noncomputable def T : ℤ[X] := X^3 + 36*X - 49
lemma T_def : T = X^3 + 36*X - 49 := rfl
