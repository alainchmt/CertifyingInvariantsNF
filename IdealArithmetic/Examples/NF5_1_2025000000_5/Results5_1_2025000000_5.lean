import IdealArithmetic.Examples.NF5_1_2025000000_5.Invariants5_1_2025000000_5

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 + 10*X^3 - 40*X^2 - 15*X - 232`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 + 10*X^3 - 40*X^2 - 15*X - 232)) := rfl

lemma T_irreducible' : Irreducible (X^5 + 10*X^3 - 40*X^2 - 15*X - 232 : ℤ[X]) := irreducible_T
