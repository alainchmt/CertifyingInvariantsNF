...
import IdealArithmetic.Examples.NF3_1_439803_1.Irreducible3_1_439803_1
...
noncomputable def T : ℤ[X] := X^3 + 165*X - 614
lemma T_def : T = X^3 + 165*X - 614 := rfl
