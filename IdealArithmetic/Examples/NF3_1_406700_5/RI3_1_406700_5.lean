...
import IdealArithmetic.Examples.NF3_1_406700_5.Irreducible3_1_406700_5
...
noncomputable def T : ℤ[X] := X^3 - X^2 + 47*X - 13
lemma T_def : T = X^3 - X^2 + 47*X - 13 := rfl
