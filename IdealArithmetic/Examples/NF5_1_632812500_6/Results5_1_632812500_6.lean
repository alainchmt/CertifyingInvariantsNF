import IdealArithmetic.Examples.NF5_1_632812500_6.Invariants5_1_632812500_6

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 - 25*X^3 - 50*X^2 + 300*X + 470`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 - 25*X^3 - 50*X^2 + 300*X + 470)) := rfl

lemma T_irreducible' : Irreducible (X^5 - 25*X^3 - 50*X^2 + 300*X + 470 : ℤ[X]) := irreducible_T
