import IdealArithmetic.Examples.NF5_1_1012500000_2.Invariants5_1_1012500000_2

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 + 15*X^3 - 80*X^2 - 90*X - 936`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 + 15*X^3 - 80*X^2 - 90*X - 936)) := rfl

lemma T_irreducible' : Irreducible (X^5 + 15*X^3 - 80*X^2 - 90*X - 936 : ℤ[X]) := irreducible_T
