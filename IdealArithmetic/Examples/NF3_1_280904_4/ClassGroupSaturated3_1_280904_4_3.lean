...
def I1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![31, 0, 0], ![12, 1, 0]] i)))
...
def A1: IdealEqSpanCertificate' Table ![![31, 0, 0], ![12, 1, 0]] 
...
def Log00Mem : IdealMemCertificate B I0
 ![![13, 0, 0], ![8, 1, 0], ![1, 0, 1]] ![41678519, 5982362, -1142786] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![-387507, 5982362, -1142786]
 hmem := by decide
...
def Log00: DiscreteLogCertificate N0 ((orderOf_of_IsOrderOf R13) ▸ IsPrimitiveRoot.orderOf _) 3 zeta1 1 where
 ...
 B := B
 hone := B_one
 xcoord := ![41678521, 5982362, -1142786]
 hxeq :=  rfl
 m := 2
 C := ![41678519, 5982362, -1142786]
 hCeq := by rfl
...
def Log01Mem : IdealMemCertificate B I0
 ![![13, 0, 0], ![8, 1, 0], ![1, 0, 1]] ![32, -6, 2] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![6, -6, 2]
 hmem := by decide
...
def Log10Mem : IdealMemCertificate B I1
 ![![31, 0, 0], ![12, 1, 0], ![6, 0, 1]] ![41678497, 5982362, -1142786] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![-750101, 5982362, -1142786]
 hmem := by decide
...
def Log11Mem : IdealMemCertificate B I1
 ![![31, 0, 0], ![12, 1, 0], ![6, 0, 1]] ![33, -6, 2] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![3, -6, 2]
 hmem := by decide
