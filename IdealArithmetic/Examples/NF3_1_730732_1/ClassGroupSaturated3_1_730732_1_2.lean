...
def Log00Mem : IdealMemCertificate B I0
 ![![3, 0, 0], ![0, 1, 0], ![2, 0, 1]] ![151872321164327, 186670362177936, 114149115795250] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![-25475303475391, 186670362177936, 114149115795250]
 hmem := by decide
...
def Log00: DiscreteLogCertificate N0 ((orderOf_of_IsOrderOf R3) ▸ IsPrimitiveRoot.orderOf _) 2 zeta1 1 where
 ...
 B := B
 hone := B_one
 xcoord := ![151872321164329, 186670362177936, 114149115795250]
 hxeq :=  rfl
 m := 2
 C := ![151872321164327, 186670362177936, 114149115795250]
 hCeq := by rfl
...
def Log02Mem : IdealMemCertificate B I0
 ![![3, 0, 0], ![0, 1, 0], ![2, 0, 1]] ![997270195631, -44498089007, 24436332337] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![316132510319, -44498089007, 24436332337]
 hmem := by decide
...
def Log02: DiscreteLogCertificate N0 ((orderOf_of_IsOrderOf R3) ▸ IsPrimitiveRoot.orderOf _) 2 alpha0 0 where
 ...
 B := B
 hone := B_one
 xcoord := ![997270195632, -44498089007, 24436332337]
 hxeq :=  rfl
 m := 1
 C := ![997270195631, -44498089007, 24436332337]
 hCeq := by rfl
...
def Log10Mem : IdealMemCertificate B I1
 ![![5, 0, 0], ![1, 1, 0], ![0, 0, 1]] ![151872321164326, 186670362177936, 114149115795250] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![-6959608202722, 186670362177936, 114149115795250]
 hmem := by decide
...
def Log10: DiscreteLogCertificate N1 ((orderOf_of_IsOrderOf R5) ▸ IsPrimitiveRoot.orderOf _) 2 zeta1 1 where
 ...
 hxeq :=  rfl
 m := 3
 C := ![151872321164326, 186670362177936, 114149115795250]
 hCeq := by rfl
...
def Log12Mem : IdealMemCertificate B I1
 ![![5, 0, 0], ![1, 1, 0], ![0, 0, 1]] ![997270195628, -44498089007, 24436332337] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![208353656927, -44498089007, 24436332337]
 hmem := by decide
...
def Log12: DiscreteLogCertificate N1 ((orderOf_of_IsOrderOf R5) ▸ IsPrimitiveRoot.orderOf _) 2 alpha0 0 where
 ...
 hxeq :=  rfl
 m := 4
 C := ![997270195628, -44498089007, 24436332337]
 hCeq := by rfl
...
def Log20Mem : IdealMemCertificate B I2
 ![![7, 0, 0], ![1, 1, 0], ![0, 0, 1]] ![151872321164326, 186670362177936, 114149115795250] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![-4971148716230, 186670362177936, 114149115795250]
 hmem := by decide
...
def Log22Mem : IdealMemCertificate B I2
 ![![7, 0, 0], ![1, 1, 0], ![0, 0, 1]] ![997270195627, -44498089007, 24436332337] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![148824040662, -44498089007, 24436332337]
 hmem := by decide
...
def Log22: DiscreteLogCertificate N2 ((orderOf_of_IsOrderOf R7) ▸ IsPrimitiveRoot.orderOf _) 2 alpha0 1 where
 ...
 hxeq :=  rfl
 m := 5
 C := ![997270195627, -44498089007, 24436332337]
 hCeq := by rfl
