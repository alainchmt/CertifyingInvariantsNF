import IdealArithmetic.Examples.NF3_1_110424_1.ClassGroupSaturated3_1_110424_1_2
import IdealArithmetic.Examples.NF3_1_110424_1.RelationIdeals3_1_110424_1F0
import IdealArithmetic.Examples.NF3_1_110424_1.RelationIdeals3_1_110424_1F1
import IdealArithmetic.Examples.NF3_1_110424_1.RelationIdeals3_1_110424_1F2
import IdealArithmetic.Examples.NF3_1_110424_1.PrimesBelowCert3_1_110424_1
...
/- Number field `K(α)` with α root of polynomial `X^3 + 54*X - 352`.
Class group structure `[2]`, generated by class of ideals `[(3, a - 1)]`. -/
...
def SturmRC : SturmBuilderOfList [[-352, 54, 0, 1], [54, 0, 3], [3168, -324], [-3975264]] [-352, 54, 0, 1] [54, 0, 3] where
  hlen := by decide
  h0 := by decide
  h1 := by decide
  hlast := by decide
...
def RC : RankUnitsCertificate O where
  ...
  P := [[-352, 54, 0, 1], [54, 0, 3], [3168, -324], [-3975264]]
  SB := SturmRC
  k := 1
  r := 2
  hr := by decide
...
theorem K_minowski : minkowskiBoundFB K ≤ (94.03196909557673 : ℝ) := by
  refine K_minkowski_decimal _ ?_
  erw [K_nrComplexPlaces, K_discr, K_finrank]
  have hraux: √110424 ≤ 332.30107799999996 := by
      refine Real.sqrt_le_iff.mpr ?_
      norm_num
  have : 0.2222222222222222 * √110424 ≤ 73.854684 := by
...
def BM : (i : Fin 3) → Fin (e i) → (Fin 1 → ℕ) := by 
  rintro ⟨i, hi⟩ 
  interval_cases i 
  exact ![![1], ![0], ![1], ![0], ![1], ![0], ![1], ![0], ![0], ![1], ![1]]
  exact ![![0], ![1], ![1], ![1], ![0], ![0], ![1], ![1], ![1], ![1], ![0], ![1]]
  exact ![![1], ![1], ![0]]
...
lemma relations_proof0 (i : Fin 11) : IsInClass O J (𝔭 0 i) (BM 0 i) := by
  show IsInClass O J (𝔭 0 i) (![![1], ![0], ![1], ![0], ![1], ![0], ![1], ![0], ![0], ![1], ![1]] i)
  unfold IsInClass
...
lemma relations_proof1 (i : Fin 12) : IsInClass O J (𝔭 1 i) (BM 1 i) := by
  show IsInClass O J (𝔭 1 i) (![![0], ![1], ![1], ![1], ![0], ![0], ![1], ![1], ![1], ![1], ![0], ![1]] i)
  unfold IsInClass
  simp only [Fin.isValue, Fin.prod_univ_castSucc, Finset.univ_eq_empty, Finset.prod_empty, Fin.succ_zero_eq_one, one_mul]
  fin_cases i
  · refine ideal_mem_principal_class''' (by decide) J rfl (by unfold_prod)
...
lemma relations_proof2 (i : Fin 3) : IsInClass O J (𝔭 2 i) (BM 2 i) := by
  show IsInClass O J (𝔭 2 i) (![![1], ![1], ![0]] i)
  unfold IsInClass
  simp only [Fin.isValue, Fin.prod_univ_castSucc, Finset.univ_eq_empty, Finset.prod_empty, Fin.succ_zero_eq_one, one_mul]
  fin_cases i
