...
def P7PI0 : CertificateIrreducibleZModOfList' 7 2 2 2 [2, 2, 1] where
 m := 1
 P := ![2]
 exp := ![1]
 hneq := by decide
...
def P7PI1 : CertificateIrreducibleZModOfList' 7 3 2 2 [4, 2, 5, 1] where
 m := 1
 P := ![3]
 exp := ![1]
 hneq := by decide
...
def P13PI1 : CertificateIrreducibleZModOfList' 13 4 2 3 [8, 6, 10, 7, 1] where
 m := 1
 P := ![2]
 exp := ![2]
 hneq := by decide
...
noncomputable def C : IrreducibleCertificateIntPolynomial T l where
 ...
 hirr := by
  ...
  · dsimp ; exact irreducible_ofList_ofCertificateIrreducibleZModOfList' P7PI0
