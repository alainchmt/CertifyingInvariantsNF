...
def A2: IdealEqSpanCertificate' Table ![![11, 0, 0], ![-5, 1, 0]] 
 ![![11, 0, 0], ![6, 1, 0], ![8, 0, 1]] where
  M :=![![![11, 0, 0], ![0, 11, 0], ![0, 0, 11]], ![![-5, 1, 0], ![0, -5, 1], ![-185, 46, -4]]]
  hmulB := by decide  
  f := ![![![56, -11, 0], ![121, 0, 0]], ![![36, -7, 0], ![78, 0, 0]], ![![38, -7, 0], ![82, 1, 0]]]
  g := ![![![1, 0, 0], ![-6, 11, 0], ![-8, 0, 11]], ![![-1, 1, 0], ![2, -5, 1], ![-39, 46, -4]]]
  hle1 := by decide   
  hle2 := by decide  
...
def Log00Mem : IdealMemCertificate B I0
 ![![5, 0, 0], ![2, 1, 0], ![1, 0, 1]] ![379388, -39838, -11221] where
...
def Log00: DiscreteLogCertificate N0 ((orderOf_of_IsOrderOf R5) ▸ IsPrimitiveRoot.orderOf _) 2 zeta1 1 where
 ...
 B := B
 hone := B_one
 xcoord := ![379391, -39838, -11221]
 hxeq :=  rfl
 m := 3
 C := ![379388, -39838, -11221]
 hCeq := by rfl
...
def Log02Mem : IdealMemCertificate B I0
 ![![5, 0, 0], ![2, 1, 0], ![1, 0, 1]] ![-45, 2, 1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![-10, 2, 1]
 hmem := by decide
...
def Log10Mem : IdealMemCertificate B I1
 ![![7, 0, 0], ![3, 1, 0], ![5, 0, 1]] ![379390, -39838, -11221] where
...
def Log12Mem : IdealMemCertificate B I1
 ![![7, 0, 0], ![3, 1, 0], ![5, 0, 1]] ![-45, 2, 1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![-8, 2, 1]
 hmem := by decide
...
def Log20Mem : IdealMemCertificate B I2
 ![![11, 0, 0], ![6, 1, 0], ![8, 0, 1]] ![379384, -39838, -11221] where
...
def Log21Mem : IdealMemCertificate B I2
 ![![11, 0, 0], ![6, 1, 0], ![8, 0, 1]] ![-11, 0, 0] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![-1, 0, 0]
 hmem := by decide
...
def Log22Mem : IdealMemCertificate B I2
 ![![11, 0, 0], ![6, 1, 0], ![8, 0, 1]] ![-46, 2, 1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![-6, 2, 1]
 hmem := by decide
