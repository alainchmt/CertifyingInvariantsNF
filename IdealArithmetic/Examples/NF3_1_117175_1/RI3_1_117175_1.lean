...
import IdealArithmetic.Examples.NF3_1_117175_1.Irreducible3_1_117175_1
...
noncomputable def T : ℤ[X] := X^3 + 25*X - 45
lemma T_def : T = X^3 + 25*X - 45 := rfl
