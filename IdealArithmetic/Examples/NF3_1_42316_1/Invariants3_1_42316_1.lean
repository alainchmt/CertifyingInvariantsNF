import IdealArithmetic.Examples.NF3_1_42316_1.ClassGroupSaturated3_1_42316_1_2
import IdealArithmetic.Examples.NF3_1_42316_1.RelationIdeals3_1_42316_1F0
import IdealArithmetic.Examples.NF3_1_42316_1.RelationIdeals3_1_42316_1F1
import IdealArithmetic.Examples.NF3_1_42316_1.PrimesBelowCert3_1_42316_1
...
/- Number field `K(α)` with α root of polynomial `X^3 - X^2 + 23*X - 75`.
Class group structure `[2]`, generated by class of ideals `[(10, a + 1)]`. -/
...
def SturmRC : SturmBuilderOfList [[-75, 23, -1, 1], [23, -2, 3], [652, -136], [-169264]] [-75, 23, -1, 1] [23, -2, 3] where
  hlen := by decide
  h0 := by decide
  h1 := by decide
  hlast := by decide
...
def RC : RankUnitsCertificate O where
  ...
  P := [[-75, 23, -1, 1], [23, -2, 3], [652, -136], [-169264]]
  SB := SturmRC
  k := 1
  r := 2
  hr := by decide
...
theorem K_minowski : minkowskiBoundFB K ≤ (58.213608267998715 : ℝ) := by
  refine K_minkowski_decimal _ ?_
  erw [K_nrComplexPlaces, K_discr, K_finrank]
  have hraux: √42316 ≤ 205.708542 := by
      refine Real.sqrt_le_iff.mpr ?_
      norm_num
  have : 0.2222222222222222 * √42316 ≤ 45.723009 := by
...
def BM : (i : Fin 2) → Fin (e i) → (Fin 1 → ℕ) := by 
  rintro ⟨i, hi⟩ 
  interval_cases i 
  exact ![![0], ![0], ![0], ![1], ![1], ![0], ![1], ![1], ![1], ![1], ![0], ![1], ![1], ![1], ![0], ![1]]
  exact ![![1], ![1], ![0]]
...
lemma relations_proof0 (i : Fin 16) : IsInClass O J (𝔭 0 i) (BM 0 i) := by
  show IsInClass O J (𝔭 0 i) (![![0], ![0], ![0], ![1], ![1], ![0], ![1], ![1], ![1], ![1], ![0], ![1], ![1], ![1], ![0], ![1]] i)
  unfold IsInClass
...
lemma relations_proof1 (i : Fin 3) : IsInClass O J (𝔭 1 i) (BM 1 i) := by
  show IsInClass O J (𝔭 1 i) (![![1], ![1], ![0]] i)
  unfold IsInClass
  simp only [Fin.isValue, Fin.prod_univ_castSucc, Finset.univ_eq_empty, Finset.prod_empty, Fin.succ_zero_eq_one, one_mul]
  fin_cases i
