...
import IdealArithmetic.Examples.NF3_3_50172_1.Irreducible3_3_50172_1
...
noncomputable def T : ℤ[X] := X^3 - X^2 - 48*X + 18
lemma T_def : T = X^3 - X^2 - 48*X + 18 := rfl
