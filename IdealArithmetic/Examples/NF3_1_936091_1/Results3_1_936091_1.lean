import IdealArithmetic.Examples.NF3_1_936091_1.Invariants3_1_936091_1

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^3 - X^2 - 17*X + 194`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^3 - X^2 - 17*X + 194)) := rfl

lemma T_irreducible' : Irreducible (X^3 - X^2 - 17*X + 194 : ℤ[X]) := irreducible_T
