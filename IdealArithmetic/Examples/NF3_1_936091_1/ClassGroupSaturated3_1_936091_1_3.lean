...
def Log00Mem : IdealMemCertificate B I0
 ![![7, 0, 0], ![4, 1, 0], ![5, 0, 1]] ![745302, -307227, -66234] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![329340, -307227, -66234]
 hmem := by decide
...
def Log00: DiscreteLogCertificate N0 ((orderOf_of_IsOrderOf R7) ▸ IsPrimitiveRoot.orderOf _) 3 zeta1 2 where
 ...
 B := B
 hone := B_one
 xcoord := ![745307, -307227, -66234]
 hxeq :=  rfl
 m := 5
 C := ![745302, -307227, -66234]
 hCeq := by rfl
...
def Log01Mem : IdealMemCertificate B I0
 ![![7, 0, 0], ![4, 1, 0], ![5, 0, 1]] ![-83, 7, 3] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![-18, 7, 3]
 hmem := by decide
...
def Log02Mem : IdealMemCertificate B I0
 ![![7, 0, 0], ![4, 1, 0], ![5, 0, 1]] ![2516, -614, 83] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![651, -614, 83]
 hmem := by decide
...
def Log10Mem : IdealMemCertificate B I1
 ![![13, 0, 0], ![4, 1, 0], ![10, 0, 1]] ![745295, -307227, -66234] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![202811, -307227, -66234]
 hmem := by decide
...
def Log11Mem : IdealMemCertificate B I1
 ![![13, 0, 0], ![4, 1, 0], ![10, 0, 1]] ![-85, 7, 3] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![-11, 7, 3]
 hmem := by decide
...
def Log12Mem : IdealMemCertificate B I1
 ![![13, 0, 0], ![4, 1, 0], ![10, 0, 1]] ![2508, -614, 83] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![318, -614, 83]
 hmem := by decide
...
def Log20Mem : IdealMemCertificate B I2
 ![![19, 0, 0], ![1, 1, 0], ![18, 0, 1]] ![745297, -307227, -66234] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![118144, -307227, -66234]
 hmem := by decide
...
def Log21Mem : IdealMemCertificate B I2
 ![![19, 0, 0], ![1, 1, 0], ![18, 0, 1]] ![-91, 7, 3] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![-8, 7, 3]
 hmem := by decide
...
def Log22Mem : IdealMemCertificate B I2
 ![![19, 0, 0], ![1, 1, 0], ![18, 0, 1]] ![2514, -614, 83] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![86, -614, 83]
 hmem := by decide
