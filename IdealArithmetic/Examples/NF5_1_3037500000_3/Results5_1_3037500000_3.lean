import IdealArithmetic.Examples.NF5_1_3037500000_3.Invariants5_1_3037500000_3

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 - 15*X^3 - 60*X^2 + 360*X - 288`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 - 15*X^3 - 60*X^2 + 360*X - 288)) := rfl

lemma T_irreducible' : Irreducible (X^5 - 15*X^3 - 60*X^2 + 360*X - 288 : ℤ[X]) := irreducible_T
