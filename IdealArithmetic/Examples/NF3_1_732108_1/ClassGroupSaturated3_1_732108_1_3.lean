...
def Log00Mem : IdealMemCertificate B I0
 ![![7, 0, 0], ![2, 1, 0], ![5, 0, 1]] ![-459035, 408505, 31091] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![-204500, 408505, 31091]
 hmem := by decide
...
def Log00: DiscreteLogCertificate N0 ((orderOf_of_IsOrderOf R7) ▸ IsPrimitiveRoot.orderOf _) 3 zeta1 1 where
 ...
 B := B
 hone := B_one
 xcoord := ![-459031, 408505, 31091]
 hxeq :=  rfl
 m := 4
 C := ![-459035, 408505, 31091]
 hCeq := by rfl
...
def Log10Mem : IdealMemCertificate B I1
 ![![7, 0, 0], ![1, 1, 0], ![6, 0, 1]] ![-459037, 408505, 31091] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![-150584, 408505, 31091]
 hmem := by decide
...
def Log20Mem : IdealMemCertificate B I2
 ![![13, 0, 0], ![4, 1, 0], ![0, 0, 1]] ![-459032, 408505, 31091] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![-161004, 408505, 31091]
 hmem := by decide
...
def Log21Mem : IdealMemCertificate B I2
 ![![13, 0, 0], ![4, 1, 0], ![0, 0, 1]] ![-5, 2, -1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![-1, 2, -1]
 hmem := by decide
...
def Log22Mem : IdealMemCertificate B I2
 ![![13, 0, 0], ![4, 1, 0], ![0, 0, 1]] ![-9, 1, -1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![-1, 1, -1]
 hmem := by decide
