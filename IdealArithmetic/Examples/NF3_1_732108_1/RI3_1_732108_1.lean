...
import IdealArithmetic.Examples.NF3_1_732108_1.Irreducible3_1_732108_1
...
noncomputable def T : ℤ[X] := X^3 - X^2 + 165*X - 183
lemma T_def : T = X^3 - X^2 + 165*X - 183 := rfl
