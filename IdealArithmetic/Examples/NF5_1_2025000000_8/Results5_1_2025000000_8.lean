import IdealArithmetic.Examples.NF5_1_2025000000_8.Invariants5_1_2025000000_8

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 - 15*X^3 - 10*X^2 + 210*X + 612`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 - 15*X^3 - 10*X^2 + 210*X + 612)) := rfl

lemma T_irreducible' : Irreducible (X^5 - 15*X^3 - 10*X^2 + 210*X + 612 : ℤ[X]) := irreducible_T
