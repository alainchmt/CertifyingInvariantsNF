...
def A1: IdealEqSpanCertificate' Table ![![19, 0, 0], ![3, 1, 0]] 
 ![![19, 0, 0], ![3, 1, 0], ![10, 0, 1]] where
  M :=![![![19, 0, 0], ![0, 19, 0], ![0, 0, 19]], ![![3, 1, 0], ![1, 3, 3], ![-122, -16, 4]]]
  hmulB := by decide  
  f := ![![![-25, -78, -78], ![0, 494, 0]], ![![-4, -12, -12], ![1, 76, 0]], ![![-13, -41, -41], ![-1, 260, 0]]]
  g := ![![![1, 0, 0], ![-3, 19, 0], ![-10, 0, 19]], ![![0, 1, 0], ![-2, 3, 3], ![-6, -16, 4]]]
  hle1 := by decide   
  hle2 := by decide  
...
def Log00Mem : IdealMemCertificate B I0
 ![![13, 0, 0], ![8, 1, 0], ![5, 0, 1]] ![-4050253, -726983, 68417] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![109502, -726983, 68417]
 hmem := by decide
...
def Log00: DiscreteLogCertificate N0 ((orderOf_of_IsOrderOf R13) ▸ IsPrimitiveRoot.orderOf _) 3 zeta1 1 where
 ...
 B := B
 hone := B_one
 xcoord := ![-4050250, -726983, 68417]
 hxeq :=  rfl
 m := 3
 C := ![-4050253, -726983, 68417]
 hCeq := by rfl
...
def Log01Mem : IdealMemCertificate B I0
 ![![13, 0, 0], ![8, 1, 0], ![5, 0, 1]] ![12126, -930, 476] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![1322, -930, 476]
 hmem := by decide
...
def Log10Mem : IdealMemCertificate B I1
 ![![19, 0, 0], ![3, 1, 0], ![10, 0, 1]] ![-4050265, -726983, 68417] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![-134394, -726983, 68417]
 hmem := by decide
...
def Log11Mem : IdealMemCertificate B I1
 ![![19, 0, 0], ![3, 1, 0], ![10, 0, 1]] ![12135, -930, 476] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![535, -930, 476]
 hmem := by decide
