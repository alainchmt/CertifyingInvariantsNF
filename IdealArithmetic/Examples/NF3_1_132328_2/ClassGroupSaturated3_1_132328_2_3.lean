...
def I1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![31, 0, 0], ![3, 1, 0]] i)))
...
def A1: IdealEqSpanCertificate' Table ![![31, 0, 0], ![3, 1, 0]] 
 ![![31, 0, 0], ![3, 1, 0], ![25, 0, 1]] where
  M :=![![![31, 0, 0], ![0, 31, 0], ![0, 0, 31]], ![![3, 1, 0], ![0, 4, 2], ![55, -19, 2]]]
  hmulB := by decide  
  f := ![![![58, 19, 0], ![-589, 0, 0]], ![![0, 0, 0], ![1, 0, 0]], ![![46, 13, -1], ![-467, 16, 0]]]
  g := ![![![1, 0, 0], ![-3, 31, 0], ![-25, 0, 31]], ![![0, 1, 0], ![-2, 4, 2], ![2, -19, 2]]]
  hle1 := by decide   
  hle2 := by decide  
...
def Log00Mem : IdealMemCertificate B I0
 ![![7, 0, 0], ![4, 1, 0], ![4, 0, 1]] ![1099017524, 1075397443, -1968325767] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![667247260, 1075397443, -1968325767]
 hmem := by decide
...
def Log00: DiscreteLogCertificate N0 ((orderOf_of_IsOrderOf R7) ▸ IsPrimitiveRoot.orderOf _) 3 zeta1 2 where
 ...
 B := B
 hone := B_one
 xcoord := ![1099017526, 1075397443, -1968325767]
 hxeq :=  rfl
 m := 2
 C := ![1099017524, 1075397443, -1968325767]
 hCeq := by rfl
...
def Log10Mem : IdealMemCertificate B I1
 ![![31, 0, 0], ![3, 1, 0], ![25, 0, 1]] ![1099017511, 1075397443, -1968325767] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![1518740947, 1075397443, -1968325767]
 hmem := by decide
...
def Log10: DiscreteLogCertificate N1 ((orderOf_of_IsOrderOf R31) ▸ IsPrimitiveRoot.orderOf _) 3 zeta1 0 where
 ...
 hxeq :=  rfl
 m := 15
 C := ![1099017511, 1075397443, -1968325767]
 hCeq := by rfl
...
def Log11Mem : IdealMemCertificate B I1
 ![![31, 0, 0], ![3, 1, 0], ![25, 0, 1]] ![-31, 2, 1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![-2, 2, 1]
 hmem := by decide
