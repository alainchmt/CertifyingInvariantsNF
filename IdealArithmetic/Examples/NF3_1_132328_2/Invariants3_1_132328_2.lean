import IdealArithmetic.Examples.NF3_1_132328_2.ClassGroupSaturated3_1_132328_2_3
import IdealArithmetic.Examples.NF3_1_132328_2.RelationIdeals3_1_132328_2F0
import IdealArithmetic.Examples.NF3_1_132328_2.RelationIdeals3_1_132328_2F1
import IdealArithmetic.Examples.NF3_1_132328_2.RelationIdeals3_1_132328_2F2
import IdealArithmetic.Examples.NF3_1_132328_2.PrimesBelowCert3_1_132328_2
...
/- Number field `K(α)` with α root of polynomial `X^3 + 37*X - 110`.
...
def SturmRC : SturmBuilderOfList [[-110, 37, 0, 1], [37, 0, 3], [990, -222], [-529312]] [-110, 37, 0, 1] [37, 0, 3] where
  hlen := by decide
  h0 := by decide
  h1 := by decide
  hlast := by decide
...
def RC : RankUnitsCertificate O where
  ...
  P := [[-110, 37, 0, 1], [37, 0, 3], [990, -222], [-529312]]
  SB := SturmRC
  k := 1
  r := 2
  hr := by decide
...
theorem K_minowski : minkowskiBoundFB K ≤ (102.93561701656499 : ℝ) := by
  refine K_minkowski_decimal _ ?_
  erw [K_nrComplexPlaces, K_discr, K_finrank]
  have hraux: √132328 ≤ 363.769168 := by
      refine Real.sqrt_le_iff.mpr ?_
      norm_num
  have : 0.2222222222222222 * √132328 ≤ 80.847593 := by
...
def BM : (i : Fin 3) → Fin (e i) → (Fin 1 → ℕ) := by 
  rintro ⟨i, hi⟩ 
  interval_cases i 
  exact ![![1], ![1], ![0], ![0], ![0], ![0], ![1], ![1], ![2], ![2], ![2], ![1], ![0]]
  exact ![![1], ![0], ![2], ![2], ![1], ![0], ![1], ![1], ![2], ![0], ![1]]
  exact ![![2], ![0], ![2], ![0]]

lemma primesGenerationBelow : {I : Ideal O | 0 < I.absNorm ∧ I.IsPrime ∧ I.absNorm < 103} ⊆ Set.range (Fin.addCasesIter e 𝔭) := by
  rw [← cert_eq_𝔭]
  refine le_primes_below_bound_of_PrimesBelowBoundCertificate_le_of_eq (Subalgebra.equivOfEq _ _ O_integral_closure).toRingEquiv PB103

def 𝔭' : Fin 28 → nonZeroDivisors (Ideal O) := by
  intro i
  have : PB103.β i ∈ List.ofFn PB103.β := by
    simp only [List.mem_ofFn, exists_apply_eq_apply]
  refine Ideal.toNonZeroDivisorOfNeZero ((PB103.β) i)
    (fun hc => ((zero_ne_mem_of_PrimesBelowCertificate_Fn _ PB103) (hc ▸ this) ))
...
lemma relations_proof0 (i : Fin 13) : IsInClass O J (𝔭 0 i) (BM 0 i) := by
  show IsInClass O J (𝔭 0 i) (![![1], ![1], ![0], ![0], ![0], ![0], ![1], ![1], ![2], ![2], ![2], ![1], ![0]] i)
  unfold IsInClass
...
lemma relations_proof1 (i : Fin 11) : IsInClass O J (𝔭 1 i) (BM 1 i) := by
  show IsInClass O J (𝔭 1 i) (![![1], ![0], ![2], ![2], ![1], ![0], ![1], ![1], ![2], ![0], ![1]] i)
  unfold IsInClass
  simp only [Fin.isValue, Fin.prod_univ_castSucc, Finset.univ_eq_empty, Finset.prod_empty, Fin.succ_zero_eq_one, one_mul]
  fin_cases i
...
lemma relations_proof2 (i : Fin 4) : IsInClass O J (𝔭 2 i) (BM 2 i) := by
  show IsInClass O J (𝔭 2 i) (![![2], ![0], ![2], ![0]] i)
  unfold IsInClass
  simp only [Fin.isValue, Fin.prod_univ_castSucc, Finset.univ_eq_empty, Finset.prod_empty, Fin.succ_zero_eq_one, one_mul]
  fin_cases i
