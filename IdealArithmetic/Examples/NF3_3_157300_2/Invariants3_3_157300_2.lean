import IdealArithmetic.Examples.NF3_3_157300_2.ClassGroupSaturated3_3_157300_2_3
import IdealArithmetic.Examples.NF3_3_157300_2.RelationIdeals3_3_157300_2F0
import IdealArithmetic.Examples.NF3_3_157300_2.RelationIdeals3_3_157300_2F1
import IdealArithmetic.Examples.NF3_3_157300_2.RelationIdeals3_3_157300_2F2
import IdealArithmetic.Examples.NF3_3_157300_2.PrimesBelowCert3_3_157300_2
...
/- Number field `K(α)` with α root of polynomial `X^3 - X^2 - 73*X - 53`.
...
def SturmRC : SturmBuilderOfList [[-53, -73, -1, 1], [-73, -2, 3], [550, 440], [1415700]] [-53, -73, -1, 1] [-73, -2, 3] where
  hlen := by decide
  h0 := by decide
  h1 := by decide
  hlast := by decide
...
def RC : RankUnitsCertificate O where
  ...
  P := [[-53, -73, -1, 1], [-73, -2, 3], [550, 440], [1415700]]
  SB := SturmRC
  k := 3
  r := 3
  hr := by decide
...
def NPSU3 : pSaturatedClassGroupCertificateNDvdT 3 ![J0] ![3] where 
 ...
 hDl := by decide 
 NInv := ![![2, 2, 2], ![0, 2, 2], ![1, 0, 2]]
 hN := by decide 

lemma T_discr : T.discr = 1415700 :=  by
  convert discriminant_eq_DiscriminantOfPRemainder_of_SturmBuilderOfList SturmRC
  rw [T_ofList]

theorem K_discr : NumberField.discr K = 157300 := by
...
theorem K_minowski : minkowskiBoundFB K ≤ (88.14569784467528 : ℝ) := by
  refine K_minkowski_decimal _ ?_
  erw [K_nrComplexPlaces, K_discr, K_finrank]
  have hraux: √157300 ≤ 396.61064999999996 := by
      refine Real.sqrt_le_iff.mpr ?_
      norm_num
  have : 0.2222222222222222 * √157300 ≤ 88.1457 := by
...
def BM : (i : Fin 3) → Fin (e i) → (Fin 1 → ℕ) := by 
  rintro ⟨i, hi⟩ 
  interval_cases i 
  exact ![![1], ![1], ![0], ![2], ![1], ![0], ![0], ![1], ![1], ![1], ![0], ![2]]
  exact ![![2], ![2], ![1], ![0], ![2], ![1], ![1], ![2], ![2], ![1]]
  exact ![![1]]

lemma primesGenerationBelow : {I : Ideal O | 0 < I.absNorm ∧ I.IsPrime ∧ I.absNorm < 89} ⊆ Set.range (Fin.addCasesIter e 𝔭) := by
  rw [← cert_eq_𝔭]
  refine le_primes_below_bound_of_PrimesBelowBoundCertificate_le_of_eq (Subalgebra.equivOfEq _ _ O_integral_closure).toRingEquiv PB89

def 𝔭' : Fin 23 → nonZeroDivisors (Ideal O) := by
  intro i
  have : PB89.β i ∈ List.ofFn PB89.β := by
    simp only [List.mem_ofFn, exists_apply_eq_apply]
  refine Ideal.toNonZeroDivisorOfNeZero ((PB89.β) i)
    (fun hc => ((zero_ne_mem_of_PrimesBelowCertificate_Fn _ PB89) (hc ▸ this) ))
...
lemma relations_proof0 (i : Fin 12) : IsInClass O J (𝔭 0 i) (BM 0 i) := by
  show IsInClass O J (𝔭 0 i) (![![1], ![1], ![0], ![2], ![1], ![0], ![0], ![1], ![1], ![1], ![0], ![2]] i)
  unfold IsInClass
...
lemma relations_proof1 (i : Fin 10) : IsInClass O J (𝔭 1 i) (BM 1 i) := by
  show IsInClass O J (𝔭 1 i) (![![2], ![2], ![1], ![0], ![2], ![1], ![1], ![2], ![2], ![1]] i)
  unfold IsInClass
  simp only [Fin.isValue, Fin.prod_univ_castSucc, Finset.univ_eq_empty, Finset.prod_empty, Fin.succ_zero_eq_one, one_mul]
  fin_cases i
