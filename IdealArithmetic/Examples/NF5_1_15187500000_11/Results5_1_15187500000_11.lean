import IdealArithmetic.Examples.NF5_1_15187500000_11.Invariants5_1_15187500000_11

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 + 25*X^3 - 150*X^2 + 450*X - 240`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 + 25*X^3 - 150*X^2 + 450*X - 240)) := rfl

lemma T_irreducible' : Irreducible (X^5 + 25*X^3 - 150*X^2 + 450*X - 240 : ℤ[X]) := irreducible_T
