...
def I2 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![19, 0, 0], ![0, 1, 0]] i)))

def A0: IdealEqSpanCertificate' Table ![![31, 0, 0], ![1, 1, 0]] 
 ![![31, 0, 0], ![1, 1, 0], ![30, 0, 1]] where
  M :=![![![31, 0, 0], ![0, 31, 0], ![0, 0, 31]], ![![1, 1, 0], ![0, 2, 2], ![95, -29, 0]]]
  hmulB := by decide  
  f := ![![![0, -1, 0], ![31, 0, 0]], ![![0, 0, 0], ![1, 0, 0]], ![![0, -2, -1], ![30, 16, 0]]]
  g := ![![![1, 0, 0], ![-1, 31, 0], ![-30, 0, 31]], ![![0, 1, 0], ![-2, 2, 2], ![4, -29, 0]]]
  hle1 := by decide   
  hle2 := by decide  
...
def A2: IdealEqSpanCertificate' Table ![![19, 0, 0], ![0, 1, 0]] 
...
def Log00Mem : IdealMemCertificate B I0
 ![![31, 0, 0], ![1, 1, 0], ![30, 0, 1]] ![-81501, 23174, 5134] where
...
def Log01Mem : IdealMemCertificate B I0
 ![![31, 0, 0], ![1, 1, 0], ![30, 0, 1]] ![-1, -1, 0] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![0, -1, 0]
 hmem := by decide
...
def Log02Mem : IdealMemCertificate B I0
 ![![31, 0, 0], ![1, 1, 0], ![30, 0, 1]] ![55, -14, -7] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![9, -14, -7]
 hmem := by decide
...
def Log10Mem : IdealMemCertificate B I1
 ![![13, 0, 0], ![2, 1, 0], ![10, 0, 1]] ![-81491, 23174, 5134] where
...
def Log11Mem : IdealMemCertificate B I1
 ![![13, 0, 0], ![2, 1, 0], ![10, 0, 1]] ![-2, -1, 0] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![0, -1, 0]
 hmem := by decide
...
def Log12Mem : IdealMemCertificate B I1
 ![![13, 0, 0], ![2, 1, 0], ![10, 0, 1]] ![58, -14, -7] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![12, -14, -7]
 hmem := by decide
...
def Log20Mem : IdealMemCertificate B I2
 ![![19, 0, 0], ![0, 1, 0], ![0, 0, 1]] ![-81491, 23174, 5134] where
...
def Log21Mem : IdealMemCertificate B I2
 ![![19, 0, 0], ![0, 1, 0], ![0, 0, 1]] ![0, -1, 0] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![0, -1, 0]
 hmem := by decide
...
def Log22Mem : IdealMemCertificate B I2
 ![![19, 0, 0], ![0, 1, 0], ![0, 0, 1]] ![57, -14, -7] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![3, -14, -7]
 hmem := by decide
