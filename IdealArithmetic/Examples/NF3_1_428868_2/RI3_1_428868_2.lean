...
import IdealArithmetic.Examples.NF3_1_428868_2.Irreducible3_1_428868_2
...
noncomputable def T : ℤ[X] := X^3 + 57*X - 190
lemma T_def : T = X^3 + 57*X - 190 := rfl
