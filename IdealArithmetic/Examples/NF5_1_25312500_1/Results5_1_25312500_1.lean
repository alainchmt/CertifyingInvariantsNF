import IdealArithmetic.Examples.NF5_1_25312500_1.Invariants5_1_25312500_1

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 - 30*X^2 - 135*X - 252`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 - 30*X^2 - 135*X - 252)) := rfl

lemma T_irreducible' : Irreducible (X^5 - 30*X^2 - 135*X - 252 : ℤ[X]) := irreducible_T
