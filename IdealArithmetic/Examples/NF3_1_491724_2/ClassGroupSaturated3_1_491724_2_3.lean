...
def I0 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![31, 0, 0], ![-11, 1, 0]] i)))
def I1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![13, 0, 0], ![-6, 1, 0]] i)))

def A0: IdealEqSpanCertificate' Table ![![31, 0, 0], ![-11, 1, 0]] 
...
def A1: IdealEqSpanCertificate' Table ![![13, 0, 0], ![-6, 1, 0]] 
 ![![13, 0, 0], ![7, 1, 0], ![3, 0, 1]] where
  M :=![![![13, 0, 0], ![0, 13, 0], ![0, 0, 13]], ![![-6, 1, 0], ![0, -6, 1], ![762, 156, -6]]]
  hmulB := by decide  
  f := ![![![79, -13, 0], ![169, 0, 0]], ![![49, -8, 0], ![105, 0, 0]], ![![21, -3, 0], ![45, 1, 0]]]
  g := ![![![1, 0, 0], ![-7, 13, 0], ![-3, 0, 13]], ![![-1, 1, 0], ![3, -6, 1], ![-24, 156, -6]]]
  hle1 := by decide   
  hle2 := by decide  
...
def Log00Mem : IdealMemCertificate B I0
 ![![31, 0, 0], ![20, 1, 0], ![3, 0, 1]] ![-3511834, -252176, 34278] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![46092, -252176, 34278]
 hmem := by decide
...
def Log00: DiscreteLogCertificate N0 ((orderOf_of_IsOrderOf R31) ▸ IsPrimitiveRoot.orderOf _) 3 zeta1 2 where
 ...
 B := B
 hone := B_one
 xcoord := ![-3511825, -252176, 34278]
 hxeq :=  rfl
 m := 9
 C := ![-3511834, -252176, 34278]
 hCeq := by rfl
...
def Log01Mem : IdealMemCertificate B I0
 ![![31, 0, 0], ![20, 1, 0], ![3, 0, 1]] ![-176, -44, -3] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![23, -44, -3]
 hmem := by decide
...
def Log10Mem : IdealMemCertificate B I1
 ![![13, 0, 0], ![7, 1, 0], ![3, 0, 1]] ![-3511830, -252176, 34278] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![-142264, -252176, 34278]
 hmem := by decide
...
def Log11Mem : IdealMemCertificate B I1
 ![![13, 0, 0], ![7, 1, 0], ![3, 0, 1]] ![-174, -44, -3] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![11, -44, -3]
 hmem := by decide
