...
def P11PI0 : CertificateIrreducibleZModOfList' 11 2 2 3 [8, 1, 1] where
 m := 1
 P := ![2]
 exp := ![1]
 hneq := by decide
...
def P11PI1 : CertificateIrreducibleZModOfList' 11 3 2 3 [6, 10, 10, 1] where
 m := 1
 P := ![3]
 exp := ![1]
 hneq := by decide
...
def P29PI1 : CertificateIrreducibleZModOfList' 29 4 2 4 [28, 8, 23, 24, 1] where
 m := 1
 P := ![2]
 exp := ![2]
 hneq := by decide
...
noncomputable def C : IrreducibleCertificateIntPolynomial T l where
 ...
 hirr := by
  ...
  · dsimp ; exact irreducible_ofList_ofCertificateIrreducibleZModOfList' P11PI0
  · dsimp ; exact irreducible_ofList_ofCertificateIrreducibleZModOfList' P11PI1
  · exact irreducible_ofList_of_linear (R := ZMod 29) _ (by decide) rfl
  · dsimp ; exact irreducible_ofList_ofCertificateIrreducibleZModOfList' P29PI1
 hm := by decide
 hprod := by decide
 hinter := by decide
