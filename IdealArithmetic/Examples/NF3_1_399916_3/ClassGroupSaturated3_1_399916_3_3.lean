...
def Log00Mem : IdealMemCertificate B I0
 ![![31, 0, 0], ![10, 1, 0], ![28, 0, 1]] ![221536, 166896, -61627] where
...
def Log00: DiscreteLogCertificate N0 ((orderOf_of_IsOrderOf R31) ▸ IsPrimitiveRoot.orderOf _) 3 zeta1 1 where
 ...
 B := B
 hone := B_one
 xcoord := ![221553, 166896, -61627]
 hxeq :=  rfl
 m := 17
 C := ![221536, 166896, -61627]
 hCeq := by rfl
...
def Log01Mem : IdealMemCertificate B I0
 ![![31, 0, 0], ![10, 1, 0], ![28, 0, 1]] ![3568780, 536804, 190078] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![-229724, 536804, 190078]
 hmem := by decide
...
def Log01: DiscreteLogCertificate N0 ((orderOf_of_IsOrderOf R31) ▸ IsPrimitiveRoot.orderOf _) 3 alpha0 0 where
 ...
 B := B
 hone := B_one
 xcoord := ![3568807, 536804, 190078]
 hxeq :=  rfl
 m := 27
 C := ![3568780, 536804, 190078]
 hCeq := by rfl
...
def Log10Mem : IdealMemCertificate B I1
 ![![19, 0, 0], ![16, 1, 0], ![15, 0, 1]] ![221542, 166896, -61627] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![-80231, 166896, -61627]
 hmem := by decide
...
def Log11Mem : IdealMemCertificate B I1
 ![![19, 0, 0], ![16, 1, 0], ![15, 0, 1]] ![3568790, 536804, 190078] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![-414276, 536804, 190078]
 hmem := by decide
