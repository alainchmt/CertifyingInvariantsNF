...
import IdealArithmetic.Examples.NF123.RI123
...
def alpha := B.equivFun.symm ![10068117025306292741207, 920598809183421036433, 825434632072257476354, -237969304875711315349, 2837709977494504993054]
...
def J : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![2, 0, 0, 0, 0], ![7, -2, 1, -1, 6]] i)))
...
lemma isUnit_zeta1 : IsUnit zeta1 := by 
 apply isUnit_of_mul_eq_one _ (B.equivFun.symm ![344412118014352214, 31492024271224303, 28236629471802842, -8140500563315459, 97072938388913653])
 rw [← B_one_repr]
...
lemma isUnit_zeta2 : IsUnit zeta2 := by 
 apply isUnit_of_mul_eq_one _ (B.equivFun.symm ![-778559803182313074925274, 103413255323453356813642, 75739613518786416371803, -18704694124197856516081, 360078571582185268860887])
 rw [← B_one_repr]
 refine table_mul_list_eq_mul timesTableO.table B _ _ _ timesTableO.basis_mul_basis ?_
 rw [← table_mul_eq_table_mul' _ _ timesTableT_eq_Table]
 decide
