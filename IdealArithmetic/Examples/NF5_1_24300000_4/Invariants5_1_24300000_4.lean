...
import IdealArithmetic.Examples.NF5_1_24300000_4.PrimesBelowCert5_1_24300000_4
...
/- Number field `K(α)` with α root of polynomial `X^5 - 5*X^3 - 10*X^2 - 16`.
Class group structure `[]`, generated by class of ideals `[]`. -/

/- Ring of integers with basis `[1, a, a^2, 1/2*a^3 - 1/2*a, 1/4*a^4 - 1/4*a^2 - 1/2*a]` -/
...
def SturmRC : SturmBuilderOfList [[-16, 0, -10, -5, 0, 1], [0, -20, -15, 0, 5], [400, 0, 150, 50], [-12000, 6000, -3000], [2160000, -1080000], [1555200000]] [-16, 0, -10, -5, 0, 1] [0, -20, -15, 0, 5] where
  hlen := by decide
  h0 := by decide
  h1 := by decide
  hlast := by decide
  ...
  e := [25, 2500, 9000000, 1166400000000]
  f := [1, 25, 2500, 9000000]
  epos := by decide
  fpos := by decide
  Q := [[0, 5], [-750, 250], [-750000, -150000], [0, 3240000000]]
  hel := by decide
  hfl := by decide
  hQl := by decide
  hrem := by
...
def RC : RankUnitsCertificate O where
  ...
  P := [[-16, 0, -10, -5, 0, 1], [0, -20, -15, 0, 5], [400, 0, 150, 50], [-12000, 6000, -3000], [2160000, -1080000], [1555200000]]
  SB := SturmRC
  k := 1
  r := 3
  hr := by decide
...
lemma T_discr : T.discr = 1555200000 :=  by
