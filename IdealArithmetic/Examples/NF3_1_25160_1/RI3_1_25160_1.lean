...
import IdealArithmetic.Examples.NF3_1_25160_1.Irreducible3_1_25160_1
...
noncomputable def T : ℤ[X] := X^3 - X^2 + 29*X - 25
lemma T_def : T = X^3 - X^2 + 29*X - 25 := rfl
