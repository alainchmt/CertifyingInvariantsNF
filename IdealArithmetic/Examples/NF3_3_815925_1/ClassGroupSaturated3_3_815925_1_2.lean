...
def I3 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![3, 0, 0], ![-1, 1, 0]] i)))

def A0: IdealEqSpanCertificate' Table ![![3, 0, 0], ![-2, 1, 0]] 
 ![![3, 0, 0], ![1, 1, 0], ![2, 0, 1]] where
  M :=![![![3, 0, 0], ![0, 3, 0], ![0, 0, 3]], ![![-2, 1, 0], ![2, -3, 4], ![-12, 36, 0]]]
  hmulB := by decide  
  f := ![![![3, -3, 4], ![0, -3, 0]], ![![1, 0, 0], ![1, 0, 0]], ![![2, -2, 3], ![0, -2, 0]]]
  g := ![![![1, 0, 0], ![-1, 3, 0], ![-2, 0, 3]], ![![-1, 1, 0], ![-1, -3, 4], ![-16, 36, 0]]]
  hle1 := by decide   
  hle2 := by decide  
...
def A3: IdealEqSpanCertificate' Table ![![3, 0, 0], ![-1, 1, 0]] 
...
def Log01Mem : IdealMemCertificate B I0
 ![![3, 0, 0], ![1, 1, 0], ![2, 0, 1]] ![-206979, 449034, -129642] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![-132243, 449034, -129642]
 hmem := by decide
...
def Log01: DiscreteLogCertificate N0 ((orderOf_of_IsOrderOf R3) ▸ IsPrimitiveRoot.orderOf _) 2 zeta2 1 where
 ...
 B := B
 hone := B_one
 xcoord := ![-206977, 449034, -129642]
 hxeq :=  rfl
 m := 2
 C := ![-206979, 449034, -129642]
 hCeq := by rfl
...
def Log03Mem : IdealMemCertificate B I0
 ![![3, 0, 0], ![1, 1, 0], ![2, 0, 1]] ![-440, -5, 12] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![-153, -5, 12]
 hmem := by decide
...
def Log10Mem : IdealMemCertificate B I1
 ![![7, 0, 0], ![2, 1, 0], ![0, 0, 1]] ![92, -472, -185] where
...
def Log11Mem : IdealMemCertificate B I1
 ![![7, 0, 0], ![2, 1, 0], ![0, 0, 1]] ![-206980, 449034, -129642] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![-157864, 449034, -129642]
 hmem := by decide
...
def Log13Mem : IdealMemCertificate B I1
 ![![7, 0, 0], ![2, 1, 0], ![0, 0, 1]] ![-444, -5, 12] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![-62, -5, 12]
 hmem := by decide
...
def Log20Mem : IdealMemCertificate B I2
 ![![11, 0, 0], ![1, 1, 0], ![6, 0, 1]] ![90, -472, -185] where
...
def Log21Mem : IdealMemCertificate B I2
 ![![11, 0, 0], ![1, 1, 0], ![6, 0, 1]] ![-206982, 449034, -129642] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![11076, 449034, -129642]
 hmem := by decide
...
def Log22Mem : IdealMemCertificate B I2
 ![![11, 0, 0], ![1, 1, 0], ![6, 0, 1]] ![-11, 0, 0] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![-1, 0, 0]
 hmem := by decide
...
def Log23Mem : IdealMemCertificate B I2
 ![![11, 0, 0], ![1, 1, 0], ![6, 0, 1]] ![-439, -5, 12] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![-46, -5, 12]
 hmem := by decide
...
def Log30Mem : IdealMemCertificate B I3
 ![![3, 0, 0], ![2, 1, 0], ![0, 0, 1]] ![94, -472, -185] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A3
 g := ![346, -472, -185]
 hmem := by decide

def Log30: DiscreteLogCertificate N3 ((orderOf_of_IsOrderOf R3) ▸ IsPrimitiveRoot.orderOf _) 2 zeta1 0 where
 r := 3
 hN := by infer_instance
 hpdvd := by decide
 B := B
...
def Log31Mem : IdealMemCertificate B I3
 ![![3, 0, 0], ![2, 1, 0], ![0, 0, 1]] ![-206979, 449034, -129642] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A3
 g := ![-368349, 449034, -129642]
 hmem := by decide

def Log31: DiscreteLogCertificate N3 ((orderOf_of_IsOrderOf R3) ▸ IsPrimitiveRoot.orderOf _) 2 zeta2 1 where
 r := 3
 hN := by infer_instance
 hpdvd := by decide
 B := B
...
def Log32: DiscreteLogCertificate N3 ((orderOf_of_IsOrderOf R3) ▸ IsPrimitiveRoot.orderOf _) 2 v 1 where
 r := 3
 hN := by infer_instance
 hpdvd := by decide
 B := B
...
def Log33Mem : IdealMemCertificate B I3
 ![![3, 0, 0], ![2, 1, 0], ![0, 0, 1]] ![-439, -5, 12] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A3
 g := ![-143, -5, 12]
 hmem := by decide

def Log33: DiscreteLogCertificate N3 ((orderOf_of_IsOrderOf R3) ▸ IsPrimitiveRoot.orderOf _) 2 alpha0 0 where
 r := 3
 hN := by infer_instance
 hpdvd := by decide
 B := B
