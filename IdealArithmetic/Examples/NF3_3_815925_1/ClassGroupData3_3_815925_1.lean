...
def alpha0 := B.equivFun.symm ![-438, -5, 12]

def v := B.equivFun.symm ![-1, 0, 0]

def zeta1 := B.equivFun.symm ![95, -472, -185]

def zeta2 := B.equivFun.symm ![-206977, 449034, -129642]
...
def MulJ00 : IdealMulEqCertificate timesTableO (J0) J0
 ...
 hmul := by decide
 f := ![![![![-80, -90, 62], ![148, 80, 0]], ![![0, 0, 0], ![-219, 0, 0]]]]
 g := ![![![![-1, 5, 2]], ![![-7, 33, 12]]], ![![![-7, 33, 12]], ![![-39, 196, 78]]]]
 hle1 := by decide
 hle2 := by decide
...
lemma isUnit_zeta1 : IsUnit zeta1 := by 
 apply IsUnit.of_mul_eq_one (B.equivFun.symm ![2245656, 25327, -61429])
 rw [← B_one_repr]
...
lemma isUnit_zeta2 : IsUnit zeta2 := by 
 apply IsUnit.of_mul_eq_one (B.equivFun.symm ![-815461, 3967806, 1510998])
 rw [← B_one_repr]
 refine table_mul_list_eq_mul timesTableO.table B _ _ _ timesTableO.basis_mul_basis ?_
 rw [← table_mul_eq_table_mul' _ _ timesTableT_eq_Table]
 decide
