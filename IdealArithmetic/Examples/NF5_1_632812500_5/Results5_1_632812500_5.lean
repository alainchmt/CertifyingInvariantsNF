import IdealArithmetic.Examples.NF5_1_632812500_5.Invariants5_1_632812500_5

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 - 50*X^2 + 75*X + 30`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 - 50*X^2 + 75*X + 30)) := rfl

lemma T_irreducible' : Irreducible (X^5 - 50*X^2 + 75*X + 30 : ℤ[X]) := irreducible_T
