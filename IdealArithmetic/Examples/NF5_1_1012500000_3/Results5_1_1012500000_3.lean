import IdealArithmetic.Examples.NF5_1_1012500000_3.Invariants5_1_1012500000_3

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 - 15*X^3 - 210*X^2 - 540*X - 648`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 - 15*X^3 - 210*X^2 - 540*X - 648)) := rfl

lemma T_irreducible' : Irreducible (X^5 - 15*X^3 - 210*X^2 - 540*X - 648 : ℤ[X]) := irreducible_T
