...
noncomputable def R2RS0 : IdealMulPrincipalCertificate timesTableO (J0 ^ 1*J1^ 0) ![1, 0, 0, 0, 0] ![![2, 0, 0, 0, 0], ![0, 1, 0, 0, 0]]
...
noncomputable def E2RS0 : IdealEqCertificateO timesTableO (Ideal.span {1} * I2N0) (Ideal.span {B.equivFun.symm ![1, 0, 0, 0, 0]} * (J0 ^ 1*J1^ 0)) 
      ![![2, 0, 0, 0, 0], ![0, 1, 0, 0, 0]] ![![2, 0, 0, 0, 0], ![0, 1, 0, 0, 0]] where 
    T := Table
    heq := timesTableT_eq_Table
...
noncomputable def R2RS1 : IdealMulPrincipalCertificate timesTableO (J0 ^ 0*J1^ 1) ![4, -1, -2, -1, 5] ![![2, 0, 0, 0, 0], ![-2, 0, 1, 1, -4]]
  ![![8, -2, -4, -2, 10], ![-12, 2, 4, 2, -10]] where
    T := Table
    heq := timesTableT_eq_Table
    hI := by exact PowJ0_0J1_1
    hmul := by decide

noncomputable def E2RS1 : IdealEqCertificateO timesTableO (Ideal.span {2} * I2N1) (Ideal.span {B.equivFun.symm ![4, -1, -2, -1, 5]} * (J0 ^ 0*J1^ 1)) 
      ![![4, 0, 0, 0, 0], ![4, 0, -2, 0, 2]] ![![8, -2, -4, -2, 10], ![-12, 2, 4, 2, -10]] where 
    T := Table
    heq := timesTableT_eq_Table
...
noncomputable def R2RS2 : IdealMulPrincipalCertificate timesTableO (J0 ^ 1*J1^ 1) ![-17, 2, 6, 3, -16] ![![4, 0, 0, 0, 0], ![2, 1, -1, 0, 2]]
  ![![-68, 8, 24, 12, -64], ![-36, 4, 16, 8, -40]] where
    T := Table
    heq := timesTableT_eq_Table
    hI := by exact PowJ0_1J1_1
    hmul := by decide

noncomputable def E2RS2 : IdealEqCertificateO timesTableO (Ideal.span {4} * I2N2) (Ideal.span {B.equivFun.symm ![-17, 2, 6, 3, -16]} * (J0 ^ 1*J1^ 1)) 
      ![![8, 0, 0, 0, 0], ![4, 4, 0, 0, 0]] ![![-68, 8, 24, 12, -64], ![-36, 4, 16, 8, -40]] where 
    T := Table
    heq := timesTableT_eq_Table
    hieq1 := by convert ideal_mul_span_singleton_coe (R := ℤ)  _ _ _ rfl 4 ; decide ; exact {out := by decide}
    hieq2 := by 
      rw [← ideal_eq_principal_mul_of_IdealMulPrincipalCertificate _ _ _ _ _ R2RS2]  
      rfl
...
lemma R2N2 : Ideal.span {4} * I2N2 =  Ideal.span {B.equivFun.symm ![-17, 2, 6, 3, -16]} * (J0 ^ 1*J1^ 1) := by 
  refine ideal_eq_of_IdealEqCertificateO _ _ _ _ _ E2RS2
                    

noncomputable def R5RS0 : IdealMulPrincipalCertificate timesTableO (J0 ^ 1*J1^ 0) ![7, 0, -2, -1, 6] ![![2, 0, 0, 0, 0], ![0, 1, 0, 0, 0]]
  ![![14, 0, -4, -2, 12], ![-2, 0, 0, 0, 2]] where
    T := Table
    heq := timesTableT_eq_Table
    hI := by exact PowJ0_1J1_0
    hmul := by decide

noncomputable def E5RS0 : IdealEqCertificateO timesTableO (Ideal.span {2} * I5N0) (Ideal.span {B.equivFun.symm ![7, 0, -2, -1, 6]} * (J0 ^ 1*J1^ 0)) 
      ![![10, 0, 0, 0, 0], ![2, 4, -2, 0, 2]] ![![14, 0, -4, -2, 12], ![-2, 0, 0, 0, 2]] where 
    T := Table
    heq := timesTableT_eq_Table
    hieq1 := by convert ideal_mul_span_singleton_coe (R := ℤ)  _ _ _ rfl 2 ; decide ; exact {out := by decide}
    hieq2 := by 
...
noncomputable def R7RS0 : IdealMulPrincipalCertificate timesTableO (J0 ^ 1*J1^ 1) ![1, 0, -2, -1, 6] ![![4, 0, 0, 0, 0], ![2, 1, -1, 0, 2]]
  ![![4, 0, -8, -4, 24], ![0, -12, -4, -4, 12]] where
    T := Table
    heq := timesTableT_eq_Table
    hI := by exact PowJ0_1J1_1
    hmul := by decide

noncomputable def E7RS0 : IdealEqCertificateO timesTableO (Ideal.span {4} * I7N0) (Ideal.span {B.equivFun.symm ![1, 0, -2, -1, 6]} * (J0 ^ 1*J1^ 1)) 
      ![![28, 0, 0, 0, 0], ![12, 8, -4, 0, 4]] ![![4, 0, -8, -4, 24], ![0, -12, -4, -4, 12]] where 
    T := Table
    heq := timesTableT_eq_Table
    hieq1 := by convert ideal_mul_span_singleton_coe (R := ℤ)  _ _ _ rfl 4 ; decide ; exact {out := by decide}
    hieq2 := by 
...
noncomputable def R7RS1 : IdealMulPrincipalCertificate timesTableO (J0 ^ 1*J1^ 1) ![-5, 0, 2, 1, -6] ![![4, 0, 0, 0, 0], ![2, 1, -1, 0, 2]]
  ![![-20, 0, 8, 4, -24], ![-8, 8, 8, 4, -20]] where
    T := Table
    heq := timesTableT_eq_Table
    hI := by exact PowJ0_1J1_1
    hmul := by decide

noncomputable def E7RS1 : IdealEqCertificateO timesTableO (Ideal.span {4} * I7N1) (Ideal.span {B.equivFun.symm ![-5, 0, 2, 1, -6]} * (J0 ^ 1*J1^ 1)) 
      ![![28, 0, 0, 0, 0], ![-4, 4, 0, 0, 0]] ![![-20, 0, 8, 4, -24], ![-8, 8, 8, 4, -20]] where 
    T := Table
    heq := timesTableT_eq_Table
    hieq1 := by convert ideal_mul_span_singleton_coe (R := ℤ)  _ _ _ rfl 4 ; decide ; exact {out := by decide}
    hieq2 := by 
...
noncomputable def R11RS0 : IdealMulPrincipalCertificate timesTableO (J0 ^ 1*J1^ 0) ![-5, 2, 2, 1, -4] ![![2, 0, 0, 0, 0], ![0, 1, 0, 0, 0]]
  ![![-10, 4, 4, 2, -8], ![0, -2, 0, 0, 4]] where
    T := Table
    heq := timesTableT_eq_Table
    hI := by exact PowJ0_1J1_0
    hmul := by decide

noncomputable def E11RS0 : IdealEqCertificateO timesTableO (Ideal.span {2} * I11N0) (Ideal.span {B.equivFun.symm ![-5, 2, 2, 1, -4]} * (J0 ^ 1*J1^ 0)) 
      ![![22, 0, 0, 0, 0], ![6, 2, -2, 0, 2]] ![![-10, 4, 4, 2, -8], ![0, -2, 0, 0, 4]] where 
    T := Table
    heq := timesTableT_eq_Table
    hieq1 := by convert ideal_mul_span_singleton_coe (R := ℤ)  _ _ _ rfl 2 ; decide ; exact {out := by decide}
    hieq2 := by 
...
noncomputable def R11RS1 : IdealMulPrincipalCertificate timesTableO (J0 ^ 1*J1^ 1) ![21, -4, -8, -5, 24] ![![4, 0, 0, 0, 0], ![2, 1, -1, 0, 2]]
  ![![84, -16, -32, -20, 96], ![48, -12, -12, -8, 36]] where
    T := Table
    heq := timesTableT_eq_Table
    hI := by exact PowJ0_1J1_1
    hmul := by decide

noncomputable def E11RS1 : IdealEqCertificateO timesTableO (Ideal.span {4} * I11N1) (Ideal.span {B.equivFun.symm ![21, -4, -8, -5, 24]} * (J0 ^ 1*J1^ 1)) 
      ![![44, 0, 0, 0, 0], ![-12, -20, -4, 0, 4]] ![![84, -16, -32, -20, 96], ![48, -12, -12, -8, 36]] where 
    T := Table
    heq := timesTableT_eq_Table
    hieq1 := by convert ideal_mul_span_singleton_coe (R := ℤ)  _ _ _ rfl 4 ; decide ; exact {out := by decide}
    hieq2 := by 
...
noncomputable def R11RS2 : IdealMulPrincipalCertificate timesTableO (J0 ^ 0*J1^ 1) ![-6, 1, 2, 1, -5] ![![2, 0, 0, 0, 0], ![-2, 0, 1, 1, -4]]
  ![![-12, 2, 4, 2, -10], ![16, -2, -6, -4, 18]] where
    T := Table
    heq := timesTableT_eq_Table
    hI := by exact PowJ0_0J1_1
    hmul := by decide

noncomputable def E11RS2 : IdealEqCertificateO timesTableO (Ideal.span {2} * I11N2) (Ideal.span {B.equivFun.symm ![-6, 1, 2, 1, -5]} * (J0 ^ 0*J1^ 1)) 
      ![![22, 0, 0, 0, 0], ![-10, 2, 0, 0, 0]] ![![-12, 2, 4, 2, -10], ![16, -2, -6, -4, 18]] where 
    T := Table
    heq := timesTableT_eq_Table
    hieq1 := by convert ideal_mul_span_singleton_coe (R := ℤ)  _ _ _ rfl 2 ; decide ; exact {out := by decide}
    hieq2 := by 
      rw [← ideal_eq_principal_mul_of_IdealMulPrincipalCertificate _ _ _ _ _ R11RS2]  
      rfl
...
lemma R11N2 : Ideal.span {2} * I11N2 =  Ideal.span {B.equivFun.symm ![-6, 1, 2, 1, -5]} * (J0 ^ 0*J1^ 1) := by 
  refine ideal_eq_of_IdealEqCertificateO _ _ _ _ _ E11RS2
                    

noncomputable def R17RS1 : IdealMulPrincipalCertificate timesTableO (J0 ^ 0*J1^ 1) ![2, 0, -1, 0, 1] ![![2, 0, 0, 0, 0], ![-2, 0, 1, 1, -4]]
  ![![4, 0, -2, 0, 2], ![-4, 4, 0, 2, -6]] where
    T := Table
    heq := timesTableT_eq_Table
    hI := by exact PowJ0_0J1_1
    hmul := by decide

noncomputable def E17RS1 : IdealEqCertificateO timesTableO (Ideal.span {2} * I17N1) (Ideal.span {B.equivFun.symm ![2, 0, -1, 0, 1]} * (J0 ^ 0*J1^ 1)) 
      ![![34, 0, 0, 0, 0], ![-16, 2, 0, 0, 0]] ![![4, 0, -2, 0, 2], ![-4, 4, 0, 2, -6]] where 
    T := Table
    heq := timesTableT_eq_Table
    hieq1 := by convert ideal_mul_span_singleton_coe (R := ℤ)  _ _ _ rfl 2 ; decide ; exact {out := by decide}
    hieq2 := by 
