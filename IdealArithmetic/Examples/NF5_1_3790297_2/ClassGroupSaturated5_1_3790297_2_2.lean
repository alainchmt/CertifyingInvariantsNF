...
def A3: IdealEqSpanCertificate timesTableO I3
...
lemma N3 : Nat.card (O ⧸ I3) = 37 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate A3)

def A4: IdealEqSpanCertificate timesTableO I4
 ![![37, 0, 0, 0, 0], ![-2, 1, 0, 0, 0]] 
...
lemma N4 : Nat.card (O ⧸ I4) = 37 := 
 ideal_norm_eq_prod' B _ _ (by decide) 0 0 (by decide) (ideal_eq_of_IdealEqSpanCertificate A4)
...
def Log30Mem : IdealMemCertificate B I3
 ...
 hieq := ideal_eq_of_IdealEqSpanCertificate A3
 g := ![0, 0, 2, 1, -5]
 hmem := by decide
...
def Log40Mem : IdealMemCertificate B I4
 ...
 hieq := ideal_eq_of_IdealEqSpanCertificate A4
 g := ![1, 0, 2, 1, -5]
 hmem := by decide
