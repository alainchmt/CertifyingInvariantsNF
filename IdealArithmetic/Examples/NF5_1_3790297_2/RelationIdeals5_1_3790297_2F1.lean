...
noncomputable def R37RS1 : IdealMulPrincipalCertificate timesTableO (J0 ^ 1*J1^ 0) ![-15, 2, 6, 3, -16] ![![2, 0, 0, 0, 0], ![0, 1, 0, 0, 0]]
  ![![-30, 4, 12, 6, -32], ![4, 2, 0, 0, 0]] where
    T := Table
    heq := timesTableT_eq_Table
    hI := by exact PowJ0_1J1_0
    hmul := by decide

noncomputable def E37RS1 : IdealEqCertificateO timesTableO (Ideal.span {2} * I37N1) (Ideal.span {B.equivFun.symm ![-15, 2, 6, 3, -16]} * (J0 ^ 1*J1^ 0)) 
      ![![74, 0, 0, 0, 0], ![4, 2, 0, 0, 0]] ![![-30, 4, 12, 6, -32], ![4, 2, 0, 0, 0]] where 
    T := Table
    heq := timesTableT_eq_Table
    hieq1 := by convert ideal_mul_span_singleton_coe (R := ℤ)  _ _ _ rfl 2 ; decide ; exact {out := by decide}
    hieq2 := by 
      rw [← ideal_eq_principal_mul_of_IdealMulPrincipalCertificate _ _ _ _ _ R37RS1]  
      rfl
...
lemma R37N1 : Ideal.span {2} * I37N1 =  Ideal.span {B.equivFun.symm ![-15, 2, 6, 3, -16]} * (J0 ^ 1*J1^ 0) := by 
  refine ideal_eq_of_IdealEqCertificateO _ _ _ _ _ E37RS1
                    

noncomputable def R37RS3 : IdealMulPrincipalCertificate timesTableO (J0 ^ 1*J1^ 0) ![3, -2, -2, -1, 6] ![![2, 0, 0, 0, 0], ![0, 1, 0, 0, 0]]
  ![![6, -4, -4, -2, 12], ![-2, -4, -2, 0, 2]] where
    T := Table
    heq := timesTableT_eq_Table
    hI := by exact PowJ0_1J1_0
    hmul := by decide

noncomputable def E37RS3 : IdealEqCertificateO timesTableO (Ideal.span {2} * I37N3) (Ideal.span {B.equivFun.symm ![3, -2, -2, -1, 6]} * (J0 ^ 1*J1^ 0)) 
      ![![74, 0, 0, 0, 0], ![-4, 2, 0, 0, 0]] ![![6, -4, -4, -2, 12], ![-2, -4, -2, 0, 2]] where 
    T := Table
    heq := timesTableT_eq_Table
    hieq1 := by convert ideal_mul_span_singleton_coe (R := ℤ)  _ _ _ rfl 2 ; decide ; exact {out := by decide}
    hieq2 := by 
      rw [← ideal_eq_principal_mul_of_IdealMulPrincipalCertificate _ _ _ _ _ R37RS3]  
      rfl
...
lemma R37N3 : Ideal.span {2} * I37N3 =  Ideal.span {B.equivFun.symm ![3, -2, -2, -1, 6]} * (J0 ^ 1*J1^ 0) := by 
  refine ideal_eq_of_IdealEqCertificateO _ _ _ _ _ E37RS3
                    

noncomputable def R41RS1 : IdealMulPrincipalCertificate timesTableO (J0 ^ 1*J1^ 0) ![5, -2, -2, -1, 6] ![![2, 0, 0, 0, 0], ![0, 1, 0, 0, 0]]
  ![![10, -4, -4, -2, 12], ![-2, -2, -2, 0, 2]] where
    T := Table
    heq := timesTableT_eq_Table
    hI := by exact PowJ0_1J1_0
    hmul := by decide

noncomputable def E41RS1 : IdealEqCertificateO timesTableO (Ideal.span {2} * I41N1) (Ideal.span {B.equivFun.symm ![5, -2, -2, -1, 6]} * (J0 ^ 1*J1^ 0)) 
      ![![82, 0, 0, 0, 0], ![8, 2, 0, 0, 0]] ![![10, -4, -4, -2, 12], ![-2, -2, -2, 0, 2]] where 
    T := Table
    heq := timesTableT_eq_Table
    hieq1 := by convert ideal_mul_span_singleton_coe (R := ℤ)  _ _ _ rfl 2 ; decide ; exact {out := by decide}
    hieq2 := by 
...
noncomputable def R43RS1 : IdealMulPrincipalCertificate timesTableO (J0 ^ 1*J1^ 1) ![9, 0, -2, -1, 6] ![![4, 0, 0, 0, 0], ![2, 1, -1, 0, 2]]
  ![![36, 0, -8, -4, 24], ![16, -4, -12, -4, 28]] where
    T := Table
    heq := timesTableT_eq_Table
    hI := by exact PowJ0_1J1_1
    hmul := by decide

noncomputable def E43RS1 : IdealEqCertificateO timesTableO (Ideal.span {4} * I43N1) (Ideal.span {B.equivFun.symm ![9, 0, -2, -1, 6]} * (J0 ^ 1*J1^ 1)) 
      ![![172, 0, 0, 0, 0], ![56, 4, 0, 0, 0]] ![![36, 0, -8, -4, 24], ![16, -4, -12, -4, 28]] where 
    T := Table
    heq := timesTableT_eq_Table
...
noncomputable def R53RS1 : IdealMulPrincipalCertificate timesTableO (J0 ^ 0*J1^ 1) ![-2, -1, 2, 1, -5] ![![2, 0, 0, 0, 0], ![-2, 0, 1, 1, -4]]
  ![![-4, -2, 4, 2, -10], ![8, -4, 2, 2, -6]] where
    T := Table
    heq := timesTableT_eq_Table
    hI := by exact PowJ0_0J1_1
    hmul := by decide

noncomputable def E53RS1 : IdealEqCertificateO timesTableO (Ideal.span {2} * I53N1) (Ideal.span {B.equivFun.symm ![-2, -1, 2, 1, -5]} * (J0 ^ 0*J1^ 1)) 
      ![![106, 0, 0, 0, 0], ![-38, 2, 0, 0, 0]] ![![-4, -2, 4, 2, -10], ![8, -4, 2, 2, -6]] where 
    T := Table
    heq := timesTableT_eq_Table
    hieq1 := by convert ideal_mul_span_singleton_coe (R := ℤ)  _ _ _ rfl 2 ; decide ; exact {out := by decide}
    hieq2 := by 
...
noncomputable def R59RS1 : IdealMulPrincipalCertificate timesTableO (J0 ^ 1*J1^ 1) ![1, -2, 0, 1, -2] ![![4, 0, 0, 0, 0], ![2, 1, -1, 0, 2]]
  ![![4, -8, 0, 4, -8], ![4, 8, -8, 0, 0]] where
    T := Table
    heq := timesTableT_eq_Table
    hI := by exact PowJ0_1J1_1
    hmul := by decide

noncomputable def E59RS1 : IdealEqCertificateO timesTableO (Ideal.span {4} * I59N1) (Ideal.span {B.equivFun.symm ![1, -2, 0, 1, -2]} * (J0 ^ 1*J1^ 1)) 
      ![![236, 0, 0, 0, 0], ![20, 4, 0, 0, 0]] ![![4, -8, 0, 4, -8], ![4, 8, -8, 0, 0]] where 
    T := Table
    heq := timesTableT_eq_Table
    hieq1 := by convert ideal_mul_span_singleton_coe (R := ℤ)  _ _ _ rfl 4 ; decide ; exact {out := by decide}
    hieq2 := by 
      rw [← ideal_eq_principal_mul_of_IdealMulPrincipalCertificate _ _ _ _ _ R59RS1]  
      rfl
...
lemma R59N1 : Ideal.span {4} * I59N1 =  Ideal.span {B.equivFun.symm ![1, -2, 0, 1, -2]} * (J0 ^ 1*J1^ 1) := by 
  refine ideal_eq_of_IdealEqCertificateO _ _ _ _ _ E59RS1
                    

noncomputable def R61RS1 : IdealMulPrincipalCertificate timesTableO (J0 ^ 1*J1^ 0) ![9, -2, -2, -1, 6] ![![2, 0, 0, 0, 0], ![0, 1, 0, 0, 0]]
  ![![18, -4, -4, -2, 12], ![-2, 2, -2, 0, 2]] where
    T := Table
    heq := timesTableT_eq_Table
    hI := by exact PowJ0_1J1_0
    hmul := by decide

noncomputable def E61RS1 : IdealEqCertificateO timesTableO (Ideal.span {2} * I61N1) (Ideal.span {B.equivFun.symm ![9, -2, -2, -1, 6]} * (J0 ^ 1*J1^ 0)) 
      ![![122, 0, 0, 0, 0], ![-16, 2, 0, 0, 0]] ![![18, -4, -4, -2, 12], ![-2, 2, -2, 0, 2]] where 
    T := Table
    heq := timesTableT_eq_Table
    hieq1 := by convert ideal_mul_span_singleton_coe (R := ℤ)  _ _ _ rfl 2 ; decide ; exact {out := by decide}
    hieq2 := by 
...
noncomputable def R61RS2 : IdealMulPrincipalCertificate timesTableO (J0 ^ 1*J1^ 0) ![-3, 0, 2, 1, -4] ![![2, 0, 0, 0, 0], ![0, 1, 0, 0, 0]]
  ![![-6, 0, 4, 2, -8], ![0, 0, -2, 0, 4]] where
    T := Table
    heq := timesTableT_eq_Table
    hI := by exact PowJ0_1J1_0
    hmul := by decide

noncomputable def E61RS2 : IdealEqCertificateO timesTableO (Ideal.span {2} * I61N2) (Ideal.span {B.equivFun.symm ![-3, 0, 2, 1, -4]} * (J0 ^ 1*J1^ 0)) 
      ![![122, 0, 0, 0, 0], ![-10, 2, 0, 0, 0]] ![![-6, 0, 4, 2, -8], ![0, 0, -2, 0, 4]] where 
    T := Table
    heq := timesTableT_eq_Table
    hieq1 := by convert ideal_mul_span_singleton_coe (R := ℤ)  _ _ _ rfl 2 ; decide ; exact {out := by decide}
    hieq2 := by 
      rw [← ideal_eq_principal_mul_of_IdealMulPrincipalCertificate _ _ _ _ _ R61RS2]  
      rfl
...
lemma R61N2 : Ideal.span {2} * I61N2 =  Ideal.span {B.equivFun.symm ![-3, 0, 2, 1, -4]} * (J0 ^ 1*J1^ 0) := by 
  refine ideal_eq_of_IdealEqCertificateO _ _ _ _ _ E61RS2
