...
import IdealArithmetic.Examples.NF3_1_236708_1.Irreducible3_1_236708_1
...
noncomputable def T : ℤ[X] := X^3 - X^2 + 20*X - 94
lemma T_def : T = X^3 - X^2 + 20*X - 94 := rfl
