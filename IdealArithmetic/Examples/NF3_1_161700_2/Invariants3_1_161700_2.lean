import IdealArithmetic.Examples.NF3_1_161700_2.ClassGroupSaturated3_1_161700_2_3
import IdealArithmetic.Examples.NF3_1_161700_2.RelationIdeals3_1_161700_2F0
import IdealArithmetic.Examples.NF3_1_161700_2.RelationIdeals3_1_161700_2F1
import IdealArithmetic.Examples.NF3_1_161700_2.RelationIdeals3_1_161700_2F2
import IdealArithmetic.Examples.NF3_1_161700_2.PrimesBelowCert3_1_161700_2
...
/- Number field `K(α)` with α root of polynomial `X^3 - X^2 + 12*X - 468`.
Class group structure `[3]`, generated by class of ideals `[(2, 1/6*a^2 - 1/6*a + 1)]`. -/
...
def SturmRC : SturmBuilderOfList [[-468, 12, -1, 1], [12, -2, 3], [4200, -70], [-5821200]] [-468, 12, -1, 1] [12, -2, 3] where
  hlen := by decide
  h0 := by decide
  h1 := by decide
  hlast := by decide
...
def RC : RankUnitsCertificate O where
  ...
  P := [[-468, 12, -1, 1], [12, -2, 3], [4200, -70], [-5821200]]
  SB := SturmRC
  k := 1
  r := 2
  hr := by decide
...
theorem K_minowski : minkowskiBoundFB K ≤ (113.78651178103314 : ℝ) := by
  refine K_minkowski_decimal _ ?_
  erw [K_nrComplexPlaces, K_discr, K_finrank]
  have hraux: √161700 ≤ 402.119395 := by
      refine Real.sqrt_le_iff.mpr ?_
      norm_num
  have : 0.2222222222222222 * √161700 ≤ 89.369866 := by
...
def BM : (i : Fin 3) → Fin (e i) → (Fin 1 → ℕ) := by 
  rintro ⟨i, hi⟩ 
  interval_cases i 
  exact ![![1], ![1], ![2], ![2], ![1], ![2], ![2], ![2], ![0], ![1], ![1], ![1], ![1], ![1], ![1], ![2]]
  exact ![![2], ![2], ![2], ![2], ![1], ![2], ![2]]
  exact ![![0], ![1], ![0], ![0], ![0], ![1], ![1], ![2], ![0]]
...
lemma relations_proof0 (i : Fin 16) : IsInClass O J (𝔭 0 i) (BM 0 i) := by
  show IsInClass O J (𝔭 0 i) (![![1], ![1], ![2], ![2], ![1], ![2], ![2], ![2], ![0], ![1], ![1], ![1], ![1], ![1], ![1], ![2]] i)
  unfold IsInClass
...
lemma relations_proof1 (i : Fin 7) : IsInClass O J (𝔭 1 i) (BM 1 i) := by
  show IsInClass O J (𝔭 1 i) (![![2], ![2], ![2], ![2], ![1], ![2], ![2]] i)
  unfold IsInClass
  simp only [Fin.isValue, Fin.prod_univ_castSucc, Finset.univ_eq_empty, Finset.prod_empty, Fin.succ_zero_eq_one, one_mul]
  fin_cases i
...
lemma relations_proof2 (i : Fin 9) : IsInClass O J (𝔭 2 i) (BM 2 i) := by
  show IsInClass O J (𝔭 2 i) (![![0], ![1], ![0], ![0], ![0], ![1], ![1], ![2], ![0]] i)
  unfold IsInClass
  simp only [Fin.isValue, Fin.prod_univ_castSucc, Finset.univ_eq_empty, Finset.prod_empty, Fin.succ_zero_eq_one, one_mul]
  fin_cases i
  · refine ideal_mem_principal_class''' (by decide) J rfl (by unfold_prod)
