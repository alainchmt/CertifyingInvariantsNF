import IdealArithmetic.Examples.NF5_3_10125000000_3.Invariants5_3_10125000000_3

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 - 25*X^3 - 150*X^2 + 480`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 - 25*X^3 - 150*X^2 + 480)) := rfl

lemma T_irreducible' : Irreducible (X^5 - 25*X^3 - 150*X^2 + 480 : ℤ[X]) := irreducible_T
