...
import IdealArithmetic.Examples.NF3_3_376300_1.Irreducible3_3_376300_1
...
noncomputable def T : ℤ[X] := X^3 - X^2 - 168*X - 98
lemma T_def : T = X^3 - X^2 - 168*X - 98 := rfl
...
-- We build the subalgebra with integral basis [1, a, 1/7*a^2 - 1/7*a] 
