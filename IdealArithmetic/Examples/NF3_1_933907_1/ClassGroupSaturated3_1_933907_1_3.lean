...
def A0: IdealEqSpanCertificate' Table ![![7, 0, 0], ![6, 1, 0]] 
 ![![7, 0, 0], ![6, 1, 0], ![0, 0, 1]] where
  M :=![![![7, 0, 0], ![0, 7, 0], ![0, 0, 7]], ![![6, 1, 0], ![0, 7, 2], ![-754, 117, 6]]]
  hmulB := by decide  
  f := ![![![-5, -1, 0], ![7, 0, 0]], ![![0, 0, 0], ![1, 0, 0]], ![![0, -4, -1], ![0, 4, 0]]]
  g := ![![![1, 0, 0], ![-6, 7, 0], ![0, 0, 7]], ![![0, 1, 0], ![-6, 7, 2], ![-208, 117, 6]]]
  hle1 := by decide   
  hle2 := by decide  
...
def Log00Mem : IdealMemCertificate B I0
 ![![7, 0, 0], ![6, 1, 0], ![0, 0, 1]] ![5263355987, -314273128, -66970992] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![1021284965, -314273128, -66970992]
 hmem := by decide
...
def Log00: DiscreteLogCertificate N0 ((orderOf_of_IsOrderOf R7) ▸ IsPrimitiveRoot.orderOf _) 3 zeta1 1 where
 ...
 hxeq :=  rfl
 m := 4
 C := ![5263355987, -314273128, -66970992]
 hCeq := by rfl
...
def Log01Mem : IdealMemCertificate B I0
 ![![7, 0, 0], ![6, 1, 0], ![0, 0, 1]] ![4373, -880, 101] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![1379, -880, 101]
 hmem := by decide
