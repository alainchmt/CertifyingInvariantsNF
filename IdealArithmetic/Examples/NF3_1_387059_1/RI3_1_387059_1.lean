...
import IdealArithmetic.Examples.NF3_1_387059_1.Irreducible3_1_387059_1
...
noncomputable def T : ℤ[X] := X^3 - X^2 + 116*X - 28
lemma T_def : T = X^3 - X^2 + 116*X - 28 := rfl
