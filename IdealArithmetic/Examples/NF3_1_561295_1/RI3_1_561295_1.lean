...
import IdealArithmetic.Examples.NF3_1_561295_1.Irreducible3_1_561295_1
...
noncomputable def T : ℤ[X] := X^3 - X^2 + 194*X + 715
lemma T_def : T = X^3 - X^2 + 194*X + 715 := rfl
...
-- We build the subalgebra with integral basis [1, a, 1/9*a^2 + 1/3*a - 1/9] 
