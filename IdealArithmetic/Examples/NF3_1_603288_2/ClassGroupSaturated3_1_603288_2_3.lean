...
def I2 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![61, 0, 0], ![-12, 1, 0]] i)))
...
def A2: IdealEqSpanCertificate' Table ![![61, 0, 0], ![-12, 1, 0]] 
...
def Log00Mem : IdealMemCertificate B I0
 ![![7, 0, 0], ![0, 1, 0], ![0, 0, 1]] ![-14, 2, 0] where
...
def Log01Mem : IdealMemCertificate B I0
 ![![7, 0, 0], ![0, 1, 0], ![0, 0, 1]] ![-35, 2, -1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![-5, 2, -1]
 hmem := by decide
...
def Log10Mem : IdealMemCertificate B I1
 ![![19, 0, 0], ![1, 1, 0], ![9, 0, 1]] ![-17, 2, 0] where
...
def Log11Mem : IdealMemCertificate B I1
 ![![19, 0, 0], ![1, 1, 0], ![9, 0, 1]] ![-45, 2, -1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![-2, 2, -1]
 hmem := by decide
...
def Log12Mem : IdealMemCertificate B I1
 ![![19, 0, 0], ![1, 1, 0], ![9, 0, 1]] ![-12, -2, 1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![-1, -2, 1]
 hmem := by decide
...
def Log20Mem : IdealMemCertificate B I2
 ![![61, 0, 0], ![49, 1, 0], ![50, 0, 1]] ![-24, 2, 0] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![-2, 2, 0]
 hmem := by decide

def Log20: DiscreteLogCertificate N2 ((orderOf_of_IsOrderOf R61) ▸ IsPrimitiveRoot.orderOf _) 3 zeta1 1 where
 r := 3
 hN := by infer_instance
 hpdvd := by decide
 B := B
...
def Log21Mem : IdealMemCertificate B I2
 ![![61, 0, 0], ![49, 1, 0], ![50, 0, 1]] ![-74, 2, -1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![-2, 2, -1]
 hmem := by decide

def Log21: DiscreteLogCertificate N2 ((orderOf_of_IsOrderOf R61) ▸ IsPrimitiveRoot.orderOf _) 3 alpha0 1 where
 r := 3
 hN := by infer_instance
 hpdvd := by decide
 B := B
...
def Log22Mem : IdealMemCertificate B I2
 ![![61, 0, 0], ![49, 1, 0], ![50, 0, 1]] ![-48, -2, 1] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![0, -2, 1]
 hmem := by decide

def Log22: DiscreteLogCertificate N2 ((orderOf_of_IsOrderOf R61) ▸ IsPrimitiveRoot.orderOf _) 3 alpha1 0 where
 r := 3
 hN := by infer_instance
 hpdvd := by decide
 B := B
