import IdealArithmetic.Examples.NF5_3_10125000000_1.Invariants5_3_10125000000_1

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 - 100*X^2 - 1725*X - 4320`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 - 100*X^2 - 1725*X - 4320)) := rfl

lemma T_irreducible' : Irreducible (X^5 - 100*X^2 - 1725*X - 4320 : ℤ[X]) := irreducible_T
