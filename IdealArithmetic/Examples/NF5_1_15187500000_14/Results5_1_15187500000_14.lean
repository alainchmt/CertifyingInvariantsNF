import IdealArithmetic.Examples.NF5_1_15187500000_14.Invariants5_1_15187500000_14

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^5 - 75*X^3 - 100*X^2 + 1500*X + 3840`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^5 - 75*X^3 - 100*X^2 + 1500*X + 3840)) := rfl

lemma T_irreducible' : Irreducible (X^5 - 75*X^3 - 100*X^2 + 1500*X + 3840 : ℤ[X]) := irreducible_T
