import IdealArithmetic.Examples.NF3_1_58604_2.ClassGroupSaturated3_1_58604_2_3
import IdealArithmetic.Examples.NF3_1_58604_2.RelationIdeals3_1_58604_2F0
import IdealArithmetic.Examples.NF3_1_58604_2.RelationIdeals3_1_58604_2F1
import IdealArithmetic.Examples.NF3_1_58604_2.PrimesBelowCert3_1_58604_2
...
/- Number field `K(α)` with α root of polynomial `X^3 + 14*X - 42`.
Class group structure `[3, 3]`, generated by class of ideals `[(3, a), (3, a + 1)]`. -/
...
def SturmRC : SturmBuilderOfList [[-42, 14, 0, 1], [14, 0, 3], [378, -84], [-58604]] [-42, 14, 0, 1] [14, 0, 3] where
  hlen := by decide
  h0 := by decide
  h1 := by decide
  hlast := by decide
...
def RC : RankUnitsCertificate O where
  ...
  P := [[-42, 14, 0, 1], [14, 0, 3], [378, -84], [-58604]]
  SB := SturmRC
  k := 1
  r := 2
  hr := by decide
...
def NPSU3 : pSaturatedClassGroupCertificateNDvdT 3 ![J0, J1] ![3, 3] where 
 ...
 hDl := by decide 
 NInv := ![![1, 2, 1], ![2, 1, 1], ![0, 2, 0]]
 hN := by decide 

lemma T_discr : T.discr = -58604 :=  by
  convert discriminant_eq_DiscriminantOfPRemainder_of_SturmBuilderOfList SturmRC
  rw [T_ofList]

theorem K_discr : NumberField.discr K = -58604 := by
...
theorem K_minowski : minkowskiBoundFB K ≤ (68.50537294954121 : ℝ) := by
  refine K_minkowski_decimal _ ?_
  erw [K_nrComplexPlaces, K_discr, K_finrank]
  have hraux: √58604 ≤ 242.082641 := by
      refine Real.sqrt_le_iff.mpr ?_
      norm_num
  have : 0.2222222222222222 * √58604 ≤ 53.806142 := by
...
def BM : (i : Fin 2) → Fin (e i) → (Fin 2 → ℕ) := by 
  rintro ⟨i, hi⟩ 
  interval_cases i 
  exact ![![0, 2], ![1, 0], ![0, 1], ![2, 2], ![2, 1], ![1, 2], ![1, 2], ![0, 1], ![0, 2], ![1, 1], ![2, 0], ![1, 1], ![1, 1], ![0, 1]]
  exact ![![2, 0], ![2, 0], ![2, 0], ![0, 0], ![2, 1], ![2, 0], ![2, 2], ![1, 0], ![2, 0]]

lemma primesGenerationBelow : {I : Ideal O | 0 < I.absNorm ∧ I.IsPrime ∧ I.absNorm < 69} ⊆ Set.range (Fin.addCasesIter e 𝔭) := by
  rw [← cert_eq_𝔭]
  refine le_primes_below_bound_of_PrimesBelowBoundCertificate_le_of_eq (Subalgebra.equivOfEq _ _ O_integral_closure).toRingEquiv PB69

def 𝔭' : Fin 23 → nonZeroDivisors (Ideal O) := by
  intro i
  have : PB69.β i ∈ List.ofFn PB69.β := by
    simp only [List.mem_ofFn, exists_apply_eq_apply]
  refine Ideal.toNonZeroDivisorOfNeZero ((PB69.β) i)
    (fun hc => ((zero_ne_mem_of_PrimesBelowCertificate_Fn _ PB69) (hc ▸ this) ))
...
lemma relations_proof0 (i : Fin 14) : IsInClass O J (𝔭 0 i) (BM 0 i) := by
  show IsInClass O J (𝔭 0 i) (![![0, 2], ![1, 0], ![0, 1], ![2, 2], ![2, 1], ![1, 2], ![1, 2], ![0, 1], ![0, 2], ![1, 1], ![2, 0], ![1, 1], ![1, 1], ![0, 1]] i)
  unfold IsInClass
...
lemma relations_proof1 (i : Fin 9) : IsInClass O J (𝔭 1 i) (BM 1 i) := by
  show IsInClass O J (𝔭 1 i) (![![2, 0], ![2, 0], ![2, 0], ![0, 0], ![2, 1], ![2, 0], ![2, 2], ![1, 0], ![2, 0]] i)
  unfold IsInClass
  simp only [Fin.isValue, Fin.prod_univ_castSucc, Finset.univ_eq_empty, Finset.prod_empty, Fin.succ_zero_eq_one, one_mul]
  fin_cases i
