...
import IdealArithmetic.Examples.NF3_1_117288_3.Irreducible3_1_117288_3
...
noncomputable def T : ℤ[X] := X^3 + 15*X - 62
lemma T_def : T = X^3 + 15*X - 62 := rfl
