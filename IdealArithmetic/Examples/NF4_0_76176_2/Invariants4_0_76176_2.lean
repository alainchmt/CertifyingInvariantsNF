...
Class group structure `[6, 2]`, generated by class of ideals `((2, -a), (6, 2/35*a^3 + 32/35*a^2 - 1/7*a + 178/35)`. -/
...
lemma primesGenerationBelow : {I : Ideal O | 0 < I.absNorm ∧ I.IsPrime ∧ I.absNorm < 42} ⊆ Set.range (Fin.addCasesIter e g) := 
  le_primes_below_bound_of_PrimesBelowBoundCertificate' (Subalgebra.equivOfEq _ _ O_integral_closure).toRingEquiv ((Fin.addCasesIter e g)) PB42 (fun _ hx => primesGenerationAux.1 hx)
