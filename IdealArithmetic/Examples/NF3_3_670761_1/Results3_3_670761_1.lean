import IdealArithmetic.Examples.NF3_3_670761_1.Invariants3_3_670761_1

noncomputable section

open Polynomial NumberField

/- Number field `K(α)` with `α` root of the polynomial `X^3 - 273*X - 91`. -/

lemma T_def' : K = AdjoinRoot (map (algebraMap ℤ ℚ) (X^3 - 273*X - 91)) := rfl

lemma T_irreducible' : Irreducible (X^3 - 273*X - 91 : ℤ[X]) := irreducible_T
