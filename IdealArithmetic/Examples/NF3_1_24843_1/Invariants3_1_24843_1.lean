...
theorem K_minowski : minkowskiBoundFB K ≤ (44.60638176300717 : ℝ) := by
  ...
  have hraux: √24843 ≤ 157.616633 := by
      ...
      norm_num
  have : 0.2222222222222222 * √24843 ≤ 35.035918 := by
...
lemma primesGenerationBelow : {I : Ideal O | 0 < I.absNorm ∧ I.IsPrime ∧ I.absNorm < 45} ⊆ Set.range (Fin.addCasesIter e 𝔭) := by
  rw [← cert_eq_𝔭]
  refine le_primes_below_bound_of_PrimesBelowBoundCertificate_le_of_eq (Subalgebra.equivOfEq _ _ O_integral_closure).toRingEquiv PB45

def 𝔭' : Fin 16 → nonZeroDivisors (Ideal O) := by
  intro i
  have : PB45.β i ∈ List.ofFn PB45.β := by
    simp only [List.mem_ofFn, exists_apply_eq_apply]
  refine Ideal.toNonZeroDivisorOfNeZero ((PB45.β) i)
    (fun hc => ((zero_ne_mem_of_PrimesBelowCertificate_Fn _ PB45) (hc ▸ this) ))
...
lemma relations_proof0 (i : Fin 15) : IsInClass O J (𝔭 0 i) (BM 0 i) := by
  show IsInClass O J (𝔭 0 i) (![![2, 0], ![1, 0], ![0, 1], ![0, 1], ![1, 2], ![2, 1], ![1, 1], ![0, 1], ![2, 2], ![2, 0], ![1, 0], ![2, 2], ![1, 2], ![1, 2], ![1, 2]] i)
  unfold IsInClass
...
lemma relations_proof1 (i : Fin 1) : IsInClass O J (𝔭 1 i) (BM 1 i) := by
  show IsInClass O J (𝔭 1 i) (![![2, 2]] i)
  unfold IsInClass
  simp only [Fin.isValue, Fin.prod_univ_castSucc, Finset.univ_eq_empty, Finset.prod_empty, Fin.succ_zero_eq_one, one_mul]
  fin_cases i
