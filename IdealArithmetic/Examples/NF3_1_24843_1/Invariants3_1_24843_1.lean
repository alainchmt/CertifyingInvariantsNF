...
import IdealArithmetic.Examples.NF3_1_24843_1.RelationIdeals3_1_24843_1
...
def g : (i : Fin 1) → Fin (e i) → Ideal O := by
  rintro ⟨i, hi⟩
  interval_cases i
  exact ![I2N0, I2N1, I3N0, I3N1, I5N0, I5N1, I7N0, I11N1, I13N0, I17N1, I23N1, I29N1, I31N0, I31N1, I31N2, I41N1]

def BM : (i : Fin 1) → Fin (e i) → (Fin 2 → ℕ) := by
  rintro ⟨i, hi⟩
  interval_cases i
  exact ![![2, 0], ![1, 0], ![0, 1], ![0, 1], ![1, 2], ![2, 1], ![1, 1], ![0, 1], ![2, 2], ![2, 0], ![1, 0], ![2, 2], ![1, 2], ![1, 2], ![1, 2], ![2, 2]]
...
lemma primesGenerationAux0  {y} :
  ...
  show y ∈ [I2N0, I2N1, I3N0, I3N0, I3N1, I5N0, I5N1, I7N0, I7N0, I7N0, I11N1, I13N0, I13N0, I13N0, I17N1, I23N1, I29N1, I31N0, I31N1, I31N2, I41N1] ↔ y ∈ [I2N0, I2N1, I3N0, I3N1, I5N0, I5N1, I7N0, I11N1, I13N0, I17N1, I23N1, I29N1, I31N0, I31N1, I31N2, I41N1]
...
lemma primesGenerationBelow : {I : Ideal O | 0 < I.absNorm ∧ I.IsPrime ∧ I.absNorm < 45} ⊆ Set.range (Fin.addCasesIter e g) :=
  le_primes_below_bound_of_PrimesBelowBoundCertificate' (Subalgebra.equivOfEq _ _ O_integral_closure).toRingEquiv ((Fin.addCasesIter e g)) PB45 (fun _ hx => primesGenerationAux.1 hx)
...
lemma relations_proof0 (i : Fin 16) : IsInClass O x (g 0 i) (BM 0 i) := by
  show IsInClass O x (g 0 i) (![![2, 0], ![1, 0], ![0, 1], ![0, 1], ![1, 2], ![2, 1], ![1, 1], ![0, 1], ![2, 2], ![2, 0], ![1, 0], ![2, 2], ![1, 2], ![1, 2], ![1, 2], ![2, 2]] i)
  unfold IsInClass
  ...
  · refine Exists.intro _ (Exists.intro ?_ (Exists.intro (?_) (Exists.intro ?_ (by convert R23N1))))
    refine Nat.cast_ne_zero.2 (by decide)
    exact (LinearEquiv.map_ne_zero_iff B.equivFun.symm).mpr (by decide)
  · refine Exists.intro _ (Exists.intro ?_ (Exists.intro (?_) (Exists.intro ?_ (by convert R29N1))))
    refine Nat.cast_ne_zero.2 (by decide)
    exact (LinearEquiv.map_ne_zero_iff B.equivFun.symm).mpr (by decide)
  · refine Exists.intro _ (Exists.intro ?_ (Exists.intro (?_) (Exists.intro ?_ (by convert R31N0))))
    refine Nat.cast_ne_zero.2 (by decide)
    exact (LinearEquiv.map_ne_zero_iff B.equivFun.symm).mpr (by decide)
