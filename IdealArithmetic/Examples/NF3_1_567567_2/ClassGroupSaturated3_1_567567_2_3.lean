...
def I2 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![31, 0, 0], ![13, 1, 0]] i)))
...
def A2: IdealEqSpanCertificate' Table ![![31, 0, 0], ![13, 1, 0]] 
...
def Log00Mem : IdealMemCertificate B I0
 ![![7, 0, 0], ![0, 1, 0], ![4, 0, 1]] ![2340353776823, -634049478990, -85780584906] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![383353730921, -634049478990, -85780584906]
 hmem := by decide
...
def Log00: DiscreteLogCertificate N0 ((orderOf_of_IsOrderOf R7) ▸ IsPrimitiveRoot.orderOf _) 3 zeta1 2 where
 ...
 B := B
 hone := B_one
 xcoord := ![2340353776825, -634049478990, -85780584906]
 hxeq :=  rfl
 m := 2
 C := ![2340353776823, -634049478990, -85780584906]
 hCeq := by rfl
...
def Log01Mem : IdealMemCertificate B I0
 ![![7, 0, 0], ![0, 1, 0], ![4, 0, 1]] ![-509, -19, -17] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![-63, -19, -17]
 hmem := by decide
...
def Log02Mem : IdealMemCertificate B I0
 ![![7, 0, 0], ![0, 1, 0], ![4, 0, 1]] ![-396, 90, 48] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![-84, 90, 48]
 hmem := by decide
...
def Log10Mem : IdealMemCertificate B I1
 ![![13, 0, 0], ![2, 1, 0], ![12, 0, 1]] ![2340353776819, -634049478990, -85780584906] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![356755365667, -634049478990, -85780584906]
 hmem := by decide
...
def Log10: DiscreteLogCertificate N1 ((orderOf_of_IsOrderOf R13) ▸ IsPrimitiveRoot.orderOf _) 3 zeta1 2 where
 ...
 hxeq :=  rfl
 m := 6
 C := ![2340353776819, -634049478990, -85780584906]
 hCeq := by rfl
...
def Log11Mem : IdealMemCertificate B I1
 ![![13, 0, 0], ![2, 1, 0], ![12, 0, 1]] ![-515, -19, -17] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![-21, -19, -17]
 hmem := by decide
...
def Log12Mem : IdealMemCertificate B I1
 ![![13, 0, 0], ![2, 1, 0], ![12, 0, 1]] ![-401, 90, 48] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![-89, 90, 48]
 hmem := by decide
...
def Log20Mem : IdealMemCertificate B I2
 ![![31, 0, 0], ![13, 1, 0], ![17, 0, 1]] ![2340353776813, -634049478990, -85780584906] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![388427966035, -634049478990, -85780584906]
 hmem := by decide
...
def Log20: DiscreteLogCertificate N2 ((orderOf_of_IsOrderOf R31) ▸ IsPrimitiveRoot.orderOf _) 3 zeta1 1 where
 ...
 hxeq :=  rfl
 m := 12
 C := ![2340353776813, -634049478990, -85780584906]
 hCeq := by rfl
...
def Log21Mem : IdealMemCertificate B I2
 ![![31, 0, 0], ![13, 1, 0], ![17, 0, 1]] ![-536, -19, -17] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![0, -19, -17]
 hmem := by decide
...
def Log22Mem : IdealMemCertificate B I2
 ![![31, 0, 0], ![13, 1, 0], ![17, 0, 1]] ![-401, 90, 48] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![-77, 90, 48]
 hmem := by decide
