...
def I1 : Ideal O := Ideal.span (Set.range (fun i ↦ B.equivFun.symm (![![31, 0, 0], ![-2, 1, 0]] i)))
...
def A1: IdealEqSpanCertificate' Table ![![31, 0, 0], ![-2, 1, 0]] 
...
def Log00Mem : IdealMemCertificate B I0
 ![![13, 0, 0], ![11, 1, 0], ![8, 0, 1]] ![502, -104, 27] where
...
def Log01Mem : IdealMemCertificate B I0
 ![![13, 0, 0], ![11, 1, 0], ![8, 0, 1]] ![-11, -1, 0] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![0, -1, 0]
 hmem := by decide
...
def Log02Mem : IdealMemCertificate B I0
 ![![13, 0, 0], ![11, 1, 0], ![8, 0, 1]] ![34, 8, 3] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A0
 g := ![-6, 8, 3]
 hmem := by decide
...
def Log10Mem : IdealMemCertificate B I1
 ![![31, 0, 0], ![29, 1, 0], ![20, 0, 1]] ![500, -104, 27] where
...
def Log11Mem : IdealMemCertificate B I1
 ![![31, 0, 0], ![29, 1, 0], ![20, 0, 1]] ![-29, -1, 0] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![0, -1, 0]
 hmem := by decide
...
def Log12Mem : IdealMemCertificate B I1
 ![![31, 0, 0], ![29, 1, 0], ![20, 0, 1]] ![13, 8, 3] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A1
 g := ![-9, 8, 3]
 hmem := by decide
...
def Log20Mem : IdealMemCertificate B I2
 ![![43, 0, 0], ![15, 1, 0], ![27, 0, 1]] ![502, -104, 27] where
...
def Log21Mem : IdealMemCertificate B I2
 ![![43, 0, 0], ![15, 1, 0], ![27, 0, 1]] ![-15, -1, 0] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![0, -1, 0]
 hmem := by decide
...
def Log22Mem : IdealMemCertificate B I2
 ![![43, 0, 0], ![15, 1, 0], ![27, 0, 1]] ![29, 8, 3] where
 hieq := ideal_eq_of_IdealEqSpanCertificate' timesTableT_eq_Table rfl A2
 g := ![-4, 8, 3]
 hmem := by decide

def Log22: DiscreteLogCertificate N2 ((orderOf_of_IsOrderOf R43) ▸ IsPrimitiveRoot.orderOf _) 3 alpha1 1 where
 r := 3
 hN := by infer_instance
 hpdvd := by decide
 B := B
